    ...
    public class EventsMenu : Script
    {
        ...
        public void Event_ResourceStart()
        {
            try
            {
                ...
                PedSystem.Repository.CreateQuest("a_m_m_afriamer_01", new Vector3(-486.10715, -399.39944, 34.546597), -47.65183f, title: "~y~NPC~w~ Simon\nVeranstalter");
                ...
                Main.CreateBlip(new Main.BlipData(491, LangFunc.GetText(LangType.De, DataName.Events), new Vector3(-483.149, -400.09946, 34.546608), 6, true));
            }
            catch (Exception e)
            {
