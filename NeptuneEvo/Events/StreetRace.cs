    ...
    class StreetRace : Script
    {
        ...
        public static void OpenStreetRaceMenu(ExtPlayer player)
        {
            try
            {
                ...
                frameList.Header = $"Straßenrennen"; 
        ...
        private static void callback_selectChar(ExtPlayer player, object listItem)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.StreetRace), LangFunc.GetText(LangType.De, DataName.EnterStavka0to100k), 6, "streetrace");
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                switch (messageId)
                {
                    case 0:
                        ...
                        Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerNotEnoughMoney), 6000);
                        break;
                    case 1:
                        if (streetRaceData.Status)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouDiedLose), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragDiedWin), 6000);
                        }
                        else
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragDiedCancel), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragDkSWin), 6000);
                        }
                        break;
                    case 2:
                        Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragDkWin), 6000);
                        break;
                    case 3:
                        if (streetRaceData.Status)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouLeftTsLose), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragLeftTsWin), 6000);
                        }
                        else
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouleftTsCancel), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragLeftTsCancel), 6000);
                        }
                        break;
                    case 4:
                        if (streetRaceData.Status)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouMustTsLose), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouMustTsLose), 6000);
                        }
                        else
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VragLeftTsWinS), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouLeftTsCancel), 6000);
                        }
                        break;
                    case 5:
                        if (streetRaceData.Status)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerFarWin), 6000);
                            Notify.Send(WinPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouFarCancel), 6000);
                        }
                        else
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerFarWin), 6000);
            ...
            try
            {
                ...
                if (!sessionData.CuffedData.Cuffed && !sessionData.DeathData.InDeath)
                {
                    ...
                    if (targetSessionData != null && !targetSessionData.CuffedData.Cuffed && !targetSessionData.DeathData.InDeath)
                    {
                        ...
                        //Notify.Send(streetRaceData.joined, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerOFferGonka, player.Value, streetRaceData.rate), 15000);
                        EventSys.SendCoolMsg(streetRaceData.joined,"Straßenrennen", "Rennen Herausforderung", $"{LangFunc.GetText(LangType.De, DataName.PlayerOFferGonka, player.Value, streetRaceData.rate)}", "", 10000);
                        EventSys.SendCoolMsg(player,"Straßenrennen", "Rennen Herausforderung", $"{LangFunc.GetText(LangType.De, DataName.YouOfferGonka, streetRaceData.joined.Value)}", "", 10000);
                        //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouOfferGonka, streetRaceData.joined.Value), 8000);
                    }
                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantGonkaNow), 6000);
                }
                else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantGonkaNow), 6000);
            }
            catch (Exception e)
        ...
        public static void StreetRaceFinished(ExtPlayer player)
        {
            try
            {
                ...
                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWinGonka, cost), 8000);
                EventSys.SendCoolMsg(player,"Straßenrennen", "Gewonnen!", $"{LangFunc.GetText(LangType.De, DataName.YouWinGonka, cost)}", "", 10000);
                ...
                //Notify.Send(LosePlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouLoseGonka), 8000);
                EventSys.SendCoolMsg(LosePlayer,"Straßenrennen", "Verloren :(", $"{LangFunc.GetText(LangType.De, DataName.YouLoseGonka, cost)}", "", 10000);
