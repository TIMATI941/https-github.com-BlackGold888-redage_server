...
namespace NeptuneEvo.VehicleModel
{
    public class AirAutoRoom : Script
    {
        ...
        public void Event_ResourceStart()
        {
            ...
            PedSystem.Repository.CreateQuest("csb_reporter", NpcBuyPosition, NpcBuyRotation, title: "~y~NPC~w~ Lufttransportverkäufer", colShapeEnums: ColShapeEnums.AirAutoRoom);
            //
            Main.CreateBlip(new Main.BlipData(602, "HeliPort", NpcSpawnPosition, 60, true));
            PedSystem.Repository.CreateQuest("s_m_y_airworker", NpcSpawnPosition, NpcSpawnRotation, title: "~y~NPC~w~ Flughafenarbeiter", colShapeEnums: ColShapeEnums.AirSpawn);
        }
