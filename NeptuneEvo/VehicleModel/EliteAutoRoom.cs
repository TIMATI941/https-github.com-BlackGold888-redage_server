...
namespace NeptuneEvo.VehicleModel
{
    public class EliteAutoRoom : Script
    {
        ...
        public void Event_ResourceStart()
        {
            ...
            PedSystem.Repository.CreateQuest("s_m_m_movprem_01", NpcBuyPosition, NpcBuyRotation, title: "~y~NPC~w~ Händler für Luxusfahrzeuge", colShapeEnums: ColShapeEnums.EliteAutoRoom);
        }
