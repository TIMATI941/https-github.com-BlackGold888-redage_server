...
namespace NeptuneEvo.Players.Phone.Taxi.Orders
{
    ...
    {        
        ...
        public static void GetSelect(ExtPlayer player, bool isTake = false)
        {
            ...
            else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotWorkTaxi), 6000);  
        ...
        public static void OnPlayerEnterVehicle(ExtPlayer player, ExtVehicle vehicle, sbyte seatId)
        {
            ...
            {
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GiveTochkaZ), 5000);
                    ...
                    if (taxiData != null)
                    {
                        if (taxiData.Player != player)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,
                                LangFunc.GetText(LangType.De, DataName.TaxiNoDriver), 6000);
            ...
            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TaxiNoDriver), 6000);
            VehicleManager.WarpPlayerOutOfVehicle(player);
        }
        ...
        public static void OnPlayerDisconnect(ExtPlayer player)
        {
            ...
            if (sessionData.TaxiData.Driver != null)
            {
                ...
                if (driverSessionData != null)
                {
                    ...
                    Notify.Send(driver, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PassengerCancel), 5000);
                }
            }
            ...
            {           
                if (sessionData.TaxiData.Passager != null)
                {
                    ...
                    if (targetSessionData != null)
                    {
                        ...
                        Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DriverCancel), 10000);
                    }
                }
            }
        }
        ...
        public static void EndWork(ExtPlayer player)
        {
            ...
            if (sessionData.WorkData.OnWork)
            {
                ...
                if (sessionData.TaxiData.Passager != null)
                {
                    ...
                    Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TaxiDriverLost), 6000);
                }
            }
        }
