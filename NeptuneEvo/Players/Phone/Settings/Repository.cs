    ...
    public class Repository
    {
        public static int OnAddSim(ExtPlayer player, int newSim)
        {
            ...
            if (sim != -1)
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Sim-Karte wurde geändert", 3000);
        ...
        public static void OnRemoveSim(ExtPlayer player)
        {
            ...
            if (sim == -1)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Sim-Karte nicht eingelegt", 3000);
                return;
            }
        ...
        public static void OnUpdateAir(ExtPlayer player)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Der Flugzeugmodus kann alle 5 Minuten geändert werden", 3000);
                return;
            }
        ...
        public static void OnUpdateForbesVisible(ExtPlayer player)
        {
            ...
            Trigger.ClientEvent(player, "phone.notify", (int) DefaultNumber.RedAge, $"Der Datenschutzstatus von Forbes wird sich mit dem nächsten Update ändern", 5);
        }
        ...
        private static List<string> SoundsCall = new List<string>
        {
            ...
            "cloud/sound/iphone/calls/fuchs.mp3",
