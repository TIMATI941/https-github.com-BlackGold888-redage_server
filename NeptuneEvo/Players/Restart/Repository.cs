...
namespace NeptuneEvo.Players.Restart
{
    public class Repository
    {
        public static void Add(ExtPlayer player, string text)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Sie haben ein verbotenes Wort eingegeben", 3000);
                return;
            }
            ...
            NAPI.ClientEvent.TriggerClientEvent(player, "restart.send", "Ich", text);
