...
{ 
    ...
    { 
        ...
        private static Vector3 SecondArrestPosition = new Vector3(-444.3758, 6011.2217, 27.985634); //knast1
         
        public static Vector3 FirstPrisonPosition = new Vector3(1862.5636, 3693.7375, 30.25940); //
        public static Vector3 SecondPrisonPosition = new Vector3(-444.60986, 6014.0884, 27.985611); //knast2
        ...
        public static Vector3 FirstPosition = new Vector3(1846.0203, 3692.7175, 34.26693);  //nicht richtig
        public static Vector3 CloakroomPosition = new Vector3(1850.7942, 3693.731, 34.26696); //nicht richtig
        private static Vector3 CloakroomSpecialPosition = new Vector3(1848.5563, 3695.9812, 34.26695); //nicht richtig
        private static Vector3 VehicleBoostPosition = new Vector3(1866.0756, 3698.5723, 33.59682); 
         
        public static Vector3 SecondPosition = new Vector3(-445.67395, 6013.7183, 31); //blip
        public static Vector3 SecondCloakroomPosition = new Vector3(-439.15466, 6011.198, 36.9); //Umkleide
        private static Vector3 SecondCloakroomSpecialPosition = new Vector3(-445.53143, 6019.0195, 36.9); //swat umkleide
        private static Vector3 SecondStockPosition = new Vector3(-437.39987, 6009.6777, 36.9); //spint
        private static Vector3 VehicleRepairPosition = new Vector3(-495.41357, 5992.021, 31.302324); //auto reparatur
         
        public static Vector3 FirstGunsPosition = new Vector3(1844.3673, 3692.2087, 34.266937); 
        public static Vector3 SecondGunsPosition = new Vector3(-445.86758, 6014.8154, 37.0556); //richtier waffen ausgabe
        ...
        { 
            ...
            { 
                ...
                Main.CreateBlip(new Main.BlipData(526, "Sheriff", SecondPosition, 81, true)); 
                ...
                NAPI.Marker.CreateMarker(27, CloakroomPosition, new Vector3(), new Vector3(), 1, new Color(65, 105, 225, 220)); 
                NAPI.Marker.CreateMarker(27, CloakroomSpecialPosition, new Vector3(), new Vector3(), 1, new Color(238, 118, 33, 220)); 
                ...
                NAPI.Marker.CreateMarker(27, SecondCloakroomPosition, new Vector3(), new Vector3(), 1, new Color(65, 105, 225, 220)); 
                NAPI.Marker.CreateMarker(27, SecondCloakroomSpecialPosition, new Vector3(), new Vector3(), 1, new Color(238, 118, 33, 220)); 
                ...
                NAPI.Marker.CreateMarker(44, new Vector3(VehicleRepairPosition.X, VehicleRepairPosition.Y, VehicleRepairPosition.Z - 0.5), new Vector3(), new Vector3(), 1f, new Color(255, 255, 255, 220)); 
                ...
                Ped ped = PedSystem.Repository.CreateQuest("s_f_y_sheriff_01", new Vector3(1852.9309, 3688.9907, 34.266937), -150.65309f, title: "~y~NPC~w~ Sandy Whores\nSekretär", colShapeEnums: ColShapeEnums.FracSheriff); 
                PedSecretaryId = ped.Value; 
                 
                Ped secondPed = PedSystem.Repository.CreateQuest("s_f_y_sheriff_01", new Vector3(-448.2623, 6014.027, 32.28), -130.169f, title: "~y~NPC~w~ Svenya Piggy\nSekretär", colShapeEnums: ColShapeEnums.FracSheriff);//richtiger ped 
                PedSecondSecretaryId = secondPed.Value; 
 
                PedSystem.Repository.CreateQuest("s_m_m_fibsec_01", FirstGunsPosition, -87.25532f, title: "~y~NPC~w~ Agent Peter\nLager", colShapeEnums: ColShapeEnums.FracSheriff); 
                PedSystem.Repository.CreateQuest("csb_cop", SecondGunsPosition, -136.875225f, title: "~y~NPC~w~ Agent Sven\nLager", colShapeEnums: ColShapeEnums.FracSheriff); //richtiger sheriff ped
                //PedSystem.Repository.CreateQuest("s_m_m_armoured_02", new Vector3(-444.31284, 6010.7974, 31.716427), 47.103275f, title: "~y~NPC~w~ Sergeant Sebastian\nMitarbeiter rufen", colShapeEnums: ColShapeEnums.CallSheriffMember);
            } 
            catch (Exception e) 
            { 
        ...
        { 
            ...
            { 
                ...
                Trigger.ClientEvent(player, "openDialog", "CallSheriffMemberDialog", LangFunc.GetText(LangType.De, DataName.AreYouWantToCallGov)); 
            } 
            catch (Exception e) 
            { 
