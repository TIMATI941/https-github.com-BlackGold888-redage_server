...
namespace NeptuneEvo.Fractions
{
    class Configs : Script
    {
        ...
        public static void InitFractionDefaultRanksName()
        {
            ...
            if (fractionData.Ranks.Count == 0) fractions.Add(fractionId);
            AddFractionRanksData(fractionId, 1, "Wächter", 0, 1, fractionData.RanksDefaultAccess[1]);
            AddFractionRanksData(fractionId, 2, "Heimwerker", 0, 2, fractionData.RanksDefaultAccess[2]);
            AddFractionRanksData(fractionId, 3, "Wachmann", 0, 3, fractionData.RanksDefaultAccess[3]);
            AddFractionRanksData(fractionId, 4, "Betrüger", 0, 4, fractionData.RanksDefaultAccess[4]);
            AddFractionRanksData(fractionId, 5, "Schwindler", 0, 5, fractionData.RanksDefaultAccess[5]);
            AddFractionRanksData(fractionId, 6, "Angeber", 0, 6, fractionData.RanksDefaultAccess[6]);
            AddFractionRanksData(fractionId, 7, "Autorität", 0, 7, fractionData.RanksDefaultAccess[7]);
            AddFractionRanksData(fractionId, 8, "Beobachter", 0, 8, fractionData.RanksDefaultAccess[8]);
            AddFractionRanksData(fractionId, 9, "Boss", 0, 9, fractionData.RanksDefaultAccess[9]);
            AddFractionRanksData(fractionId, 10, "Dieb im Gesetz", 0, 10, fractionData.RanksDefaultAccess[10]);
            ...
            try
            {
                ...
                if (resultFraction != null && resultFraction.Rows.Count > 0)
                {
                    foreach (DataRow dataRow in resultFraction.Rows)
                    {
                        ...
                        {
                            fractionData.StockLabel = (ExtTextLabel) NAPI.TextLabel.CreateTextLabel("~w~Leeres Lager", Stocks.matsCoords[fractionId] + new Vector3(0, 0, 1.5), 10f, 0.4f, 0, new Color(255, 255, 255), true, NAPI.GlobalDimension);
                        ...
                        NAPI.TextLabel.CreateTextLabel(Main.StringToU16($"~w~Lager ~r~{Manager.GetName(fractionId)}"), new Vector3(Stocks.stockCoords[fractionId].X, Stocks.stockCoords[fractionId].Y, Stocks.stockCoords[fractionId].Z + 0.6), 5F, 0.5F, 0, new Color(255, 255, 255));
