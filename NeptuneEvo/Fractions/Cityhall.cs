...
{ 
    ...
    { 
        ...
        public static Vector3 CloakroomPosition = new Vector3(-568.5248, -200.34793, 38f); //umkleide
        public static Vector3 SecondCloakroomPosition = new Vector3(-565.8175, -193.002252, 38f); //umkleide 2
        private static Vector3 StockPosition = new Vector3(-566.4993, -191.8047, 38f); //lager
        public static Vector3 GiveGunPosition = new Vector3(-563.86285, -198.40375, 38f); //waffen ausgabe
        public static Vector3 SecondGiveGunPosition = new Vector3(2487.9102f, -376.6428f, 82.69f); 
        public static Vector3 GpsPosition = new Vector3(-550.63855, -195.30724, 38.21f); //bilip von rathaus
        private static Vector3 CallingEmployeesPosition = new Vector3(-552.9627, -192.0429, 38.21f);

        private static Vector3 JobPosition = new Vector3(-551.53143, -191.21649, 38.219288);// arbeit geber
        private static Vector3 JobPosition1 = new Vector3(720.61, 153.67567, 80.90749);
        ...
        private static Vector3 JobPosition5 = new Vector3(-1339.743, 39.87946, 55.24567); //-1331.7507, 44.325035, 53.5806
        ...
        { 
            ...
            { 
                ...
                Main.CreateBlip(new Main.BlipData(419, "Regierung", GpsPosition, 4, true, 1.5f)); 
                //Main.CreateBlip(new Main.BlipData(419, "Regierung", new Vector3(2515.921, -357.68134, 94), 4, true, 1.5f)); 
                Main.CreateBlip(new Main.BlipData(541, "Gericht", new Vector3(-524.278, -178.63527, 38.219223), 4, true)); 
                ...
                PedSystem.Repository.CreateQuest("s_m_y_devinsec_01", GiveGunPosition, -139.39449f, title: "~y~NPC~w~ Patrick Kessel\nWaffen ausgabe", colShapeEnums: ColShapeEnums.FractionCityhallGunMenu);
                PedSystem.Repository.CreateQuest("s_m_y_devinsec_01", SecondGiveGunPosition, -129.7344f, title: "~y~NPC~w~ Jonny Wayne\nWaffen ausgabe", colShapeEnums: ColShapeEnums.FractionCityhallGunMenu); 
                PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition, -112.454f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect);
                PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition1, -50.89626f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect);
                //  PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition2, -159.75824f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect); 
                // PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition3, -81.50282f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect); 
                PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition4, 86.65183f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect);
                PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition5, -90.612854f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect);
                //PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition6, -96.25076f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect); 
                //PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition7, -9.802892f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect); 
                //PedSystem.Repository.CreateQuest("mp_f_execpa_02", JobPosition8, -87.92568f, title: "~y~NPC~w~ Jenny Ingold\nJob starten", colShapeEnums: ColShapeEnums.JobSelect);
                ...
                { 
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Aufzug"), new Vector3(CityhallLiftCheckpoints[i].X, CityhallLiftCheckpoints[i].Y, CityhallLiftCheckpoints[i].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                ...
                { 
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Aufzug"), new Vector3(CourtCheckpoints[i].X, CourtCheckpoints[i].Y, CourtCheckpoints[i].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                ...
                { 
                    ...
                    NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Aufzug"), new Vector3(SecondGovLiftCoords[i].X, SecondGovLiftCoords[i].Y, SecondGovLiftCoords[i].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
        ...
        { 
            ...
            { 
                ...
                Trigger.ClientEvent(player, "openDialog", "CallGovMemberDialog", LangFunc.GetText(LangType.De, DataName.AreYouWantToCallGov)); 
            } 
            catch (Exception e) 
            { 
            ...
            { 
                ...
                { 
                    ...
                    case 3: 
                        ...
                        { 
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotGOV), 6000); 
                            return; 
                        } 
        ...
        { 
            ...
            { 
                ...
                { 
                    ...
                    { 
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyAtFloor), 6000); 
                        return; 
                    } 
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GoingToFloor, index), 6000); 
            } 
            catch (Exception e) 
            { 
        ...
        { 
            ...
            { 
                ...
                else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotGOV), 6000); 
            } 
            catch (Exception e) 
            { 
        ...
        { 
            ...
            { 
                ...
                { 
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TooFar), 6000); 
                    return; 
                } 
