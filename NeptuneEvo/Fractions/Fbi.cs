    ...
    class Fbi : Script
    {
        ...
        { 
            ...
            { 
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[0].X, fbiCheckpoints[0].Y, fbiCheckpoints[0].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[14], 1, 2, 0, ColShapeEnums.FractionFbi, 1); // duty fbi 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[14].X, fbiCheckpoints[14].Y, fbiCheckpoints[14].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[1], 1, 2, 0, ColShapeEnums.FractionFbi, 2); // 49 floor to 53 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[1].X, fbiCheckpoints[1].Y, fbiCheckpoints[1].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[2], 1, 2, 0, ColShapeEnums.FractionFbi, 4); // 49 floor 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[2].X, fbiCheckpoints[2].Y, fbiCheckpoints[2].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[3], 1, 2, 0, ColShapeEnums.FractionFbi, 5); // 53 floor to 49 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[3].X, fbiCheckpoints[3].Y, fbiCheckpoints[3].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[4], 1, 2, 0, ColShapeEnums.FractionFbi, 2); // roof 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[4].X, fbiCheckpoints[4].Y, fbiCheckpoints[4].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[5], 1, 2, 0, ColShapeEnums.FractionFbi, 3); // gun menu 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[5].X, fbiCheckpoints[5].Y, fbiCheckpoints[5].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[13], 1, 2, 0, ColShapeEnums.FractionFbi, 3); // gun menu 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[13].X, fbiCheckpoints[13].Y, fbiCheckpoints[13].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[6], 1, 2, 0, ColShapeEnums.FractionFbi, 2); // 1 floor 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[6].X, fbiCheckpoints[6].Y, fbiCheckpoints[6].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[7], 1, 2, 0, ColShapeEnums.FractionFbi, 2); // garage 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[7].X, fbiCheckpoints[7].Y, fbiCheckpoints[7].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[8], 1, 2, 0, ColShapeEnums.FractionFbi, 6); // warg 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[8].X, fbiCheckpoints[8].Y, fbiCheckpoints[8].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[12], 1, 2, 0, ColShapeEnums.FractionFbi, 6); // warg 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[12].X, fbiCheckpoints[12].Y, fbiCheckpoints[12].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[9], 1, 2, 0, ColShapeEnums.FractionFbi, 7); // stock 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Waffenlager öffnen"), new Vector3(fbiCheckpoints[9].X, fbiCheckpoints[9].Y, fbiCheckpoints[9].Z + 0.3), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Fahrzeug reparieren"), fbiCheckpoints[10], 5F, 0.3F, 0, new Color(255, 255, 255)); 
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Fahrzeug reparieren"), fbiCheckpoints[11], 5F, 0.3F, 0, new Color(255, 255, 255)); 
                 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[15], 1, 2, 0, ColShapeEnums.FractionFbi, 9); // 2 floor 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[15].X, fbiCheckpoints[15].Y, fbiCheckpoints[15].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                 
                CustomColShape.CreateCylinderColShape(fbiCheckpoints[16], 1, 2, 0, ColShapeEnums.FractionFbi, 10); // 4 floor 
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(fbiCheckpoints[16].X, fbiCheckpoints[16].Y, fbiCheckpoints[16].Z), 5F, 0.3F, 0, new Color(255, 255, 255)); 
                #endregion 
                
                PedSystem.Repository.CreateQuest("s_m_m_fibsec_01", new Vector3(117.0207, -747.3272, 45.75158), 109.83642f, title: "~y~NPC~w~ Agent Andrey\nMitarbeiter rufen", colShapeEnums: ColShapeEnums.CallFibMember);
            } 
            catch (Exception e) 
            { 
        ...
        { 
            ...
            { 
                ...
                Trigger.ClientEvent(player, "openDialog", "CallFibMemberDialog", LangFunc.GetText(LangType.De, DataName.AreYouWantToCallGov)); 
            } 
            catch (Exception e) 
            { 
            ...
            { 
                ...
                { 
                    case 1: 
                        ...
                        else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotFIB), 6000); 
                        return; 
                    case 2: 
                    ...
                    case 3: 
                        ...
                        { 
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotFIB), 6000); 
                            return; 
                        } 
                    ...
                    case 6: 
                        ...
                        { 
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WorkClothesSuccess), 6000); 
                        } 
                        else 
                        { 
                            if (!warg_mode) 
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SpecialWorkClothesSuccess), 6000); 
                        } 
                        return; 
                    case 7: 
                        if (fractionData == null || fractionData.Id != (int) Models.Fractions.FIB) 
                    ...
                    case 8: 
                        ...
                        { 
                            ...
                            if (g.Hour >= 1) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NextRepair1h, g.Hour, g.Minute, g.Second), 7000); 
                            else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NextRepair, g.Minute, g.Second), 7000); 
                            return; 
                        } 
                        ...
                        if (vehicleLocalData != null) 
                        {
                            ...
                            { 
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustWorkCar), 6000); 
                                return; 
                            } 
                        } 
                        return; 
        ...
        { 
            ...
            { 
                ...
                { 
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.IsBadgeFIBorPD), 5000); 
                    return; 
                } 
                switch (floor) 
                { 
