    ...
    class Army : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(ArmyCheckpoints[0].X, ArmyCheckpoints[0].Y, ArmyCheckpoints[0].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[1], 1, 2, 3244522, ColShapeEnums.FractionArmy, 1);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(ArmyCheckpoints[1].X, ArmyCheckpoints[1].Y, ArmyCheckpoints[1].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Aufzug"), new Vector3(ArmyCheckpoints[3].X, ArmyCheckpoints[3].Y, ArmyCheckpoints[3].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[4], 1, 2, 0, ColShapeEnums.FractionArmy, 3);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Aufzug"), new Vector3(ArmyCheckpoints[4].X, ArmyCheckpoints[4].Y, ArmyCheckpoints[4].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[5], 1, 2, 3244522, ColShapeEnums.FractionArmy, 4);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Waffenlager öffnen"), new Vector3(ArmyCheckpoints[5].X, ArmyCheckpoints[5].Y, ArmyCheckpoints[5].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[6], 3, 3, 0, ColShapeEnums.FractionArmy, 5);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Fahrzeug reparieren"), new Vector3(ArmyCheckpoints[6].X, ArmyCheckpoints[6].Y, ArmyCheckpoints[6].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[7], 5, 2, 0, ColShapeEnums.FractionArmy, 6);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Luftfahrzeug reparieren"), new Vector3(ArmyCheckpoints[7].X, ArmyCheckpoints[7].Y, ArmyCheckpoints[7].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[8], 1, 2, 0, ColShapeEnums.FractionArmy, 7);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Alarm Knopf"), new Vector3(ArmyCheckpoints[8].X, ArmyCheckpoints[8].Y, ArmyCheckpoints[8].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255), true);
                                
                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[9], 1, 2, 0, ColShapeEnums.FractionArmy, 8);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(ArmyCheckpoints[9].X, ArmyCheckpoints[9].Y, ArmyCheckpoints[9].Z), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[10], 1, 2, 3244522, ColShapeEnums.FractionArmy, 9);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(ArmyCheckpoints[10].X, ArmyCheckpoints[10].Y, ArmyCheckpoints[10].Z), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 3244522);

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[11], 1, 2, 0, ColShapeEnums.FractionArmy, 10);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(ArmyCheckpoints[11].X, ArmyCheckpoints[11].Y, ArmyCheckpoints[11].Z), 5F, 0.3F, 0, new Color(255, 255, 255));

                CustomColShape.CreateCylinderColShape(ArmyCheckpoints[12], 1, 2, 4566544, ColShapeEnums.FractionArmy, 11);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(ArmyCheckpoints[12].X, ArmyCheckpoints[12].Y, ArmyCheckpoints[12].Z), 5F, 0.3F, 0, new Color(255, 255, 255), dimension: 4566544);
                ...
                PedSystem.Repository.CreateQuest("s_m_m_marine_01", new Vector3(-276.09488, -2636.1191, 6.0462055), -50.05095f, title: "~y~NPC~w~ Rekrut Sven\nMitarbeiter rufen", colShapeEnums: ColShapeEnums.CallArmyMember);
            }
        ...
        public static void callback_armyGuns(ExtPlayer player, int index)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TooFarFromWeaponTake), 6000);
                    return;
                }
                switch (index)
                {
                    ...
                    case 3: //armor
                        ...
                        if (fractionData.Materials > Manager.matsForArmor && Chars.Repository.itemCount(player, "inventory", ItemId.BodyArmor) < Chars.Repository.maxItemCount)
                        {
                            ...
                            Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.CraftedBronik));
                        }
                        return;
                    case 4:
        ...
        { 
            ...
            { 
                ...
                Trigger.ClientEvent(player, "openDialog", "CallArmyMemberDialog", LangFunc.GetText(LangType.De, DataName.AreYouWantToCallGov)); 
            } 
            catch (Exception e) 
            { 
            ...
            try
            {
                ...
                switch (interact)
                {
                    case 0:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DostupOn), 6000);
                            return;
                        }
                    ...
                    case 1:
                        if (fractionData.Id != (int) Models.Fractions.ARMY)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DostupOff), 6000);
                            return;
                        }
                    ...
                    case 2:
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarCantMoveMats), 6000);
                                return;
                            }
                            if (vehicleLocalData.Fraction != (int) Models.Fractions.ARMY)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantLoadMatsToCar), 6000);
                                return;
                            }
                            if (sessionData.TimersData.LoadMatsTimer != null)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyLoadingMatsToCar), 6000);
                                return;
                            }
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LoadingMatsStarted), 6000);
                    ...
                    case 5: // Наземный
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustArmyVeh), 6000);
                                return;
                            }
                        }
                        return;
                    case 6: // Воздушный
                        ...
                        if (!player.IsInVehicle)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustFlyingVeh), 6000);
                            return;
                        }
                        if (player.Vehicle.Class != 15 && player.Vehicle.Class != 16)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RepairOnlyFlyingVeh), 6000);
                            return;
                        }
                    ...
                    case 7: // Общая тревога
                        ...
                        if (is_warg)
                        {
                            message = LangFunc.GetText(LangType.De, DataName.EnableWargNG, player.Name);
                            GameLog.FracLog(fractionData.Id, player.GetUUID(), -1, player.Name, "-1", "enableWarg");
                        }
                        else
                        {
                            message = LangFunc.GetText(LangType.De, DataName.DisableWargNG, player.Name);
        ...
        public static void OutFractionArmy(ExtPlayer player, int Index)
        {
            try
            {
                ...
                if (sessionData.TimersData.LoadMatsTimer != null)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Das Beladen von Mats wurde abgebrochen! Das Fahrzeug hat den Checkpoint verlassen", 6000);
                }
            }
            catch (Exception e)
            {
        ...
        public static void loadMaterialsTimer(ExtPlayer player)
        {
            try
            {
                ...
                if (sessionData.WhereLoad == "WAR" && !MatsWar.isWar)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TimeOver), 6000);
                    return;
                }
                ...
                else
                {
                    ...
                    if (vehicle.Model == (uint)VehicleHash.Cargobob)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CargobobDayLimit, Stocks.MaxCargobobMats), 6000);
                            return;
                        }
                        else // Если может
                        {
                    ...
                    Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.MatLoads, iCount));
                ...
                if (sessionData.TimersData.LoadMatsTimer != null) Timers.Stop(sessionData.TimersData.LoadMatsTimer);
                sessionData.TimersData.LoadMatsTimer = null;
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MatSucLoading), 6000);
            }
            catch (Exception e)
            {
        ...
        public static void Event_PlayerDeath(ExtPlayer player, ExtPlayer entityKiller, uint weapon)
        {
            try
            {
                ...
                if (sessionData.TimersData.LoadMatsTimer != null)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MatLoadingCancelByDeath), 6000);
                    Timers.Stop(sessionData.TimersData.LoadMatsTimer);
                    sessionData.TimersData.LoadMatsTimer = null;
                ...
                if (vehicleLocalData != null)
                {
                    if (vehicleLocalData.LoaderMats != null)
                    {
                        ...
                        if (sessionData.TimersData.LoadMatsTimer != null)
                        {
                            ...
                            sessionData.TimersData.LoadMatsTimer = null;
                            vehicleLocalData.LoaderMats = null;
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MatLoadingCancelByCheckpoint), 6000);
                        }
                    }
                }
            }
