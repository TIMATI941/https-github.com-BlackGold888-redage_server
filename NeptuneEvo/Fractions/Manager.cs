    ...
    class Manager : Script
    {
        ...
        public static void onResourceStart()
        {
            try
            {
                ...
                Main.CreateBlip(new Main.BlipData(564, "News", LsNewsSystem.LSNewsCoords[0], 4, true, 1.3f));

                Main.CreateBlip(new Main.BlipData(61, LangFunc.GetText(LangType.De, DataName.Bolnica), Ems.emsCheckpoints[0], 1, true));
                
                Main.CreateBlip(new Main.BlipData(60, "FIB", Fbi.GpsPosition, 4, true));
                
                Main.CreateBlip(new Main.BlipData(478, LangFunc.GetText(LangType.De, DataName.WarPort), Army.ArmyCheckpoints[2], 4, true));
        ...
        private static IReadOnlyList<GarageData> GaragesData = new List<GarageData>() // Alle Fraktions Garagen
        {
            ...
            new GarageData((int) Models.Fractions.SHERIFF,
                new Vector3(-450.11752, 6010.501, 32.288654), new Vector3(), 
                StaticExitGaragesData[0][0][2], StaticExitGaragesData[0][1][2], 
                
                new Vector3(-450.1386, 6010.347, 32.28865), //garage sheriff
        ...
        private static void CreateGarageData()
        {
            ...
            {
                CustomColShape.CreateCylinderColShape(garageData.VehEnterPosPoint, 3f, 1, 0, ColShapeEnums.FractionGarageEnter, index); // Телепорт из улицы в гараж
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Garage News"),  new Vector3(0, 0, 0), 3f, 3f, 0, new Color(255, 255, 255, 220), dimension: 0);
                NAPI.Marker.CreateMarker(27, garageData.VehEnterPosPoint - new Vector3(0, 0, 0.3), new Vector3(), new Vector3(), 1, new Color(255, 255, 255, 50), dimension: 0);
                ...
                NAPI.Marker.CreateMarker(27, garageData.VehExitPosPoint - new Vector3(0, 0, 0.3), new Vector3(), new Vector3(), 1, new Color(255, 255, 255, 50), dimension: (uint)(garageData.DefaultDimension + garageData.FractionId));
                
                CustomColShape.CreateCylinderColShape(garageData.PlayerExitPos, 3f, 2, (uint)(garageData.DefaultDimension + garageData.FractionId), ColShapeEnums.FractionGarageExit, index); // Телепорт с гаража на улицу
                NAPI.Marker.CreateMarker(27, garageData.PlayerExitPos - new Vector3(0, 0, 0.3), new Vector3(), new Vector3(), 1, new Color(255, 255, 255, 200), dimension: (uint)(garageData.DefaultDimension + garageData.FractionId));
        ...
        public static void FractionGarageEnter(ExtPlayer player, int index)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNotInFraction), 6000);
                    return;
                }
                ...
                else
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustBeDriver), 6000);
                        return;
                    }
        ...
        { 
            ...
            { 
                ...
                { 
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CallGov15sec), 6000); 
                    return; 
                } 
                ...
                Manager.sendFractionMessage(fracId, "!{#F08080}[F] " + LangFunc.GetText(LangType.De, DataName.PlayerCallGov, player.Name, player.Value) + " " + numberInfo, true); 
                EventSys.SendCoolMsg(player, "Erfolgreich", "Mitarbeiter Dispatch", $"{LangFunc.GetText(LangType.De, DataName.PlayerSucCallGov)}",  "", 10000);
                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerSucCallGov), 6000); 
                //Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Ems, LangFunc.GetText(LangType.De, DataName.PlayerSucCallGov), DateTime.Now); 
        ...
        public static bool canGetWeapon(ExtPlayer player, string weapon, bool notify = true)
        {
            try
            {
                ...
                {
                    if (notify) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoDostup), 6000);
                    return false;
                }
                else return true;
            }
        ...
        public static Dictionary<int, FracMatsData> FractionDataMats = new Dictionary<int, FracMatsData>()
        {
            ...
            { 0, new FracMatsData(0, "Geldwäschedienst", "inv-item-briefcase", "") },
            ...
            { 6, new FracMatsData(6, "Fahndung senken", "sm-icon-wanted", $"{Main.BlackMarketWanted}$") },
            { 7, new FracMatsData(7, Chars.Repository.ItemsInfo[ItemId.BodyArmor].Name, Chars.Repository.ItemsInfo[ItemId.BodyArmor].Icon, $"150 Mats.") },
            { 69, new FracMatsData(69, "Handschellen knacken", "sm-icon-arrested", $"{Main.BlackMarketUnCuff}$") },
            { 78, new FracMatsData(78, "Waffenschein", "inv-item-modifications", $"{Main.BlackMarketGunLic}$") },
            { 79, new FracMatsData(79, "Krankenversicherung", Chars.Repository.ItemsInfo[ItemId.Note].Icon, $"{Main.BlackMarketMedCard}$") },
            { 80, new FracMatsData(80, "QR Code", Chars.Repository.ItemsInfo[ItemId.Note].Icon, $"{Main.BlackQrFake}$") },
            { 81, new FracMatsData(81, "Funkabfangjäger", Chars.Repository.ItemsInfo[ItemId.RadioInterceptor].Icon, $"{Main.BlackRadioInterceptord}$") },
            ...
            { 25, new FracMatsData(25, "Abzeichen", "sm-icon-documents", null) },
            { 26, new FracMatsData(26, "Schutzweste abgeben", "sm-icon-remove-armour", null) },

            { 27, new FracMatsData(27, "Fahrzeugdiebstahl", "sm-icon-hijacking", null) },
            { 28, new FracMatsData(28, "Transport von Fahrzeugen", "sm-icon-transportation", null) },


            { 29, new FracMatsData(29, "Waffentransport", "sm-icon-truck-ammo", null) },
            { 30, new FracMatsData(30, "Geldtransport", "sm-icon-truck-cash", null) },
            { 31, new FracMatsData(31, "Leichentransport", "sm-icon-truck-corpses", null) },
            ...
            { 100, new FracMatsData(100, Chars.Repository.ItemsInfo[ItemId.WaterCan].Name, Chars.Repository.ItemsInfo[ItemId.WaterCan].Icon, Main.PricesSettings.InstrumentPrices[4]+"$") },
            { 101, new FracMatsData(101, Chars.Repository.ItemsInfo[ItemId.Pot].Name, Chars.Repository.ItemsInfo[ItemId.Pot].Icon, Main.PricesSettings.InstrumentPrices[5]+"$") },
            ...
            try
            {
                ...
                /*else if (memberFractionData.Id == (int) Models.Fractions.CITY)
                {
                    switch (memberFractionData.Rank)
                    {
                        ...
                        case 20:
                            break;
                        default:
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.OnlyForceGov), 6000);
                            return;
                    }
                }*/
                ...
                switch (index)
                {
                    case 33:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WarehouseNoMats), 6000);
                            return;
                        }
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GetBronik), 6000);
                        GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "armor", 1, "out");
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.VzyalBron));
                        ...
                        if (fractionData.Id == (int) Models.Fractions.POLICE || fractionData.Id == (int) Models.Fractions.SHERIFF || fractionData.Id == (int) Models.Fractions.CITY || fractionData.Id == (int) Models.Fractions.ARMY || fractionData.Id == (int) Models.Fractions.FIB)
                            sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakenBronik, player.Name, player.Value), true);
                        return;
                    case 26:
                        ...
                        if (ItemStruct == null)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouHaveNoBronik), 6000);
                            return;
                        }
                        int armorp;
                        if (ItemStruct.Location == "accessories")
                        {
                            ...
                            {
                                Trigger.SendToAdmins(3, LangFunc.GetText(LangType.De, DataName.AdminACBronik, player.Name));
                                armorp = 0;
                            }
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BronikReturn, armorp, matstoadd), 5000);
                        
                        if (fractionData.Id == (int) Models.Fractions.ARMY)
                            player.AddTableScore(TableTaskId.Item18);

                        if (fractionData.Id == (int) Models.Fractions.POLICE || fractionData.Id == (int) Models.Fractions.SHERIFF || fractionData.Id == (int) Models.Fractions.CITY || fractionData.Id == (int) Models.Fractions.ARMY || fractionData.Id == (int) Models.Fractions.FIB)
                            sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.SdalBronik, player.Name, player.Value, armorp, matstoadd), true);
                        return;
                    case 32: // medkit
                        if (!canGetWeapon(player, "Medkits")) return;
                        if (fractionData.MedKits == 0)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WarehouseNoAptekas), 6000);
                            return;
                        }
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GotApteka), 6000);
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.GetApteka));

                        if (fractionData.Id == (int) Models.Fractions.POLICE || fractionData.Id == (int) Models.Fractions.SHERIFF || fractionData.Id == (int) Models.Fractions.CITY || fractionData.Id == (int) Models.Fractions.ARMY || fractionData.Id == (int) Models.Fractions.FIB)
                            sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakeApteka, player.Name, player.Value), true);
                        return;
                    ...
                    case 25:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouAlreadyHaveBadge), 6000);
                            return;
                        }
                        ...
                        Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeSpecial, LangFunc.GetText(LangType.De, DataName.GetNewBadge));
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotFibBadge), 6000);
                        return;
                    ...
                    case 19:
                        ...
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.Ammo), LangFunc.GetText(LangType.De, DataName.EnterAmmoHoches), 4, "take_frac_ammo");
                        return;
                    case 20:
                    ...
                    case 82:
                        ...
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSpaceInventory), 6000);
                            return;
                        }
                     
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Konus].Name), 6000);
                        return;
                    case 83:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Konuss].Name), 6000);
                        return;
                    case 84:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Otboynik1].Name), 6000);
                        return;
                    case 85:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Otboynik2].Name), 6000);
                        return;
                    case 86:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Dontcross].Name), 6000);
                        return;
                    case 87:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Stop].Name), 6000);
                        return;
                    case 88:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.NetProezda].Name), 6000);
                        return;
                    case 89:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Kpp].Name), 6000);
                        return;
                    case 90:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Zabor1].Name), 6000);
                        return;
                    case 91:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Zabor2].Name), 6000);
                        return;
                    case 92:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Airlight].Name), 6000);
                        return;
                    case 93:
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Camera1].Name), 6000);
                        return;
                    case 94:
                        ...
                        return;
                    case 78:
                        if (Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.WaterCan, 1, "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSpaceInventory), 6000);
                            return;
                        }

                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.WaterCan].Name), 6000);
                        return;
                    case 79:
                        if (Chars.Repository.AddNewItem(player, $"char_{characterData.UUID}", "inventory", ItemId.Pot, 1, "0") == -1)
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSpaceInventory), 6000);
                            return;
                        }

                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ItemId.Pot].Name), 6000);
                        return;
                }
            }
            catch (Exception e)
        ...
        public static void giveGun(ExtPlayer player, WeaponRepository.Hash gun, string weaponstr)
        {
            ...
            {			
                ...
                if (player.HasData($"GET_{gun.ToString()}") && DateTime.Now < player.GetData<DateTime>($"GET_{gun.ToString()}"))
                {
                    ...
                    if (g.Hour >= 1) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCanTakeGun1h, gun.ToString(), g.Hour, g.Minute, g.Second), 5000);
                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCanTakeGun, gun.ToString(), g.Minute, g.Second), 5000);
                    return;
                }
                ...
                fractionData.UpdateLabel();
                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.YouVzyalItem, gun.ToString(), serial));
                int minutes = 5;
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, wType.ToString()), 6000);
                ...
                if (memberFractionData.Id == (int) Models.Fractions.POLICE || memberFractionData.Id == (int) Models.Fractions.SHERIFF || memberFractionData.Id == (int) Models.Fractions.CITY || memberFractionData.Id == (int) Models.Fractions.ARMY || memberFractionData.Id == (int) Models.Fractions.FIB)
                    sendFractionMessage(memberFractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakeGun, player.Name, player.Value, gun.ToString(), serial), true);
            }
            catch (Exception e)
            {
        ...
        public static void giveAmmo(ExtPlayer player, ItemId ammoType, int ammo)
        {
            ...
            {		
                ...
                fractionData.UpdateLabel();
                Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.YouVzyalItem, Chars.Repository.ItemsInfo[ammoType].Name, ammo));
                GameLog.Stock(memberFractionData.Id, player.GetUUID(), player.Name, ammoType.ToString(), 1, "out");
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGotItem, Chars.Repository.ItemsInfo[ammoType].Name, ammo), 6000);

                if (memberFractionData.Id == (int) Models.Fractions.POLICE || memberFractionData.Id == (int) Models.Fractions.SHERIFF || memberFractionData.Id == (int) Models.Fractions.CITY || memberFractionData.Id == (int) Models.Fractions.ARMY || memberFractionData.Id == (int) Models.Fractions.FIB)
                    sendFractionMessage(memberFractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakeAmmo, player.Name, player.Value, Chars.Repository.ItemsInfo[ammoType].Name, ammo), true);
            }
            catch (Exception e)
            {
        ...
        public static void TakeFractionAmmo(ExtPlayer player, int ammo)
        {
            try
            {
                ...
                else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.IncrorectInput), 6000);
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (FractionTypes[fracId] == FractionsType.None || FractionTypes[fracId] == FractionsType.Gov)
                {
                    if (FractionTypes[fracId] == FractionsType.None)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantCraftWeapon), 6000);
                            return;
                        }
                    }
                    else
        ...
        public static void Event_WCraft(ExtPlayer player, int frac, int cat, int index)
        {
            ...
            {			
                ...
                if (FractionTypes[frac] == FractionsType.None || FractionTypes[frac] == FractionsType.Gov)
                {
                    if (FractionTypes[frac] == FractionsType.None)
                    {
                        ...
                        if (organizationData != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FamilyDoesntSel, familySelected), 6000);
                                return;
                            }
                        }
                        else
                ...
                if (frac == (int) Models.Fractions.MERRYWEATHER)
                {
                    switch (selected)
                    {
                        ...
                        case "CombatPistol":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Das Craften von {selected} für MerryWeather ist ab Rang 2 Verfügbar", 3000);
                                return;
                            }
                            break;
                        case "HeavyPistol":
                        case "Pistol50":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Das Craften von {selected} für MerryWeather ist ab Rang 3 Verfügbar", 3000);
                                return;
                            }
                            break;
                        case "SMG":
                        ...
                        case "SawnOffShotgun":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Das Craften von {selected} für MerryWeather ist ab Rang 4 Verfügbar", 3000);
                                return;
                            }
                            break;
                        case "PumpShotgunMk2":
                        ...
                        case "SMGMk2":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Das Craften von {selected} für MerryWeather ist ab Rang 5 Verfügbar", 3000);
                                return;
                            }
                            break;
                        ...
                        case "CarbineRifleMk2":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Das Craften von {selected} für MerryWeather ist ab Rang 6 Verfügbar", 3000);
                                return;
                            }
                            break;
                        case "APPistol":
                        ...
                        case "BullpupRifle":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Das Craften von {selected} für MerryWeather ist ab Rang 8 Verfügbar", 3000);
                                return;
                            }
                            break;
                        default:
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CraftError), 6000);
                            return;
                    }
                }
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Sie erstellen {selected} für {matsForGun[ WeaponRepository.GetHash(selected)]} Mats", 3000);
            }
            catch (Exception e)
            {
        ...
        public static void Event_WCraftAmmo(ExtPlayer player, int frac, int category, int ammo)
        {
            ...
            {		
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CraftMW2lvl), 6000);
                    return;
                }
                ...
                if (ammo == 0)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoInputAmmos), 6000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Sie erstellen {Chars.Repository.ItemsInfo[AmmoTypes[category]].Name} x{ammo}", 3000);
            }
            catch (Exception e)
            {
            ...
            try
            {
                    ...
                    switch (action)
                    {
                        case "put_stock":
                            ...
                            if (item == "mats")
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WarehouseTooMuch), 6000);
                                    return;
                                }
                                //ItemStruct mItem = Chars.Repository.isItem(player, "inventory", ItemId.Material);
                            ...
                            else if (item == "drugs")
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NarkoWarehouseTooMuch), 6000);
                                    return;
                                }
                            ...
                            if (item == "mats")
                            {
                                ...
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.TakenMats, amount));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FGetMats, player.Name, player.Value, amount), true);
                            }
                            else if (item == "drugs")
                            {
                                fractionData.Drugs += amount;
                                Chars.Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.Drugs, amount);
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs, LangFunc.GetText(LangType.De, DataName.TakenDrugs, amount));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FGetDurgs, player.Name, player.Value, amount), true);
                            }
                            else if (item == "money")
                            {
                                ...
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMoney, LangFunc.GetText(LangType.De, DataName.TakenMoney, MoneySystem.Wallet.Format(amount)));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FGetMoney, player.Name, player.Value, MoneySystem.Wallet.Format(amount)), true);
                            }
                            else if (item == "medkits")
                            {
                                fractionData.MedKits += amount;
                                Chars.Repository.Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.HealthKit, amount);
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.TakenHealthkits, amount));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FGetHealthKits, player.Name, player.Value, amount), true);
                            }
                            GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, item, amount, "in");
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WarehouseLeft, stockContains + amount, playerHave - amount), 6000);
                            fractionData.UpdateLabel();
                            break;
                        case "take_stock":
                            ...
                            if (item == "mats")
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.InventoryFilled), 6000);
                                    return;
                                }
                            }
                            else if (item == "drugs")
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WarehouseEmptyNet), 6000);
                                return;
                            }
                            ...
                            if (item == "mats")
                            {
                                ...
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMats, LangFunc.GetText(LangType.De, DataName.TakeMats, amount));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakenMats, player.Name, player.Value, amount), true);
                            }
                            else if (item == "drugs")
                            {
                                ...
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs, LangFunc.GetText(LangType.De, DataName.TakeNarko, amount));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakenDrugs, player.Name, player.Value, amount), true);
                            }
                            else if (item == "money")
                            {
                                fractionData.Money -= amount;
                                ...
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMoney, LangFunc.GetText(LangType.De, DataName.TakeMoney, MoneySystem.Wallet.Format(amount)));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakenMoney, player.Name, player.Value, MoneySystem.Wallet.Format(amount)), true);
                            }
                            else if (item == "medkits")
                            {
                                ...
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.TakeHealthkits, amount));
                                Manager.sendFractionMessage(fractionData.Id, LangFunc.GetText(LangType.De, DataName.FTakenHealthKits, player.Name, player.Value, amount), true);
                            }
                ...
                else
                {
                    ...
                    if (vehicleLocalData != null)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarCantMoving), 6000);
                            return;
                        }
                        ...
                        switch (action)
                        {
                            case "load_mats":
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ClubNotInFraction, Manager.GetName(sessionData.OnFracStock)), 6000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ThisVehNoMatsHere), 6000);
                                    return;
                                }
                                if (stockFractionData.Materials < amount)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SkaldNoMats), 6000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LimitOnlyMats, maxMats - curmats), 6000);
                                    return;
                                }
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouLoadedMat), 6000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "mats", amount, "out");
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.ZagruzilMatsSoSklad, Manager.GetName(fractionId), amount));
                                return;
                            case "unload_mats":
                                ...
                                if (count < amount)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.InCarMats, count), 6000);
                                    return;
                                }
                                int maxstock = GetMaxStock(fractionData.Id);
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.OnlyZankudo), 6000);
                                    return;
                                }
                                Chars.Repository.Remove(null, VehicleManager.GetVehicleToInventory(vehicle.NumberPlate), "vehicle", ItemId.Material, amount);
                                stockFractionData.Materials += amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouLoadedMats), 6000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "mats", amount, "in");
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.LoadedMats, Manager.GetName(fractionId), amount));
                            ...
                            case "load_drugs":
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorNarkoSklad), 6000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarMaxDrugs), 6000);
                                    return;
                                }
                                else if ((count + amount) > (vMain.GetMaxSlots(vehicle.Model) * Chars.Repository.ItemsInfo[ItemId.Drugs].Stack))
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.InCarSpace, (vMain.GetMaxSlots(vehicle.Model) * Chars.Repository.ItemsInfo[ItemId.Drugs].Stack) - count), 6000);
                                    return;
                                }
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LoadDrugs), 6000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "drugs", amount, "out");
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs, LangFunc.GetText(LangType.De, DataName.LloadedDrugs, Manager.GetName(fractionId), amount));
                                return;
                            case "unload_drugs":
                                ...
                                if (count < amount)
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehNoDrugs), 6000);
                                    return;
                                }
                                ...
                                stockFractionData.Drugs += amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.UnloadedDrugs), 6000);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "drugs", amount, "in");
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeDrugs, LangFunc.GetText(LangType.De, DataName.LoadedDrugs, Manager.GetName(fractionId), amount));
                            ...
                            case "load_medkits":
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorAptekasSklad), 6000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorMedAmount), 6000);
                                    return;
                                }
                                ...
                                fractionData.MedKits -= amount;
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LoadAptekas), 6000);
                                fractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "medkits", amount, "out");
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.LoadedAptekasFromSklad, Manager.GetName(fractionId), amount));
                                return;
                            case "unload_medkits":
                                if (!sessionData.WorkData.OnDuty)
                                {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehNoMedkits), 6000);
                                    return;
                                }
                                if (fractionId == 8)
                                {
                                    ...
                                    {
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SkladNoApteka), 6000);
                                        return;
                                    }
                                }
                                else
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.UnloadedAptekas), 6000);
                                player.AddTableScore(TableTaskId.Item22);
                                stockFractionData.UpdateLabel();
                                GameLog.Stock(fractionData.Id, characterData.UUID, player.Name, "medkits", amount, "in");
                                Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeMedkits, LangFunc.GetText(LangType.De, DataName.LoadedAptekas, Manager.GetName(fractionId), amount));
                                return;
                            default:
                                // Not supposed to end up here. 
                                break;
                ...
                switch (list)
                {
                    case 1:
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SkladFullyClosed), 6000);
                                return;
                            }
                    ...
                    case 2:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotOnSkladPoint), 6000);
                            return;
                        }
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    if (vehicleLocalData.Fraction == (int) Models.Fractions.ARMY)
                    {
                        ...
                        if (count >= 1)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Ressourcen können nur in das Armeelager entladen werden", 3000);
                                return;
                            }
                                ...
                                if (current_count >= 1)
                                {
                                    ...
                                    if (fractionData != null)
                                    {
                                        if (i == 0)
                                        {
                                            ...
                                            LoadInfo += $"{current_count} Stk. Kohle, ";
                                        }
                                        else if (i == 1)
                                        {
                                            fractionData.IronOre += current_count;
                                            LoadInfo += $"{current_count} Stk. Eisenerz, ";
                                        }
                                        else if (i == 2)
                                        {
                                            fractionData.SulfurOre += current_count;
                                            LoadInfo += $"{current_count} Stk. Schwefelerz, ";
                                        }
                                        else if (i == 3)
                                        {
                                            fractionData.PreciousOre += current_count;
                                            LoadInfo += $"{current_count} Stk. Smaragd, ";
                                        }
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "Ressourcen erfolgreich gelagert.", 3000);

                            LoadInfo = LoadInfo.Remove(LoadInfo.Length - 2);
                            Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.TakeOre, $"Erfolgreich ins Army Lager gelagert {LoadInfo}.");
                        }
                    }
                }
            }
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    switch (eventName)
                    {
                        case "loadmats":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Sie sind kein Mitglied von {Manager.GetName(sessionData.OnFracStock)}", 3000);
                                return;
                            }
    ...
    class MatsWar : Script
    {
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                warblip = (ExtBlip) NAPI.Blip.CreateBlip(601, warPosition, 1, 4, Main.StringToU16("National Guard"), 255, 0, true, 0, 0);
            }
            catch (Exception e)
            {
        ...
        public static void startWar()
        {
            ...
            {
                if (isWar) return;
                NAPI.Chat.SendChatMessageToAll("~o~[MATWAR] \"Krieg um Mats\" hat begonnen!");
                ...
                isWar = true;
                Manager.sendFractionMessage((int) Models.Fractions.FAMILY, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.BALLAS, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.VAGOS, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.MARABUNTA, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.BLOOD, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.LCN, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.RUSSIAN, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.YAKUZA, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.THELOST, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
                Manager.sendFractionMessage((int) Models.Fractions.MERRYWEATHER, LangFunc.GetText(LangType.De, DataName.WzmShipGoing));
        ...
        public static void endWar()
        {
            try
            {
                NAPI.Task.Run(() =>
                {
                    try
                    {
                        NAPI.Chat.SendChatMessageToAll("~o~[MATWAR] \"Krieg um Mats\" ist beendet!");
                ...
                Manager.sendFractionMessage((int) Models.Fractions.FAMILY, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.BALLAS, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.VAGOS, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.MARABUNTA, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.BLOOD, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.LCN, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.RUSSIAN, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.YAKUZA, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.THELOST, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
                Manager.sendFractionMessage((int) Models.Fractions.MERRYWEATHER, LangFunc.GetText(LangType.De, DataName.WzmShipGone));
        ...
        public static void CheckMatWarDropLockStatus(ExtPlayer player, int ShapeId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PressEtoLockPick), 6000);
        ...
        public static void StartedMatWarHack(ExtPlayer player, int ShapeId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RestrictedForAdmin), 6000);
                    return;
                }
                ...
                if (count == 0)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoArmyLockpick), 6000);
                    return;
                }
                ...
                if (ShapeId == 100)
                {
                    if (MatWarDropHealth > 0)
                    {
                        if (MatWarDropHackPlayerInfo != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SomebodyHacking), 6000);
                                return;
                            }
                        }
            ...
            try
            {
                ...
                if (ShapeId == 100)
                {
                    ...
                    if (MatWarDropHealth <= 0)
                    {
                        ...
                        if (hack_chance <= 50)
                        {
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucZamok), 6000);
                        ...
                        else
                        {
                            MatWarDropHealth = 20;
                            Trigger.ClientEvent(player, "client.updateMatWarHackStatus", true, MatWarDropHealth);
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FailZamok), 6000);
                        }
        ...
        public static void OnWar(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCantMatsWar), 6000);
                    return;
                }
                if (!player.IsInVehicle)
                {
                ...
                if (vehicleLocalData != null)
                {
                    if (!vehicleLocalData.CanMats)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantMoveMatsVeh), 6000);
                        return;
                    }
                    if (sessionData.TimersData.LoadMatsTimer != null)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LoadingMatsvehUzhe), 6000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarMaxMats), 6000);
                        return;
                    }
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LoadingMatsStarted), 6000);
                    Trigger.ClientEvent(player, "showLoader", LangFunc.GetText(LangType.De, DataName.LoadingMats), 1);
        ...
        public static void OutWar(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MatLoadingCancelByCheckpoint), 6000);
                }
            }
            catch (Exception e)
            {
