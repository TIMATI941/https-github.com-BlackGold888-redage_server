    ...
    class Lawnmower : Script
    {
        ...
        private static List<List<Vector3>> MowerWays = new List<List<Vector3>>()
        {
            new List<Vector3>()
            {
                ...
                new Vector3(-1298.156, -14.02906, 49.41903),    // 71
                new Vector3(-1309.017, 4.108258, 50.99983),     // 72
                new Vector3(-1318.991, 25.81007, 53.54743),     // 73
        ...
        public static void StartWork(ExtPlayer player)
        {
            ...
            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.StartLawnmower), 6000);
        }
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    else
                    {
                        ...
                        if (bonusPay > 0)
                        {
                            ...
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusPay, bonusPay), 6000);
