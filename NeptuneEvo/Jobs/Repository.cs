...
namespace NeptuneEvo.Jobs
{
    public class Repository
    {
        public static void OnPlayerEnterVehicle(ExtPlayer player, ExtVehicle vehicle, sbyte seatId)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehBusy), 6000);
        ...
        public static void OnPlayerExitVehicle(ExtPlayer player, ExtVehicle vehicle)
        {
            ...
            Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.FjobNotify));
            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehjobNotify), 8000);
