...
namespace NeptuneEvo
{
    ...
    {
        public static string Codename { get; } = "Rockford RP";
        ...
        public static void LoadServerSettings()
        {
            ...
            Manager.FractionDataMats[100].Price = $"{Main.PricesSettings.InstrumentPrices[4]}$";
            Manager.FractionDataMats[101].Price = $"{Main.PricesSettings.InstrumentPrices[5]}$";
        ...
        public void onResourceStart()
        {
            try
            {
                ...
                /*CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-358.4868, -52.37103, 53.29886), 38, true, 0.5f));
                CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(22.71732, -1737.653, 28.18297), 38, true, 0.5f));
                CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-1646.822, -228.72, 55.92), 38, true, 0.5f));
                CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-2025.384, -469.42, 11.42), 38, true, 0.5f));
                CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(1188.66, -1548.76, 39.37), 38, true, 0.5f));
                CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-975.0394, -1474.377, 5.020052), 38, true, 0.5f));
                CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-39.57354, 211.735, 106.1348), 38, true, 0.5f));

                if (ServerNumber <= 1) // Поставлены только на Black'е и отображать на Test'овом
                {
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-740.8164, -67.55, 41.75), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-927.72, -164.84, 41.87), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-482.2281, -612.549, 32.47), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(1032.372, -771.5231, 56.94999), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(1151.805, -477.1126, 65.16711), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(1230.796, -435.7309, 66.61465), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(1096.052, -335.8769, 66.10432), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(1142.26, -392.178, 65.92946), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-2162.425, -399.813, 12.26453), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-463.0861, -806.9484, 29.41866), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-1245.905, -1413.595, 4.322968), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(373.6721, 279.976, 103.3404), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(281.2544, -194.9666, 61.57069), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-204.1797, 308.1642, 96.94662), 38, true, 0.5f));
                    CreateBlip(new BlipData(267, LangFunc.GetText(LangType.De, DataName.Parking), new Vector3(-354.1708, 286.2279, 84.74282), 38, true, 0.5f));
                }*/

                //CreateBlip(new BlipData(304, LangFunc.GetText(LangType.De, DataName.Theather), new Vector3(683.739, 570.40, 130.46), 7, true));
                //CreateBlip(new BlipData(455, LangFunc.GetText(LangType.De, DataName.Yacht), new Vector3(-2070.151, -1023.134, 11.9), 81, true));
                //CreateBlip(new BlipData(311, LangFunc.GetText(LangType.De, DataName.Gym), new Vector3(-1202.281, -1568.798, 3.488338), 4, true));
                
                //CreateBlip(new BlipData(93, "Strand Party", new Vector3(-1497.7688, -1484.525, 5.7608714), 4, true)); // todo LangFunc
                //CreateBlip(new BlipData(766, "Strand", new Vector3(5024.207, -5122.8962, 3.701595), 43, true)); // 
                //CreateBlip(new BlipData(93, "Strand Party", new Vector3(-1705.88, -970.7998, 8.648665), 4, true)); // todo LangFunc
        ...
        {
            if (player == null) return;
            Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.Greetings1));
            Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.Greetings2));
            Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.Greetings3));
            Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.Greetings4));
            Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.Greetings5));
        }
        #endregion Player
        ...
        public static void RagempCheatDetected(ExtPlayer player, int cheatCode)
        {
            try
            {
                ...
                Trigger.SendPunishment(LangFunc.GetText(LangType.De, DataName.AutoACBan, player.Name, cheatCode), player);
                DateTime until = DateTime.Now.AddDays(999);
                Ban.Online(player, until, true, $"Cheats({cheatCode})", "AntiCheat");
                Notify.Send(player, NotifyType.Warning, NotifyPosition.Center, LangFunc.GetText(LangType.De, DataName.YouBannedPerm), 30000);
                Notify.Send(player, NotifyType.Warning, NotifyPosition.Center, LangFunc.GetText(LangType.De, DataName.ReasonCheats, cheatCode), 30000);
                GameLog.Ban(0, characterData.UUID, player.GetLogin(), until, LangFunc.GetText(LangType.De, DataName.ReasonCheats, cheatCode), true);
                player.Kick();
            }
            catch (Exception e)
            {
        ...
        public void ClientEvent_KeyInsert(ExtPlayer player)
        {
            ...
            try
            {
                ...
                Trigger.SendToAdmins(5, LangFunc.GetText(LangType.De, DataName.InsertTrigger, player.Name, player.Value, characterData.LVL));
            }
            catch (Exception e)
            {
        ...
        public void ClientEvent_SyncWP(ExtPlayer player, float X, float Y)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VoditeluPeredalDannie), 6000);
        ...
        public void ClientEvent_SyncWP(ExtPlayer player)
        {
            try
            {
                ...
                if (veh.GetSharedData<bool>("SIRENSOUND") == true)
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WeeWeeOn), 1000);
                }
                else
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WeeWeeOff), 1000);
                }
            }
            catch (Exception e)
            {
        ...
        public static bool IHaveDemorgan(ExtPlayer player, bool withsmg = false)
        {
            try
            {
                ...
                {
                    if (withsmg) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.IHaveDemorgan), 4000);
                    return true;
                }
                else return false;
            }
        ...
        public void StartPushVehicle(ExtPlayer player, ExtVehicle vehicle)
        {
            try
            {
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoKeysFromVeh), 6000);
                        return;
                    }
                    ...
                    if (vehicleData != null)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarDead), 6000);
                            return;
                        }
                    }
            ...
            try
            {
                ...
                switch (callback)
                {
                    ...
                    case "fuelcontrol_news":
                        ...
                        {
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VvedireCorrect), 6000);
                            return;
                        }
                        switch (callback)
                        {
                            case "fuelcontrol_city":
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FuelcontrolCity, limit), 6000);
                                break;
                            case "fuelcontrol_police":
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FuelcontrolPolice, limit), 6000);
                                break;
                            case "fuelcontrol_ems":
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FuelcontrolEms, limit), 6000);
                                break;
                            case "fuelcontrol_fib":
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FuelcontrolFib, limit), 6000);
                                break;
                            case "fuelcontrol_army":
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FuelcontrolArmy, limit), 6000);
                                break;
                            case "fuelcontrol_news":
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FuelcontrolNews, limit), 6000);
                                break;
                        }
                        return;
                    case "club_setprice":
                    ...
                    case "mayor_take":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoCityhallGov, Cityhall.canGetMoney), 6000);
                            return;
                        }
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoneyGov), 6000);
                            return;
                        }
                    ...
                    case "take_stock":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ServerCantAccept), 6000);
                            return;
                        }
                    ...
                    case "streetrace":
                        ...
                        {
                            Trigger.ClientEvent(player, "openInput", "Straßenrennen", LangFunc.GetText(LangType.De, DataName.InputBet0100k), 6, "streetrace");
                            return;
                        }
                    ...
                    case "sellcar":
                        ...
                        if (house != null)
                        {
                            ...
                            {
                                sessionData.SellItemData = new SellItemData();
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,LangFunc.GetText(LangType.De, DataName.PlayerNoGarage), 6000);
                                return;
                            }
                            ...
                            {
                                sessionData.SellItemData = new SellItemData();
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerMaxVehGarage), 6000);
                                return;
                            }
                        }
                        else
                        {
                            ...
                            {
                                sessionData.SellItemData = new SellItemData();
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerMaxVeh), 6000);
                                return;
                            }
                        }
                        ...
                        {
                            sessionData.SellItemData = new SellItemData();
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehNotExists), 6000);
                            return;
                        }
                        ...
                        EventSys.SendCoolMsg(player,"Angebot", "Kauf", $"{LangFunc.GetText(LangType.De, DataName.BuycarOffer, target.Name, vName, number, MoneySystem.Wallet.Format(limit))}", "", 5000);
                        //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuycarOffer, target.Name, vName, number, MoneySystem.Wallet.Format(limit)), 6000);
                        ...
                        Trigger.ClientEvent(target, "openDialog", "BUY_CAR", LangFunc.GetText(LangType.De, DataName.BuycarOffered, player.Name, vName, number, MoneySystem.Wallet.Format(limit)));
                        return;
                    case "weaptransfer":
                        limit = 0;
                        if (text.Contains('.')) text = text.Replace(".", null);
                    ...
                    case "sell_festive":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AmountIncorrect), 6000);
                            return;
                        }
                        if (limit % 3 != 0)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NumberNotDelitsya), 6000);
                            return;
                        }
                        int count = Chars.Repository.getCountItem($"char_{characterData.UUID}", Festive.EventCoins, bagsToggled: false);
                        if (limit > count)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoCoins), 6000);
                            return;
                        }
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucTradeCoins, limit, prefix, rb), 6000);
                        UpdateData.RedBucks(player, rb, msg:LangFunc.GetText(LangType.De, DataName.ExchangeCoins, Festive.EventCoinsName));
                        break;
                    case "rentname":
                        ...
                        Trigger.SendToAdmins(1, LangFunc.GetText(LangType.De, DataName.TentPostavil, player.Name, player.Value, text));
                        break;
                    case "sell_tent":
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantSellItem), 6000);
                            return;
                        }
                        ...
                        if (inventoryTentData.Value == Item.Count)
                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SellItemTent, Chars.Repository.ItemsInfo[Item.ItemId].Name, limit), 10000);
                            return;
                        }
                    ...
                    case "make_ped_name":
                        ...
                        if (text.Length >= 36)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Name36ogran), 6000);
                            return;
                        }
                    ...
                    case "player_ticketsum":
                        ...
                        Trigger.ClientEvent(player, "openInput", "Straffzettel ausstelen", "Grund", 50, "player_ticketreason");
                        break;
        ...
        public void DoorControlState(ExtPlayer player, string door)
        {
            try
            {
                ...
                if (DoorsControl[door]) 
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DoorsClosed), 6000);
                else 
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DoorsOpened), 6000);
            ...
            try
            {
                ...
                {            
                    ...
                    if (house != null && (sessionData.Name == house.Owner || house.Roommates.ContainsKey(sessionData.Name)))
                    {
                        ...
                        if (house.Locked)
                        {
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.HouseClosed), 6000);
                            BattlePass.Repository.UpdateReward(player, 125);
                        }
                        else
                        {
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.HouseOpened), 6000);
        ...
        public void RemoteEvent_acceptPressed(ExtPlayer player)
        {
            try
            {
                ...
                if (DateTime.Now >= sessionData.RequestData.Time)
                {
                    ...
                    Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.OfferTimeout), 1500);
        ...
        public void RemoteEvent_cancelPressed(ExtPlayer player)
        {
            try
            {
                ...
                {
                    case "acceptPass":
                        if (characterData.Gender) Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.HePassNo));
                        else Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.ShePassNo));
                        break;
                    case "acceptLics":
                        if (characterData.Gender) Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.HeLicNo));
                        else Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.SheLicNo));
                        break;
                    case "HANDSUP":
                        if (characterData.Gender) Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.NoHandsUp));
                        else Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.SheNoHandsUp));
                        break;
                    default:
                        break;
                }
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CancelOffer), 6000);
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (yes)
                {
                    ...
                    switch (callback)
                    {
                        case "RepairMyVeh":
                            ...
                            {
                                Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoneyMech), 6000);
                                return;
                            }
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RepairPayed), 6000);
                            BattlePass.Repository.UpdateReward(player, 13);
                            Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.RepairVehi));
                            return;
                        case "FORGET_FRIENDS":
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ForgotFriends), 6000);
                            return;
                        case "PAY_MEDKIT":
                        ...
                        case "DICE_PLAY":
                            {
                                if (sessionData.DiceData.Target != null)
                                {
                                    ...
                                    {
                                        sessionData.DiceData = new DiceData();
                                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.OpponentNotFound), 6000);
                                    }
                                    else
                                    {
                                        ...
                                        if (characterData.Money < dicemon)
                                        {
                                            ...
                                            sessionData.DiceData = new DiceData();
                                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoney), 6000);
                                            Notify.Send(diceplayer, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerNotEnoughMoney), 6000);
                                            return;
                                        }
                                        if (diceplayerCharacterData.Money < dicemon)
                                        {
                                            diceplayerSessionData.DiceData = new DiceData();
                                            sessionData.DiceData = new DiceData();
                                            Notify.Send(diceplayer, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoney), 6000);
                                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerNotEnoughMoney), 6000);
                                            return;
                                        }
                                        if (!characterData.InCasino || !diceplayerCharacterData.InCasino)
                                        {
                                            ...
                                            Notify.Send(diceplayer, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GameCancelCuzNoCasino), 6000);
                                            return;
                                        }
                                        if (sessionData.IsCasinoGame != null)
                                        {
                                            ...
                                            Notify.Send(diceplayer, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GameCancelled), 6000);
                                            return;
                                        }
                                        ...
                                        Notify.Send(diceplayer, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerAcceptOffer, player.Value), 6000);
                        ...
                        case "RENTCARI_DATETIME":
                            if (sessionData.RentData != null)
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyRentMaxTime), 8000);
                                    return;
                                }
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoBankMoney), 5000);
                                    return;
                                }
                                rentCar.Date = rentCar.Date.AddMinutes(59);
                                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SuccessfullRentExpand, rentCar.Date), 5000);
                                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent, LangFunc.GetText(LangType.De, DataName.SuccessfullRentExpand, rentCar.Date), DateTime.Now);  
                            }
                            return;
                        ...
                        case "BUY_CAR":
                            {
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Du kaufst {vehicleData.Model} ({number}) für {MoneySystem.Wallet.Format(price)}$ у {seller.Name}", 6000);
                                Notify.Send(seller, NotifyType.Success, NotifyPosition.BottomCenter, $"{player.Name} kauf bei dir {vehicleData.Model} ({number}) für {MoneySystem.Wallet.Format(price)}$", 6000);
                                sellerSessionData.SellItemData = new SellItemData();
                                sessionData.SellItemData = new SellItemData();
                        ...
                        case "REMOVE_SNUM":
                            {
                                ...
                                {
                                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoContacts, num), 4000);
                                    return;
                                }
                                Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DelContact, num), 4000);
                        ...
                        case "INVITED_FRAC":
                            {
                                try
                                {
                                    if (sessionData.InviteData.Fraction != -1)
                                    {
                                       ...
                                       // Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.JoinFrac, Fractions.Manager.FractionNames[fractionId]), 6000);
                                        EventSys.SendCoolMsg(player,"Fraktion", "Herzlich Willkommen!", LangFunc.GetText(LangType.De, DataName.JoinFrac, Fractions.Manager.FractionNames[fractionId]), "", 8000); 
                                        
                                        Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AcceptJoinFrac, player.Name), 6000);
                                        //EventSys.SendCoolMsg(target,"Fraktion", "Приглашение",  LangFunc.GetText(LangType.De, DataName.AcceptJoinFrac, player.Name), "", 8000); 
                                        GameLog.FracLog(fractionId, target.GetUUID(), characterData.UUID, target.Name, player.Name, "invite");
                                        Fractions.Table.Logs.Repository.AddLogs(target, FractionLogsType.Invite, LangFunc.GetText(LangType.De, DataName.AcceptedFrac, player.Name, characterData.UUID));
                                        Fractions.Table.Logs.Repository.AddLogs(player, FractionLogsType.Invite, LangFunc.GetText(LangType.De, DataName.InvitedFrac, target.Name, target.GetUUID()));
                                    }
                                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.InvitedOffline), 6000);
                                }
                        ...
                        case "INVITED_ORG":
                            {
                                try
                                {
                                    if (sessionData.InviteData.Organization != -1)
                                    {
                                        ...
                                        //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.JoinFrac, organizationData.Name), 6000);
                                        EventSys.SendCoolMsg(player,"Organisation", "Herzlich Willkommen!", LangFunc.GetText(LangType.De, DataName.JoinFrac, organizationData.Name), "", 8000); 
                                        Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AcceptedOrg, player.Name), 6000);
                                        //EventSys.SendCoolMsg(target,"Organisation", "Приглашение",  LangFunc.GetText(LangType.De, DataName.AcceptedOrg, player.Name), "", 8000); 
                                        Organizations.Table.Logs.Repository.AddLogs(target, OrganizationLogsType.Invite, LangFunc.GetText(LangType.De, DataName.AcceptedFrac, player.Name, characterData.UUID));
                                        Organizations.Table.Logs.Repository.AddLogs(player, OrganizationLogsType.Invite, LangFunc.GetText(LangType.De, DataName.InvitedFrac, target.Name, targetCharacterData.UUID));
                                    }
                                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.InvitedOffline), 6000);
                                }
                                catch { Log.Write("RemoteEvent_DialogCallback23 ERROR"); }
                        ...
                        case "CAR_SELL_TOGOV":
                            {
                                if (sessionData.CarSellGov != null)
                                {
                                    ...
                                    //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouSellCar, vehicleData.Model, number, MoneySystem.Wallet.Format(price)), 6000);
                                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Bank, LangFunc.GetText(LangType.De, DataName.YouSellCar, vehicleData.Model, number, MoneySystem.Wallet.Format(price)), DateTime.Now);
                        ...
                        case "CONFIRM_BUY_BODYARMOUR":
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CrimeBuyBronik), 6000);
                                return;
                            }
                            if (Chars.Repository.itemCount(player, "inventory", ItemId.BodyArmor) >= Chars.Repository.maxItemCount)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyHaveBronik), 6000);
                                return;
                            }
                            ...
                            if (count < 150)
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMats), 6000);
                                return;
                            }
                            ...
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Bronik50Crafted), 6000);
                            return;
                            ...
                            switch (weddingData.type)
                            {
                                case 0:
                                    ...
                                    if (weddingData.typeSurname == 0) 
                                        Trigger.ClientEvent(weddingData.player, "openDialog", "Boda", LangFunc.GetText(LangType.De, DataName.YouWantWedding, player.Name, characterData.LastName)); 
                                    else 
                                        Trigger.ClientEvent(weddingData.player, "openDialog", "Boda", LangFunc.GetText(LangType.De, DataName.YouWantWeddingTo, player.Name)); 
                                    break;
                                case 1:
                ...
                else
                {
                    ...
                    switch (callback)
                    {
                        ...
                        case "GUN_LIC":
                        case "PM_LIC":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucCancelBuyLic), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelBuyLic), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            break;
                        case "BUSINESS_BUY":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelBuyBiz), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelBuyBiz), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "FUEL_CAR":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelZapravka), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelFuel), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "REPAIR_CAR":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelRepairVeh), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelRepairVeh), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "HOUSE_SELL":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelBuyHome), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelBuyHome), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "PAY_HEAL":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelHeal), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelHeal), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "PAY_MEDKIT":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelMedkit), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelMedkit), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "BUY_CAR":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelVeh), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelVeh), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "DICE_PLAY":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelDice), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.DiceData = new DiceData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelDice), 6000);
                            sellerSessionData.DiceData = new DiceData();
                            sessionData.DiceData = new DiceData();
                            return;
                        case "ROOM_INVITE":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelHomeGo), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelHomeGo), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "BUS_RENT":
                        ...
                        case "RENT_CAR":
                            ...
                            return;
                        case "TAXI_PAY":
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCancelPayBus), 6000);
                            if (sellerSessionData == null)
                            {
                                sessionData.SellItemData = new SellItemData();
                                return;
                            }
                            Notify.Send(seller, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelPayBus), 6000);
                            sellerSessionData.SellItemData = new SellItemData();
                            sessionData.SellItemData = new SellItemData();
                            return;
                        case "TICKET":
        ...
        public Main()
        {
            try
            {
                NAPI.Task.Run(async () =>
                {
                    while (true)
                    {
                        ...
                        foreach (var player in NAPI.Pools.GetAllPlayers().Cast<ExtPlayer>())
                        {
                            ...
                            {
                                Trigger.SendToAdmins(1, $"~r~ Spieler {player.Name} ({player.Id}) {player.Address} wurde vom System vom Server gekickt");
                                player.Kick();
                            }
                        }
                    }
                ...
                NAPI.Server.SetCommandErrorMessage("Befehl nicht gefunden!");
                ...
                {
                    new ConnectionInfo("MainDB", mainDB.Server,
                    mainDB.User,
                    mainDB.Password,
                    mainDB.DataBase,
                    mainDB.Port),

                    new ConnectionInfo("ConfigDB", mainDB.Server,
                    mainDB.User,
                    mainDB.Password,
                    $"{mainDB.DataBase}config",
                    mainDB.Port),

                    new ConnectionInfo("WebSiteBD", mainDB.Server,
                    mainDB.User,
                    mainDB.Password,
                    mainDB.DataBase,
                    mainDB.Port)
            ...
            Trigger.SetTask(async () =>
            {
                try
                {
                    ...
                    if (compensation != null)
                    {
                        ...
                        {
                            UpdateData.RedBucks(player, compensation.Donate, msg: $"erhaltene Entschädigung in der Form von ({compensation.Donate})");
        ...
        private static void OnlineReward(ExtPlayer player, byte hours, int redbuckses)
        {
            try
            {
                ...
                var characterData = player.GetCharacterData();
                if (characterData == null) return;
                UpdateData.RedBucks(player, redbuckses, msg: "Spielzeit Belohnung");
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, LangFunc.GetText(LangType.De, DataName.BonusEverdayOnline, hours, redbuckses), DateTime.Now);
                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusEverdayOnline, hours, redbuckses), 5000);
                EventSys.SendCoolMsg(player,"System", "Belohnung: für Spielzeit", $"{LangFunc.GetText(LangType.De, DataName.BonusEverdayOnline, hours, redbuckses)}", "", 10000);
                if (!characterData.Achievements[16])
                {
                    characterData.Achievements[16] = true;
                    Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RbBonus1), 30000);
                    Notify.SendToKey(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RbBonus2), 30000, 21);
                }
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (AutoRestart) // Check AutoRestart
                {
                    if (now.Hour == 6)
                    {
                        if (now.Minute == 0)
                        {
                            NAPI.Chat.SendChatMessageToAll("!{#FF0000}[AUTO RESTART] Liebe Spieler, um 06:15 erfolgt ein automatischer Serverneustart.");
                        }
                        else if (now.Minute == 5)
                        {
                            NAPI.Chat.SendChatMessageToAll("!{#FF0000}[AUTO RESTART] Liebe Spieler, wir erinnern Sie daran, dass der Server um 06:15 automatisch neu gestartet wird.");
                        }
                        ...
                        else if (now.Minute == 15 || now.Minute == 16)
                        {
                            ...
                            {
                                NAPI.Chat.SendChatMessageToAll("!{#FF0000}[AUTO RESTART] Liebe Spieler, jetzt wird der Server automatisch neu gestartet, der Server wird in etwa ein paar Minuten wieder verfügbar sein.");
                                Admin.stopServer("Es gibt einen automatischen Neustart, wir freuen uns, Sie in ein paar Minuten wiederzusehen! :)");
                            }
                        }
                    }
                }
                ...
                if (dayofweek == DayOfWeek.Wednesday || dayofweek == DayOfWeek.Friday || dayofweek == DayOfWeek.Sunday)
                {
                    ...
                    {
                        NAPI.Chat.SendChatMessageToAll(LangFunc.GetText(LangType.De, DataName.MatwarStart)); ;
                        EventSys.SendPlayersToEvent("MATS WAR", "Kampf um Materialien!", $"Um 20:00 beginnt der Kampf um Materialien!", "", 15000);
                    }
                ...
                foreach (ExtPlayer foreachPlayer in Character.Repository.GetPlayers())
                {
                        ...
                        switch (foreachCharacterData.Time.TodayTime)
                        {
                            ...
                            case 180:
                                ...
                                if (!foreachCharacterData.Achievements[17])
                                {
                                    ...
                                    Notify.SendToKey(foreachPlayer, NotifyType.Alert, NotifyPosition.BottomCenter, $"Im Donationmenü (F9) steht Ihnen jetzt eine Free Daily Case zur Verfügung. Sie können es 1 Mal pro Tag kostenlos öffnen, nachdem Sie 3 Stunden gespielt haben.", 9000, 21);
                                }
                                break;
                            case 240:
                            ...
                            case 300:
                                ...
                                if (!foreachCharacterData.Achievements[23])
                                {
                                    ...
                                    Notify.SendToKey(foreachPlayer, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Case0get), 30000, 21);
                                }
                                break;
                            case 480:
                                ...
                                if (!foreachCharacterData.Achievements[24])
                                {
                                    ...
                                    Notify.SendToKey(foreachPlayer, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Case1get), 30000, 21);
                                }
                                break;
                        }
                    }
                    ...
                    {
                        UpdateData.RedBucks(foreachPlayer, 500, msg: "Spielzeit Belohnung"); //Monatlich
                        Notify.Send(foreachPlayer, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Case2get), 5000);
                    }
                    if (foreachAccountData.VipLvl > 0 && foreachAccountData.VipDate <= DateTime.Now)
                    {
                        foreachAccountData.VipLvl = 0;
                        Notify.Send(foreachPlayer, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VipIsOver), 6000);
                    }
                    ...
                    try
                    {
                        if (foreachSessionData.RentData != null && !foreachSessionData.RentData.IsJob && now > foreachSessionData.RentData.Date)
                        {
                            ...
                            Notify.Send(foreachPlayer, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RentOver), 6000);
                        }
                    }
                    catch (Exception e)
                    {
            ...
            try
            {
                ...
                if (BonusCodes.ContainsKey(text))
                {
                    lock (BonusCodes)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusUsed), 5000);
                            return;
                        }
                        ...
                        if (pcdata.UsedLimit == 0 || pcdata.UsedTimes < pcdata.UsedLimit)
                        {
                            ...
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.OpenGift), 6000);
                            if (characterData.Gender) Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.OpenedGift));
                            else Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.OpenedaGift));
                            ...
                            if (pcdata.RewardVipLvl != 0)
                            {
                                if (accountData.VipLvl == 0)
                                {
                                    ...
                                    {
                                        case 1:
                                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BronzeBonus, pcdata.RewardVipDays), 15000);
                                            break;
                                        case 2:
                                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SilverBonus, pcdata.RewardVipDays), 15000);
                                            break;
                                        case 3:
                                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GoldBonus, pcdata.RewardVipDays), 15000);
                                            break;
                                        case 4:
                                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlatinumBonus, pcdata.RewardVipDays), 15000);
                                            break;
                                        default:
                                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorBonus, pcdata.RewardVipDays), 15000);
                                            break;
                                    }
                                    accountData.VipLvl = pcdata.RewardVipLvl;
                                    accountData.VipDate = DateTime.Now.AddDays(pcdata.RewardVipDays);
                                    GameLog.Money($"system", $"player({characterData.UUID})", 0, $"bonusVIP({accountData.VipLvl}lvl, {pcdata.RewardVipDays}d, verlängert bist {accountData.VipDate.ToString("s")})");
                                }
                                ...
                                else
                                {
                                    ...
                                    GameLog.Money($"system", $"player({characterData.UUID})", 0, $"bonusVIP({accountData.VipLvl}lvl, {days}d, verlängert bist {accountData.VipDate.ToString("s")})");
                                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DaysDop, days), 15000);
                                }
                            ...
                            if (characterData.Gender)
                            {
                                if (pcdata.RewardItemsMale.Count != 0)
                                {
                                    ...
                                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusItems, pcdata.RewardItemsMale.Count), 15000);
                                }
                            }
                            else
                            {
                                if (pcdata.RewardItemsFemale.Count != 0)
                                {
                                    ...
                                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusItems, pcdata.RewardItemsFemale.Count), 15000);
                                }
                            }
                        ...
                        else if (pcdata.UsedLimit != 0 && pcdata.UsedTimes >= pcdata.UsedLimit) Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusEnd, pcdata.UsedLimit), 6000);
                    }
                }
                else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoBonusMore), 5000);
            }
            catch (Exception e)
            {
            ...
            try
            {
                            ...
                            if (pcdata.RewardLimit == 0 || pcdata.RewardReceived < pcdata.RewardLimit)
                            {
                                ...
                                if (pcdata.RewardVipLvl != 0)
                                {
                                    if (accountData.VipLvl == 0)
                                    {
                                        accountData.VipLvl = pcdata.RewardVipLvl;
                                        accountData.VipDate = DateTime.Now.AddDays(pcdata.RewardVipDays);
                                        GameLog.Money($"system", $"player({characterData.UUID})", 0, $"promoCodeVIP({accountData.VipLvl}lvl, {pcdata.RewardVipDays}d, verlängert bist {accountData.VipDate.ToString("s")})");
                                    }
                                    else if (accountData.VipLvl == pcdata.RewardVipLvl)
                                    {
                                        accountData.VipDate = accountData.VipDate.AddDays(pcdata.RewardVipDays);
                                    ...
                                    else
                                    {
                                        ...
                                        accountData.VipDate = accountData.VipDate.AddDays(days);
                                        GameLog.Money($"system", $"player({characterData.UUID})", 0, $"promoCodeVIP({accountData.VipLvl}lvl, {days}d, verlängert bist {accountData.VipDate.ToString("s")})");
                                        Trigger.SendChatMessage(player, $"Da Sie bereits VIP besitzen, wurde es um {days} verlängert!");
                                    }
                                ...
                                if (pcdata.CreatorUUID != 0)
                                {
                                    ...
                                    if (target != null)
                                    {
                                        ...
                                        Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NagradaLvlPromo, player.Name), 5000);
                                        isGiven = true;
                                    }
                                    if (!isGiven) 
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusEnd, pcdata.RewardLimit), 6000);
                        }
                    }
                    else
                    {
                        accountData.PromoCodes[0] = "noref";
                        Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BonusOver), 7000);
                    }
                }
                ...
                if (accountData.RefferalId != 0 && !accountData.RefPresentGet)
                {
                    if (characterData.LVL >= 3)
                    {
                        ...
                        UpdateData.RedBucks(player, 100, msg:"Geschenk für die Eingabe eines Promo-Code");
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RefBonus, characterData.LVL), 15000);
                        ...
                        Trigger.SetTask(async () =>
                        {
                            try
                            {
                                ...
                                {
                                    var successText = LangFunc.GetText(LangType.De, DataName.RefBonusGet, sessionData.Name);
                                    if (refferalData.VipId > 0)
                                    {
                                        successText += $" {Group.GroupNames[refferalData.VipId]} ({refferalData.VipDays} Tage);";
                                    ...
                                    {
                                        successText += $"Kostenlose drehung";
                                    ...
                                    {
                                        successText += $" Ingame Währung (+{MoneySystem.Wallet.Format(refferalData.Money)}$);";
                                        MoneySystem.Wallet.Change(target, +refferalData.Money);
                                    }
                                    if (refferalData.RB > 0)
                                    {
                                        successText += $" Rockford-Coins (+{MoneySystem.Wallet.Format(refferalData.RB)}RC);";
                                        UpdateData.RedBucks(target, refferalData.RB, msg:"Empfehlungsbonus");
                                    }
                ...
                if (accountData.PromoCodes[0] == "noref" && accountData.RefferalId == 0 && !accountData.PresentGet && !accountData.RefPresentGet) 
                    Trigger.SendChatMessage(player, "~r~Sie haben bei der Registrierung keinen Promocode eingegeben. Sie können trotzdem jeden Promocode über das Telefon aktivieren (M -> Geschenk).");
            }
            catch (Exception e)
            {
        ...
        public static void payDayTrigger(bool withlottery)
        {
            try
            {
                ...
                World.Drugs.DrugsHandler.RespawnPlants();
                World.Drugs.DrugsHandler.CreateDealler();
                ...
                if (withlottery)
                {
                    try
                    {
                        if (MoneySystem.Lottery.Price == 0) 
                            NAPI.Chat.SendChatMessageToAll(LangFunc.GetText(LangType.De, DataName.LotteryAnnouncer));
                        else
                        {
                            // Конец этой игры
                            ...
                            if (PlayerNames.ContainsKey(winuuid)) // Если персонаж победителя еще существует
                            {
                                ...
                                if (target != null)
                                {
                                    ...
                                    Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LotteryWinner), 5000);
                                }
                                else
                                ...
                                NAPI.Chat.SendChatMessageToAll($"~g~[LOTTERIE] {PlayerNames[winuuid]} knackt den Jackpot in höhe von {MoneySystem.Wallet.Format(MoneySystem.Lottery.Price)}$ mit einer wahrscheinlichkeit von {(MoneySystem.Lottery.LotteryBought.Where(p => p.Value == winuuid).Count() * 100.0 / MoneySystem.Lottery.LotteryBought.Count()).ToString("0.##")}%.");
                                NAPI.Chat.SendChatMessageToAll(LangFunc.GetText(LangType.De, DataName.LotteryTicketSold, MoneySystem.Lottery.LotteryBought.Count(), winnumb));
                            ...
                            else NAPI.Chat.SendChatMessageToAll("~g~[LOTTERIE] Aufgrund eines technischen Fehlers findet die Ziehung erst in einer Stunde statt.");
                        }
                    }
                    catch (Exception e)
                    {
                    ...
                    try
                    {
                        ...
                        if (foreachCharacterData.HotelID != -1)
                        {
                            if (foreachCharacterData.HotelLeft-- <= 0)
                            {
                                ...
                                Notify.Send(foreachPlayer, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.HotelLeftNoMoney), 15000);
                            }
                        }

                        if (foreachCharacterData.LastHourMin < 1)
                        {
                            //Chars.Repository.PlayerStats(player);
                            GameLog.Money($"server", $"player({foreachCharacterData.UUID})", 0, "nopayday(15min)");
                            Notify.Send(foreachPlayer, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustPlay15MinForPd), 6000);
                            continue;
                        }
                        if (foreachAccountData.VipLvl == 3)
                        {
                            UpdateData.RedBucks(foreachPlayer, 2, msg:String.Empty);
                            Notify.Send(foreachPlayer, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Platinum2RB), 6000);
                        }
                        if (foreachAccountData.VipLvl == 4)
                        {
                            UpdateData.RedBucks(foreachPlayer, 5, msg:String.Empty);
                            Notify.Send(foreachPlayer, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Diamond5RB), 6000);
                        }
                        int payment = 0;
                        byte type = 0;
                ...
                foreach (Business biz in BusinessManager.BizList.Values)
                {
                    try
                    {
                        ...
                        if (PlayerNames.Values.Contains(owner) && PlayerUUIDs.ContainsKey(owner))
                        {
                            ...
                            if (characterData != null)
                            {
                                Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizSlet), 6000);
                ...
                foreach (var house in HouseManager.Houses)
                {
                    try
                    {
                        ...
                        if (accountData != null && characterData != null)
                        {
                            ...
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NalogPokaPoka), 6000);
                            MoneySystem.Wallet.Change(player, price);
                        }
                        else
                        {
        ...
        public void CMD_AutoRestart(ExtPlayer player)
        {
            try
            {
                ...
                if (!AutoRestart) Notify.Send(player, NotifyType.Success, NotifyPosition.Center, LangFunc.GetText(LangType.De, DataName.AutoRRoff), 1500);
                else Notify.Send(player, NotifyType.Success, NotifyPosition.Center, LangFunc.GetText(LangType.De, DataName.AutoRRon), 1500);
            }
            catch (Exception e)
            {
        ...
        public void CMD_BUILD(ExtPlayer player)
        {
            ...
            {
                if (player == null) return;
                Trigger.SendChatMessage(player, $"Server !{{#f39c12}}{Full}!{{#FFF}} Online! !{{#f39c12}}{StartDate}");
                Trigger.SendChatMessage(player, $"Build Datum: !{{#f39c12}}{CompileDate}");
            }
            catch (Exception e)
            {
        ...
        public static void OpenMayorMenu(ExtPlayer player)
        {
            try
            {
                ...
                frameList.Header = LangFunc.GetText(LangType.De, DataName.Kazna);
                frameList.Callback = callback_mayormenu;

                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.MoneyKazna, fractionData.Money), "info")); 
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.KaznaSobrano, Fractions.Cityhall.lastHourTax), "info2")); 
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.TakeMoneyy), "take")); 
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.PutMoney), "put")); 
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.Control), "header2")); 
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.GosZapravka), "fuelcontrol"));
        ...
        private static void callback_mayormenu(ExtPlayer player, object listItem) /// Никитос Чини 
        {
            ...
            {	
                ...
                {
                    case "take":
                        Trigger.ClientEvent(player, "openInput", "Geld aus der Staatskasse abheben", "Menge", 6, "mayor_take");
                        return;
                    case "put":
                        Trigger.ClientEvent(player, "openInput", "Geld in die Staatskasse einzahlen", "Menge", 6, "mayor_put");
                        return;
                    case "fuelcontrol":
        ...
        public static void OpenFuelcontrolMenu(ExtPlayer player)
        {
            try
            {
                ...
                var frameList = new FrameListData(); 
                frameList.Header = LangFunc.GetText(LangType.De, DataName.GosZapravka); 
                frameList.Callback = callback_fuelcontrol; 
                
                var fractionData = Fractions.Manager.GetFractionData((int) Fractions.Models.Fractions.CITY);
                if (fractionData != null)
                    frameList.List.Add(new ListData($"Rathaus. Heute übrig: {fractionData.FuelLeft}/{fractionData.FuelLimit}$", "info_city"));

                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.SetLimit), "set_city"));
                
                fractionData = Fractions.Manager.GetFractionData((int) Fractions.Models.Fractions.POLICE);
                if (fractionData != null)
                    frameList.List.Add(new ListData($"LSPD. Heute übrig: {fractionData.FuelLeft}/{fractionData.FuelLimit}$", "info_police"));

                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.SetLimit), "set_police"));
                
                fractionData = Fractions.Manager.GetFractionData((int) Fractions.Models.Fractions.EMS);
                if (fractionData != null)
                    frameList.List.Add(new ListData($"EMS. Heute übrig: {fractionData.FuelLeft}/{fractionData.FuelLimit}$", "info_ems"));

                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.SetLimit), "set_ems"));
                
                fractionData = Fractions.Manager.GetFractionData((int) Fractions.Models.Fractions.FIB);
                if (fractionData != null)
                    frameList.List.Add(new ListData($"FIB. Heute übrig: {fractionData.FuelLeft}/{fractionData.FuelLimit}$", "info_fib"));

                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.SetLimit), "set_fib"));

                fractionData = Fractions.Manager.GetFractionData((int) Fractions.Models.Fractions.ARMY);
                if (fractionData != null)
                    frameList.List.Add(new ListData($"Army. Heute übrig: {fractionData.FuelLeft}/{fractionData.FuelLimit}$", "info_army"));
                
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.SetLimit), "set_army"));
                
                fractionData = Fractions.Manager.GetFractionData((int) Fractions.Models.Fractions.LSNEWS);
                if (fractionData != null)
                    frameList.List.Add(new ListData($"News. Heute übrig: {fractionData.FuelLeft}/{fractionData.FuelLimit}$", "info_news"));
                
                frameList.List.Add(new ListData(LangFunc.GetText(LangType.De, DataName.SetLimit), "set_news"));
        ...
        private static void callback_fuelcontrol(ExtPlayer player, object listItem) /// Никитос Чини 
        {
            try
            {
                ...
                {
                    case "set_city":
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.SetLimit), LangFunc.GetText(LangType.De, DataName.FuelLimitM), 5, "fuelcontrol_city");
                        return;
                    case "set_police":
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.SetLimit), LangFunc.GetText(LangType.De, DataName.FuelLimitP), 5, "fuelcontrol_police");
                        return;
                    case "set_ems":
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.SetLimit), LangFunc.GetText(LangType.De, DataName.FuelLimitE), 5, "fuelcontrol_ems");
                        return;
                    case "set_fib":
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.SetLimit), LangFunc.GetText(LangType.De, DataName.FuelLimitF), 5, "fuelcontrol_fib");
                        return;
                    case "set_army":
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.SetLimit), LangFunc.GetText(LangType.De, DataName.FuelLimitA), 5, "fuelcontrol_army");
                        return;
                    case "set_news":
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.SetLimit), LangFunc.GetText(LangType.De, DataName.FuelLimitN), 5, "fuelcontrol_news");
                        return;
                }
            }
            catch (Exception e)
