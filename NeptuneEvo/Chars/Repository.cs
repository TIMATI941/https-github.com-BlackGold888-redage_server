    ...
    class Repository : Script
    {
        ...
        public static TradeCharacterResponse TradeCharacter(ExtPlayer player, ExtPlayer target, string type)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouHaveNoBusiness), 6000);
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PersonHaveNoBusiness), 6000);
                    return TradeCharacterResponse.Error;
                }
        ...
        public static void TradeClear(ExtPlayer player, bool message = true)
        {
            try
            {
                ...
                if (dataTrade != null)
                {
                    ...
                    {
                        if (message) Notify.Send(dataTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeCancel), 6000);
            ...
            try
            {
                ...
                else if (PlayerTrade.ContainsKey(player.Value) && DateTime.Now >= PlayerTrade[player.Value].Time)
                {
                    ...
                    if (isOnlineCharacter(dataTrade.Player) && PlayerTrade.ContainsKey(dataTrade.Player.Value))
                    {
                        ...
                        {
                            Notify.Send(dataTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeCancel), 6000);
        ...
        public static void TradeStart(ExtPlayer player, ExtPlayer target, string type)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FunctionOffByAdmins), 6000);
        ...
        /*public static void TradeBusinessesStart(ExtPlayer player)
        {
            try
            {
                ...
                if (targetSessionData == null || targetSessionData.TradePropertyData == null)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeCanceled), 6000);
                    TradeClear(player);
                    return;
                }
                ...
                menuItem.Text = LangFunc.GetText(LangType.De, DataName.YouBusinesses);
                menu.Add(menuItem);
                ...
                menuItem.Text = LangFunc.GetText(LangType.De, DataName.Close);
                menu.Add(menuItem);
        ...
        private static void CallbackTradeBusinesses(ExtPlayer player, Menu menu, Menu.Item item, string eventName, dynamic data)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerChosingBiz), 6000);
                }
            }
            catch (Exception e)
            {
        ...
        public static void TradeBusinessesConfirm(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoBusiness), 6000);
                    TradeClear(player);
                    return;
                }
                TradePropertyData dataTargetTrade = targetSessionData.TradePropertyData;
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorChelBiz), 6000);
                    return;
                }
        ...
        public static void TradeBusinessesConfirmed(ExtPlayer player, bool toggled)
        {
            try
            {
                ...
                if (!toggled)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeSucCancelled), 6000);
                    Notify.Send(dataTargetTrade.Player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerCancelTrade), 6000);
                    TradeClear(player);
                ...
                else
                {
                    ...
                    if (dataTargetTrade.Status == TradeStage.confirmed) //Если второй выбрал авто как и мы то 
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoBusiness), 6000);
                            Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorChelBiz), 6000);
                            TradeClear(player);
                            TradeClear(dataTargetTrade.Player);
                            return;
                        }
                        ...
                        {
                            Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoBusiness), 6000);
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorChelBiz), 6000);
                            TradeClear(player);
                            TradeClear(dataTargetTrade.Player);
                            return;
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DealSuccess), 6000);
                        Notify.Send(dataTargetTrade.Player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DealSuccess), 6000);
                        TradeClear(player, false);
                        TradeClear(dataTargetTrade.Player, false);
                    }
                    else
                    {
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeBusinessesConfirmed, dataTargetTrade.Player.Name, dataTargetTrade.Player.Value), 6000);
                    }
                }
            }
            catch (Exception e)
        ...
        /*public static void TradeVehicleStart(ExtPlayer player)
        {
            try
            {
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouHaveNoCar), 6000);
                    return;
                }
                ...
                Menu.Item menuItem = new Menu.Item("header", Menu.MenuItem.Header);
                menuItem.Text = "Fahrzeug auswahl";
                menu.Add(menuItem);
        ...
        private static void CallbackTradeVehicle(ExtPlayer player, Menu menu, Menu.Item item, string eventName, dynamic data)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerChosingVeh), 6000);
                }
            }
            catch (Exception e)
            {
        ...
        public static void TradeVehicleConfirm(ExtPlayer player)
        {
            try
            {
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNeVladeetVehTrade), 6000);
                    return;
                }
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerNeVladeetVehTrade), 6000);
                    return;
                }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dataTargetTrade.Status == TradeStage.confirmed) //Если второй выбрал авто как и мы то 
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerTooFar), 6000);
                            Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerTooFar), 6000);
                            TradeClear(player, false);
                            return;
                        }
                        var vehicleData = VehicleManager.GetVehicleToNumber(dataTrade.Number);
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNeVladeetVehTrade), 6000);
                            Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerNeVladeetVehTrade), 6000);
                            TradeClear(player, false);
                            return;
                        }
                        var vehicleDataTarget = VehicleManager.GetVehicleToNumber(dataTargetTrade.Number);
                        ...
                        {
                            Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNeVladeetVehTrade), 6000);
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerNeVladeetVehTrade), 6000);
                            TradeClear(player, false);
                            return;
                        }
        ...
        /*public static void TradeHouseConfirm(ExtPlayer player)
        {
            try
            {
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PersonNoHome), 6000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorMaxGarageCars, garageTargetType.MaxCars), 6000);
                    Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerErrorMaxGarageCars, garageTargetType.MaxCars), 6000);
                    TradeClear(player, false);
                    return;
                }
                dataTrade.Time = DateTime.Now.AddSeconds(10);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dataTargetTrade.Status == TradeStage.confirmed) //Если второй выбрал авто как и мы то 
                    {
                        ...
                        if (house == null || house.Owner != player.Name)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoreHouse), 6000);
                            TradeClear(player);
                            return;
                        }
                        ...
                        {
                            Notify.Send(dataTargetTrade.Player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoreHouse), 6000);
                            TradeClear(player);
                            return;
                        }
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DealSuccess), 6000);
                        Notify.Send(dataTrade.Player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DealSuccess), 6000);
                        TradeClear(player, false);
                    }
                    else
                    {
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeBusinessesConfirmed, dataTrade.Player.Name, dataTrade.Player.Value), 6000);
                    }
                }
            }
            catch (Exception e)
        ...
        {
            new RouletteCategory("Kostenlos", "keys_2", new int[] {0, 1, 2}),
        ...
        public static List<RouletteCaseData> RouletteCasesData = new List<RouletteCaseData> { 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case0, "Case", 0, new List<RouletteItemData>(), "keys_0", "Kostenloser Case: Nach 3h Spielzeit erhältlich"), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case1, "Waffen Case", 0, new List<RouletteItemData>(), "keys_1", "Kostenloser Case mit Waffen: Nach 5h Spielzeit erhältlich"), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case2, "Fahrzeug Case", 0, new List<RouletteItemData>(), "keys_2", "Kostenloser Case mit Fahrzeug: Nach 8h Spielzeit erhältlich"), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case3, "Standard Case", 99, new List<RouletteItemData>(), "keys_3", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),             
            /* 
            Case 'VIP' - 19 items 
            Blue    40.00% 
            Yellow  14.80% 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case4, "Seltsamer Case", 249, new List<RouletteItemData>(), "keys_4", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case5, "Besonderer Case", 499, new List<RouletteItemData>(), "keys_5", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
            /* 
            Case 'Rare' - 15 items 
            Blue    29.00% 
            Yellow  40.00% 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case6, "Seltener Case", 999, new List<RouletteItemData>(), "keys_6", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
            /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case7, "Ellite Case", 2499, new List<RouletteItemData>(), "keys_7", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
                        /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case8, "Männlicher Case", 2999, new List<RouletteItemData>(), "keys_9", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
                        /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case9, "Weiblicher Case", 2999, new List<RouletteItemData>(), "keys_10", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
                        /* 
            ...
            Total   10000 - 100.00% 
            */ 
            new RouletteCaseData(ItemId.Case10, "Exotischer Case", 7777, new List<RouletteItemData>(), "keys_8", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),              
            new RouletteCaseData(ItemId.Case11, "Legendärer Case", 5555, new List<RouletteItemData>(), "keys_11", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
            new RouletteCaseData(ItemId.Case12, "Intressanter Case", 3999, new List<RouletteItemData>(), "keys_12", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
            new RouletteCaseData(ItemId.Case13, "Hubschrauber Case", 8888, new List<RouletteItemData>(), "keys_13", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"), 
            new RouletteCaseData(ItemId.Case14, "Gepanzerter Case", 5000, new List<RouletteItemData>(), "keys_14", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),
            new RouletteCaseData(ItemId.Case15, "Exklusiver Case", 100, new List<RouletteItemData>(), "keys_15", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),
            new RouletteCaseData(ItemId.Case16, "Winter Case [M]", 5000, new List<RouletteItemData>(), "keys_16", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),   
            new RouletteCaseData(ItemId.Case17, "Amethyst Case [М]", 5000, new List<RouletteItemData>(), "keys_17", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),   
            new RouletteCaseData(ItemId.Case18, "Festlicher Case [М]", 5000, new List<RouletteItemData>(), "keys_18", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),   
            new RouletteCaseData(ItemId.Case19, "Winter Case [W]", 5000, new List<RouletteItemData>(), "keys_19", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),  
            new RouletteCaseData(ItemId.Case20, "Amethyst Case [W]", 5000, new List<RouletteItemData>(), "keys_20", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),  
            new RouletteCaseData(ItemId.Case21, "Festlicher Case [W]", 5000, new List<RouletteItemData>(), "keys_21", "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan"),  
        };
            ...
            try
            {
                ...
                switch (Name)
                {
                    ...
                    case "VIP Diamond":
                        ...
                        {
                            returnText = LangFunc.GetText(LangType.De, DataName.CaseWinVip, Group.GroupNames[rank], Amount, Group.GroupNames[accountData.VipLvl]);
                        }
                        else if (accountData.VipLvl > 0 && accountData.VipLvl > rank)//Если нынешняя випка выше выйграной
                        {
                            returnText = LangFunc.GetText(LangType.De, DataName.CaseWinVipHueviy, Group.GroupNames[rank], Amount);
                        }
                        else returnText = LangFunc.GetText(LangType.De, DataName.CaseWinVipNoVip, Group.GroupNames[rank], Amount);//если нет випки
                        break;
                    case "Ingame Währung":
                        returnText = LangFunc.GetText(LangType.De, DataName.CaseWinMoney, Wallet.Format(Amount));
                        break;
                    case "EXP":
                        returnText = LangFunc.GetText(LangType.De, DataName.CaseWinExp, Amount);
                        break;
                    case "RedBucks":
                        returnText = LangFunc.GetText(LangType.De, DataName.CaseWinRB, Wallet.Format(Amount));
                        break;
                    case "Maske":
                        returnText = LangFunc.GetText(LangType.De, DataName.CaseWinMask);
                        break;
                    case "Hubschrauberlizenz":
                        if (characterData.Licenses[4]) returnText = LangFunc.GetText(LangType.De, DataName.CaseWinFlylicEst);
                        else returnText = LangFunc.GetText(LangType.De, DataName.CaseWinFlylic);
                        break;
                    case "Fluglizenz":
                        if (characterData.Licenses[5]) returnText = LangFunc.GetText(LangType.De, DataName.CaseWinSamoletEst);
                        else returnText = LangFunc.GetText(LangType.De, DataName.CaseWinSamolet);
                        break;
                    case "Rettungssanitäter-Lizenz":
                        if (characterData.Licenses[8]) returnText = LangFunc.GetText(LangType.De, DataName.CaseWinParamedic);
                        else returnText = LangFunc.GetText(LangType.De, DataName.CaseWinParamedicEst);
                        break;
                    case "Sim-Karte":
                        if (characterData.Sim != -1) returnText = LangFunc.GetText(LangType.De, DataName.CaseWinSimCard, Amount);
                        else returnText = LangFunc.GetText(LangType.De, DataName.CaseWinSimCard, Amount);
                        break;
                    case "Tee":
                        returnText = LangFunc.GetText(LangType.De, DataName.CaseWinTea, Amount);
                        break;
                    default:
                        returnText = LangFunc.GetText(LangType.De, DataName.CaseWinItem, Name);
                        break;
                }

                if (Price > 0)
                {
                    returnText += LangFunc.GetText(LangType.De, DataName.CaseSellRB, Price);
                    if (BtnTake) returnText += LangFunc.GetText(LangType.De, DataName.CaseOstavitPriz);
                }
                else if (BtnTake) returnText += LangFunc.GetText(LangType.De, DataName.CaseGetPrize);
                return returnText;
            }
            catch (Exception e)
            {
                Log.Write($"RouletteToItemsText Exception: {e.ToString()}");
                return LangFunc.GetText(LangType.De, DataName.CaseWinItem, Name);
            }
        }
        ...
        public static bool RouletteGetWallet(ExtPlayer player, int amount, bool typeCurrency)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetRB), 6000);
                    return false;
                }
                else if (typeCurrency && characterData.Money < (amount * Convert.ToInt32(100 * Main.DonateSettings.Convert)))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoney), 6000);
                    return false;
                }
                return true;
            }
        ...
        public static void RouletteUpdateWallet(ExtPlayer player, int amount, bool typeCurrency, int caseid = -1)
        {
            try
            {
                ...
                {
                    if (caseid == -1) 
                        UpdateData.RedBucks(player, amount, msg: "Case´s öffnen");
                    else 
        ...
        public static void RouletteBuyCase(ExtPlayer player, int caseid, int count)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CaseNeDostupen), 6000);
                return;
            }
            ...
            if (isFreeSlots(player, caseData.ItemId, count, send: false) != 0)
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CaseGetSklad), 6000);
                return;
            }     

            AddNewItem(player, $"char_{characterData.UUID}", "inventory", caseData.ItemId, count);
            Notify.Send(player, NotifyType.Success, NotifyPosition.Top, LangFunc.GetText(LangType.De, DataName.CaseGetInventory), 2000);
        }
        public static void RouletteOpenCase(ExtPlayer player, int caseid, int count, bool typeCurrency = false)
        {
            try
            {
                ...
                if (aItem == null)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouHaveNoCase), 6000);
                    return;
                }
                else if (count > aItem.Item.Count)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter,LangFunc.GetText(LangType.De, DataName.YouHaveCases, aItem.Item.Count), 6000);
                    return;
                }
        ...
        public static List<RouletteData> RouletteCreate(ExtPlayer player, int caseid, RouletteCaseData caseData, int indexItem, int count = 1, bool typeCurrency = false)
        {
            try
            {
                ...
                if (sessionData.RouletteData.Count > 0)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WaitTillNextTry), 6000);
                        return null;
                    }
                }
        ...
        private static void RouletteWinAnnounce(ExtPlayer player, int caseid, RouletteItemData RouletteItem, int amount, bool type, byte bonuscase)
        {
            try
            {
                ...
                {
                    case "Ingame Währung":
                        Commands.RPChat("sb", player, "gewinnt " + RouletteItemColorByCase(RouletteItem.Color) + RouletteItem.Name + "!{#d4d4d4} " + Wallet.Format(amount) + $"$ aus {RouletteCasesData[caseid].Name}."); // NE SMOG
                        break;
                    case "RedBucks":
                        Commands.RPChat("sb", player, "gewinnt " + RouletteItemColorByCase(RouletteItem.Color) + RouletteItem.Name + "!{#d4d4d4} " + Wallet.Format(amount) + $"RC aus {RouletteCasesData[caseid].Name}.");
                        break;
                    default:
                        Commands.RPChat("sb", player, "gewinnt " + RouletteItemColorByCase(RouletteItem.Color) + RouletteItem.Name + "!{#d4d4d4} " + $"{RouletteCasesData[caseid].Name}.");
                        break;
                }
                if (type) Admin.WinLog($"[{RouletteCasesData[caseid].Name}] {player.Name} ({player.Value}) gewinnt {RouletteItem.Name} {Wallet.Format(amount)}: Verkauft!");
                else Admin.WinLog($"[{RouletteCasesData[caseid].Name}] {player.Name} ({player.Value}) gewinnt {RouletteItem.Name} {Wallet.Format(amount)}!");
                ...
                if (RouletteItem.IsChatMessage)
                {
                    ...
                    {
                        case "Ingame Währung":
                            NAPI.Chat.SendChatMessageToAll($"~g~[GEWONNEN] WoW! {player.Name} gewinnt {Wallet.Format(amount)} {RouletteItem.Name} aus {RouletteCasesData[caseid].Name}!");
                            break;
                        case "RedBucks":
                            NAPI.Chat.SendChatMessageToAll($"~g~[GEWONNEN] {player.Name} gewinnt {Wallet.Format(amount)} {RouletteItem.Name} aus {RouletteCasesData[caseid].Name}!");
                            break;
                        default:
                            NAPI.Chat.SendChatMessageToAll($"~g~[GEWONNEN] Unglaublich! {player.Name} gewinnt {RouletteItem.Name} aus {RouletteCasesData[caseid].Name}!");
                            break;
                    }
                }
                if (RouletteItem.IsHudMessage)
                {
                    ...
                    {
                        case "Ingame Währung":
                            SupperWin($"{Wallet.Format(amount)} Rockford-Coins aus {RouletteCasesData[caseid].Name}!", RouletteItem.Name, RouletteItem.Image, player.Name);
                            break;
                        case "RedBucks":
                            SupperWin($"{Wallet.Format(amount)} Rockford-Coins aus {RouletteCasesData[caseid].Name}!", RouletteItem.Name, RouletteItem.Image, player.Name);// NE SMOG
                            break;
                        default:
                            SupperWin($"{RouletteItem.Name} aus {RouletteCasesData[caseid].Name}!", RouletteItem.Name, RouletteItem.Image, player.Name);
                            break;
                    }
                }
        ...
        private static void FreeCaseWinBonus(ExtPlayer player)
        {
            try
            {
                ...
                if (accountData == null) return;
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WinOneFreeCase), 6000);
                Commands.RPChat("sb", player, LangFunc.GetText(LangType.De, DataName.WonOneFreeCase));
                ...
                if (type)
                {
                    switch (returnPlayerData.Item.Name)
                    {
                        case "Ingame Währung":
                            ...
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWonMoneyAmount, MoneySystem.Wallet.Format(returnPlayerData.Amount)), 6000);
                            break;
                        case "RedBucks":
                            RouletteUpdateWallet(player, returnPlayerData.Amount, returnPlayerData.TypeCurrency);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWonRbAmount, MoneySystem.Wallet.Format(returnPlayerData.Amount)), 6000);
                            break;
                        default:
                            if (returnPlayerData.Item.Name == "Sim-Karte")
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWonItemRBAmount, returnPlayerData.Item.Name, MoneySystem.Wallet.Format(returnPlayerData.Price)), 6000);
                            break;
                    }
                }
                else
                {
                    switch (returnPlayerData.Item.Name)
                    {
                        case "Ingame Währung":
                            ...
                            GameLog.Money($"system", $"player({characterData.UUID})", returnPlayerData.Amount, $"caseWin");
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetMoneyAmount, MoneySystem.Wallet.Format(returnPlayerData.Amount)), 6000);
                            break;
                        case "EXP":
                            ...
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetItemAmount, returnPlayerData.Item.Name, returnPlayerData.Amount), 6000);
                            break;
                        case "VIP Silver":
                        case "VIP Gold":
                        case "VIP Platinum":
                        case "VIP Diamond":
                            ...
                            GameLog.Money($"system", $"player({characterData.UUID})", 0, $"caseWinVIP({rank}lvl, {returnPlayerData.Amount}d, bis {accountData.VipDate.ToString("s")})");
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetVipAmount, returnPlayerData.Item.Name, returnPlayerData.Amount), 6000);
                            break;
                        case "RedBucks":
                            RouletteUpdateWallet(player, returnPlayerData.Amount, returnPlayerData.TypeCurrency);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWonRbAmount, MoneySystem.Wallet.Format(returnPlayerData.Amount)), 6000);
                        ...
                        case "Maske":
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetNewMask), 6000);
                            break;
                        case "Hubschrauberlizenz":
                            if (characterData.Licenses[4])
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouAlreadyHaveLic), 6000);
                                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWonRbAmount, MoneySystem.Wallet.Format(returnPlayerData.Price)), 6000);
                                RouletteUpdateWallet(player, returnPlayerData.Price, returnPlayerData.TypeCurrency);
                                return;
                            }
                            ...
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouActivatedLicFly), 6000);
                            break;
                        case "Fluglizenz":
                            ...
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouActivatedLicSamolet), 6000);
                            break;
                        case "Rettungssanitäter-Lizenz":
                            ...
                            //PlayerStats(player);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouActivatedPMLic), 6000);
                            break;
                        case "Sim-Karte":
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetSimCard, returnPlayerData.Amount), 6000);
                            break;
                        ...
                        default:
                            ...
                            if (returnPlayerData.Item.ItemId != ItemId.Debug)
                            {
                                ...
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetItemSclad, returnPlayerData.Item.Name), 6000);
                            }
                            else
                            {
                                foreach (KeyValuePair<ItemId, ItemsInfo> itemData in ItemsInfo)
        ...
        public static void UpdateVipStatus(ExtPlayer player, int rank, int days, bool force = false, bool logWrite = false, string logMessagePrefix = "RefVIP")
        {
            try
            {
                ...
                if (logWrite)
                    GameLog.Money($"server", $"player({characterData.UUID})", 1, $"{logMessagePrefix}({accountData.VipLvl}lvl, bis: {accountData.VipDate.ToString("s")}, RefId: {accountData.RefferalId})");
            }
            catch (Exception e)
            {
        ...
        {
            new RefferalData("Sollen wir starten?", 0, 0, 0, true, 200, 5), // Первый, нулевой человек
            new RefferalData("Erste Schritte", 1, 4, 1, true, 250, 7), // 1 - 4 человек
            new RefferalData("Anfänger", 5, 4, 1, true, 300, 10), // 5 - 9
            new RefferalData("Neuling", 10, 4, 1, true, 375, 13), // 10 - 14
            new RefferalData("Möchtegern", 15, 4, 1, true, 400, 15), // 15 - 19
            new RefferalData("Aufsteiger", 20, 4, 1, true, 425, 17), // 20 - 29
            new RefferalData("Berühmtheit", 30, 4, 1, true, 500, 20), // 30 - 39
            new RefferalData("Phänomen", 40, 4, 1, true, 550, 22), // 40 - 49
            new RefferalData("Star", 50, 4, 1, true, 600, 25), // 50 - 60
            new RefferalData("Idol", 60, 4, 1, true, 625, 27), // 60 - 70
            new RefferalData("Ass", 70, 4, 1, true, 700, 30), // 70 - 89
            new RefferalData("Megastar", 80, 4, 1, true, 750, 32), // 80 - 99
            new RefferalData("Generaldirektor", 100, 4, 1, true, 800, 35), // 100 - 119
            new RefferalData("Ikone", 120, 4, 1, true, 850, 37), // 120 - 149
            new RefferalData("Vize El Presidente", 150, 4, 2, true, 900, 40), // 150 - 200
            new RefferalData("El Presidente", 200, 4, 3, true, 1000, 50), // 201+
        };
        #endregion

        #region Kennzeichen tausch

        public static void ChangeAutoNumberInit()
        {
            Main.CreateBlip(new Main.BlipData(811, "Kennzeichen wechseln", new Vector3(-2286.025, 354.21, 174.6016), 47, true, 1.5f));
            ...
            NAPI.TextLabel.CreateTextLabel("~w~Kennzeichen wechseln", new Vector3(-2286.025, 354.21, 174.6016), 8f, 0.3f, 0, new Color(255, 255, 255), true, 0);
            CustomColShape.CreateSphereColShape(new Vector3(-1288.142, -579.7515, 30.573048), 2f, 0, ColShapeEnums.ChangeAutoNumber); // Kennzeichen wechseln
            PedSystem.Repository.CreateQuest("s_m_m_fiboffice_02", new Vector3(-1288.142, -579.7515, 30.573048), 27.65183f, title: "~y~NPC~w~ Eduard Ritter\nKennzeichen wechsel", colShapeEnums: ColShapeEnums.ChangeAutoNumber);
        ...
        public static void OnChangeAutoNumber(ExtPlayer player)
        {
            try
            {
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNeedNot2Cars), 6000);
                    return;
                }
                int count = 0;
                foreach (string number in vehiclesNumber)
                ...
                {
                    TradeClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNeedNot2CarsPremium), 6000);
                    return;
                }
                string Number1 = null;
                var sessionData = player.GetSessionData();
                ...
                frameList.Header = "Fahrzeug auswahl";
        ...
        private static void CallbackChangeAutoNumber(ExtPlayer player, object listItem)
        {
            try
            {
                ...
                {
                    ChangeAutoNumberClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarBoleeNetu), 6000);
                    return;
                }
                if (BusinessManager.CarsNames[2].Contains(vehicleData1.Model) || BusinessManager.CarsNames[3].Contains(vehicleData1.Model))
                {
                    ChangeAutoNumberClear(player);
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehNePodhoditDlyaObmena), 6000);
                    return;
                }
                var sessionData = player.GetSessionData();
                if (sessionData.ChangeAutoNumber == null)
                ...
                else
                {
                    ...
                    Trigger.ClientEvent(player, "openDialog", "ChangeAutoNumberConfirm", $"Sie sind sicher, dass Sie die Kennzeichen zwischen {vehicleData1.Model} und {vehicleData2.Model} wechseln möchten?<br/><br/>Kosten 70.000$");
                }
            }
            catch (Exception e)
            {
        ...
        public static void ChangeAutoNumberConfirm(ExtPlayer player, bool toggled)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VehDoesntExist), 6000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucNumberTrade), 6000);
            }
            catch (Exception e)
            {
 ...
 */
        ...
        {
            { ItemId.Mask, new ItemsInfo("Maske", "Es hilft, die Persönlichkeit zu verbergen, dient aber gleichzeitig als Dekoration. Es kann von der Polizei gestört werden.", "inv-item-mask", "Kleidung", 3887136870, 1, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Clothes) },
            { ItemId.Gloves, new ItemsInfo("Handschuhe", "Halten dich im Winter warm", "inv-item-glove", "Kleidung", 3125389411, 1, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Clothes) },
            { ItemId.Ears, new ItemsInfo("Kopfhöhrer", ".", "inv-item-ears", "Kleidung", 3125389411, 1, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Clothes) },
            { ItemId.Leg, new ItemsInfo("Hose", "Не дадут тебе замёрзнуть.", "inv-item-shorts", "Kleidung", 2086911125, 1, new Vector3(0.0,0.0,-0.85), new Vector3(), newItemType.Clothes) },

            { ItemId.Bag, new ItemsInfo("Tasche", "Erweitert dein Iventar", "inv-item-backpack", "Kleidung", NAPI.Util.GetHashKey("prop_cs_heist_bag_02"), 1, new Vector3(0, 0, -0.85), new Vector3(), newItemType.Clothes) },

            { ItemId.Feet, new ItemsInfo("Schuhe", " Schuhe dienen primär dem Schutz der Fußsohle beim Gehen sowie als Schutz der Füße bei Nässe und Kälte", "inv-item-sneakers", "Kleidung", 1682675077, 1, new Vector3(0.0,0.0,-0.95), new Vector3(), newItemType.Clothes) },
            { ItemId.Jewelry, new ItemsInfo("Accessoire", "Der Begriff Accessoire kommt aus dem Französischen und bedeutet „zusätzlich“ oder auch „nebensächlich“.", "inv-item-necklace", "Kleidung", 2329969874, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.Clothes) },
            { ItemId.Undershit, new ItemsInfo("Untere Kleidung", "Kleidungsstück für den Oberkörper, meistens aus Baumwolltrikot, mit kurzen Ärmeln", "inv-item-shirt", "Kleidung", 578126062, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.Clothes) },
            { ItemId.BodyArmor, new ItemsInfo("Schutzweste", "Schutzwesten zählen zu den Schutzwaffen, deren frühe Entwicklung auf Rüstungen aus verschiedensten Materialien zurückgeht", "inv-item-armor", "Kleidung", 701173564, 1, new Vector3(0.0,0.0,-0.88), new Vector3(90, 90, 0), newItemType.Clothes) },
            { ItemId.Decals, new ItemsInfo("Schmuck", "Lässt dich gut aussehen", "inv-item-clock", "Kleidung", 0, 1, new Vector3(), new Vector3(), newItemType.Clothes) },
            { ItemId.Top, new ItemsInfo("Obere Kleidung", "Ein häufig gestricktes Kleidungsstück für den Oberkörper mit langen Ärmeln, das meist über den Kopf gezogen werden muss", "inv-item-jacket", "Kleidung", 3038378640, 1, new Vector3(0.0,0.0,-0.96), new Vector3(), newItemType.Clothes) },
            { ItemId.Hat, new ItemsInfo("Kopfbedeckung", "Schützt dich vor einem Sonnenstich", "inv-item-cap", "Kleidung", 1619813869, 1, new Vector3(0.0,0.0,-0.93), new Vector3(), newItemType.Clothes) },
            { ItemId.Glasses, new ItemsInfo("Brille", "Schützt Sie vor der Sonne", "inv-item-glasses", "Kleidung", 2329969874, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.Clothes) },
            { ItemId.Bracelets, new ItemsInfo("Armband", "Lässt dich gut aussehen", "inv-item-bracelet", "Kleidung", 2329969874, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.Clothes) },
            { ItemId.Watches, new ItemsInfo("Armbanduhr", "Lässt dich gut aussehen", "inv-item-clock", "Kleidung", 2329969874, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.Clothes) },

            { ItemId.Debug, new ItemsInfo("None", "", "", "", 0, 0, new Vector3(), new Vector3(), newItemType.None) },
            { ItemId.BagWithDrill, new ItemsInfo("Werkzeugtasche", "Wird verwendet um einen Tresor zu knacken.","inv-item-Bag-drill", "Andere", NAPI.Util.GetHashKey("prop_cs_heist_bag_02"), 1, new Vector3(0, 0, -0.85), new Vector3(), newItemType.None) },
            { ItemId.GasCan, new ItemsInfo("Kanister", "Kann das Fahrzeug betanken.","inv-item-gasoline", "Werkzeug", 786272259, 2, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.None) },
            { ItemId.Crisps, new ItemsInfo("Chips", "Snack, stellt 30 % Gesundheit wieder her.","inv-item-Chips", "Essen", 2564432314, 4, new Vector3(0.0,0.0,-1.0), new Vector3(90, 90, 0), newItemType.Eat) },
            { ItemId.Beer, new ItemsInfo("Bier", "Morgens ein Bier und der Tag gehört Dir!","inv-item-beer", "Wasser", 1940235411, 5, new Vector3(0.0,0.0,-0.97), new Vector3(-80, 0, 0), newItemType.Water) },
            { ItemId.Pizza, new ItemsInfo("Pizza", "Pizza... stellt 30 % Gesundheit wieder her.","inv-item-pizza", "Essen", 604847691, 3, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Eat) },
            { ItemId.Burger, new ItemsInfo("Burger", "Burger... stellt 30 % Gesundheit wieder her..","inv-item-burger", "Essen", 2240524752, 4, new Vector3(0.0,0.0,-0.97), new Vector3(), newItemType.Eat) },
            { ItemId.HotDog, new ItemsInfo("Hot-Dog", "Hot-Dog... stellt 30 % Gesundheit wieder her.","inv-item-hot-dog", "Essen", 2565741261, 5, new Vector3(0.0,0.0,-0.97), new Vector3(), newItemType.Eat) },
            { ItemId.Sandwich, new ItemsInfo("Sandwich", "Sandwich... stellt 30 % Gesundheit wieder her.","inv-item-sandwich", "Essen", 987331897, 7, new Vector3(0.0,0.0,-0.99), new Vector3(), newItemType.Eat) },
            { ItemId.eCola, new ItemsInfo("eCola", "eCola... stellt 10% Gesundheit wieder her.","inv-item-eCola", "Wasser", 144995201, 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Water) },
            { ItemId.Sprunk, new ItemsInfo("Sprunk", "Sprunk... stellt 10% Gesundheit wieder her.","inv-item-eCola", "Wasser", 2973713592, 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Water) },
            { ItemId.Lockpick, new ItemsInfo("Dietrich", "Werkzeug zum Öffnen von Schlössern ohne Schlüssel.","inv-item-picklock", "Werkzeug", 977923025, 10, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            { ItemId.BagWithMoney, new ItemsInfo("Geldtasche", "Dort können Sie das ganze Geld nach dem Raub rund um die Uhr deponieren.","inv-item-briefcase", "Andere", NAPI.Util.GetHashKey("p_ld_heist_bag_s_pro"), 1, new Vector3(0, 0, -1.1), new Vector3(0, 30, 110), newItemType.None) },
            { ItemId.Material, new ItemsInfo("Mats", "Wird benötigt um Waffen und Munition herzustellen.","inv-item-fraction", "Andere", 3045218749, 4000, new Vector3(0.0,0.0,-0.6), new Vector3(), newItemType.None) },
            { ItemId.Drugs, new ItemsInfo("Drogen", "Ich glaube, die Leute müssen über die Tatsache unterrichtet werden, daß Marihuana keine Droge ist. Marihuana ist eine Blume. Gott hat sie hergebracht.","inv-item-marijuana", "Andere", 4293279169, 50, new Vector3(0.0,0.0,-0.95), new Vector3(), newItemType.None) },
            { ItemId.HealthKit, new ItemsInfo("Verbandskasten","Für eine Behandlung erforderlich, kann 1 Mal in 5 Minuten verwendet werden.","inv-item-medical-kit", "Andere", 678958360, 10, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },

            { ItemId.ArmyLockpick, new ItemsInfo("Verbesserter Dietrich", "Werkzeug zum Öffnen der Schlösser von Militärfahrzeugen.","inv-item-picklock", "Werkzeug", 977923025, 10, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            { ItemId.Pocket, new ItemsInfo("Sack", "Ein ganz normaler Sack. Sie sagen, man kann es jemandem auf den Kopf setzen...","inv-item-bag", "Werkzeug", 3887136870, 5, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            { ItemId.Cuffs, new ItemsInfo("Kabelbinder", "Sie ermöglichen eine Person mit erhobenen Händen zu fesseln.","inv-item-stretching", "Werkzeug", 3887136870, 5, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            { ItemId.CarKey, new ItemsInfo("Fahrzeugschlüssel", "Ein Werkzeug mit dem Sie ein Fahrzeug öffnen / schließen und starten können.","inv-item-key", "Werkzeug", 977923025, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            { ItemId.Present, new ItemsInfo("Geschenk", "Enthält etwas Interessantes! Los, mach es schnell auf :)","inv-item-gift", "Werkzeug", 1580014892, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            { ItemId.KeyRing, new ItemsInfo("Bundschlüssel", "Sammeln Sie alle Schlüssel in einem großen Bündel und sparen Sie Platz in Ihren Inventar!","inv-item-key-2", "Werkzeug", 977923025, 1, new Vector3(0.0,0.0,-0.98), new Vector3(), newItemType.None) },
            /* Drinks */
            { ItemId.RusDrink1, new ItemsInfo("<Caipirinha>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-On-lemon-peel", "Alkohol", NAPI.Util.GetHashKey("prop_rum_bottle"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.RusDrink2, new ItemsInfo("<Highball>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-The-cranberries", "Alkohol", NAPI.Util.GetHashKey("h4_prop_h4_t_bottle_01a"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.RusDrink3, new ItemsInfo("<Russian Standard>", "Der gute alte russische Wodka wirkt wie eine Alkoholvergiftung.","inv-item-Russian-standard", "Alkohol", NAPI.Util.GetHashKey("prop_vodka_bottle"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.YakDrink1, new ItemsInfo("<Asahi>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Asahi", "Alkohol", NAPI.Util.GetHashKey("prop_bottle_brandy"), 5, new Vector3(0.0,0.0,-0.87), new Vector3(), newItemType.Alco) },
            { ItemId.YakDrink2, new ItemsInfo("<Midori>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Midori", "Alkohol", NAPI.Util.GetHashKey("prop_bottle_cognac"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.YakDrink3, new ItemsInfo("<Yamazaki>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Yamazaki", "Alkohol", NAPI.Util.GetHashKey("prop_bottle_macbeth"), 5, new Vector3(0.0,0.0,-0.87), new Vector3(), newItemType.Alco) },
            { ItemId.LcnDrink1, new ItemsInfo("<Martini Asti>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Martini-Asti", "Alkohol", NAPI.Util.GetHashKey("p_amb_bag_bottle_01"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.LcnDrink2, new ItemsInfo("<Sambuca>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Sambuca", "Alkohol", NAPI.Util.GetHashKey("prop_cs_whiskey_bottle"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.LcnDrink3, new ItemsInfo("<Campari>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Campari", "Alkohol", NAPI.Util.GetHashKey("prop_bottle_richard"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.ArmDrink1, new ItemsInfo("<Mojito>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-alcohol", "Alkohol", NAPI.Util.GetHashKey("h4_prop_h4_t_bottle_02a"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.ArmDrink2, new ItemsInfo("<Cosmopolitan>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-ararat", "Alkohol", NAPI.Util.GetHashKey("p_cs_bottle_01"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            { ItemId.ArmDrink3, new ItemsInfo("<Coco Loco>", "Alkoholisches Getränk wirkt wie eine Alkoholvergiftung.","inv-item-Noyan-Tapan", "Alkohol", NAPI.Util.GetHashKey("prop_tequila_bottle"), 5, new Vector3(0.0,0.0,-1.0), new Vector3(), newItemType.Alco) },
            /* Weapons */
            /* Pistols */
            { ItemId.Pistol, new ItemsInfo("Pistol", "Das Magazin dieser Pistole umfasst 12 Patronen","inv-item-Pistol", "Waffe", 1467525553, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CombatPistol, new ItemsInfo("Combat Pistol", "Das Magazin dieser Pistole umfasst 12 Patronen","inv-item-Pistol", "Waffe", 403140669, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Pistol50, new ItemsInfo("Pistol 50", "Das Magazin dieser Pistole umfasst 9 Patronen","inv-item-Pistol-50", "Waffe", 4116483281, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SNSPistol, new ItemsInfo("SNS Pistol", "Das Magazin dieser Pistole umfasst 6 Patronen","inv-item-SNS-Pistol", "Waffe", 339962010, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.HeavyPistol, new ItemsInfo("Heavy Pistol", "Das Magazin dieser Pistole umfasst 18 Patronen","inv-item-Heavy-Pistol", "Waffe", 1927398017, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.VintagePistol, new ItemsInfo("Vintage Pistol", "Das Magazin dieser Pistole umfasst 7 Patronen","inv-item-Vintage-Pistol", "Waffe", 3170921020, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MarksmanPistol, new ItemsInfo("Marksman Pistol", "Das Magazin dieser Pistole umfasst 1 Patrone","inv-item-Marksman-Pistol", "Waffe", 4191177435, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Revolver, new ItemsInfo("Revolver", "Das Magazin dieser Pistole umfasst 6 Patrone","inv-item-Heavy-Revolver", "Waffe", 914615883, 1, new Vector3(0.0,0.0,-0.95), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.APPistol, new ItemsInfo("AP Pistol", "Das Magazin dieser Pistole umfasst 18 Patrone","inv-item-AP-Pistol", "Waffe", 905830540, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.StunGun, new ItemsInfo("Stun Gun", "Mit diesem Teaser machst du alle kampfunfähig","inv-item-Stun-Gun", "Nahkampfwaffe", 1609356763, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.FlareGun, new ItemsInfo("Flare Gun", "Eine normale Leuchtpistole","inv-item-Flare-Gun", "Waffe", 1349014803, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.DoubleAction, new ItemsInfo("Double Action Revolver", "Das Magazin dieser Pistole umfasst 6 Patrone","inv-item-Double-Action-Revolver", "Waffe", 1393678102, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.PistolMk2, new ItemsInfo("Pistol Mk2", "Das Magazin dieser Pistole umfasst 12 Patrone","inv-item-Pistol-Mk-II", "Waffe", 995074671, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SNSPistolMk2, new ItemsInfo("SNSPistol Mk2", "Das Magazin dieser Pistole umfasst 6 Patrone","inv-item-SNS-Pistol-Mk-II", "Waffe", 4221916961, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.RevolverMk2, new ItemsInfo("Heavy Revolver Mk2", "Das Magazin dieser Pistole umfasst 6 Patrone","inv-item-Heavy-Revolver-Mk-II", "Waffe", 4065179617, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            /* SMG */
            { ItemId.MicroSMG, new ItemsInfo("Micro SMG", "Das Magazin dieser SMG umfasst 16 Patrone","inv-item-Micro-SMG", "Waffe", 3238253642, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MachinePistol, new ItemsInfo("Machine Pistol", "Das Magazin dieser MachinePistol umfasst 12 Patrone","inv-item-Machine-Pistol", "Waffe", 3963421467, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SMG, new ItemsInfo("SMG", "Das Magazin dieser SMG umfasst 30 Patrone","inv-item-SMG", "Waffe", 3794909300, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.AssaultSMG, new ItemsInfo("Assault SMG", "Das Magazin dieser AssaultSMG umfasst 30 Patrone","inv-item-Assault-SMG", "Waffe", 3821393119, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CombatPDW, new ItemsInfo("Combat PDW", "Das Magazin dieser CombatPDW umfasst 30 Patrone","inv-item-Combat-PDW", "Waffe", 2901952492, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MG, new ItemsInfo("MG", "Das Magazin dieser MG umfasst 54 Patronen","inv-item-MG", "Waffe", 2238602894, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CombatMG, new ItemsInfo("Combat MG", "Das Magazin dieser CombatMG umfasst 100 Patronen","inv-item-Combat-MG", "Waffe", 3555572849, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Gusenberg, new ItemsInfo("Gusenberg", "Das Magazin dieser Gusenberg umfasst 30 Patrone","inv-item-Gusenberg-Sweeper", "Waffe", 574348740, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MiniSMG, new ItemsInfo("Mini SMG", "Das Magazin dieser MiniSMG umfasst 20 Patronen","inv-item-Mini-SMG", "Waffe", 3322144245, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SMGMk2, new ItemsInfo("SMG Mk2", "Das Magazin dieser SMGMk2 umfasst 30 Patronen","inv-item-SMG-Mk-II", "Waffe", 2547423399, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CombatMGMk2, new ItemsInfo("Combat MG Mk2", "Das Magazin dieser CombatMGMk2 umfasst 100 Patronen", "inv-item-Combat-MG-Mk-II", "Waffe", 2969831089, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            /* Rifles */
            { ItemId.AssaultRifle, new ItemsInfo("Assault Rifle", "Das Magazin dieser AssaultRifle umfasst 30 Patronen","inv-item-Assault-Rifle", "Waffe", 273925117, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CarbineRifle, new ItemsInfo("Carbine Rifle", "Das Magazin dieser CarbineRifle umfasst 30 Patronen","inv-item-Carbine-Rifle", "Waffe", 1026431720, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.AdvancedRifle, new ItemsInfo("Advanced Rifle", "Das Magazin eines Sturmgewehr umfasst 30 Patronen.","inv-item-Advanced-Rifle", "Waffe", 2587382322, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SpecialCarbine, new ItemsInfo("Special Carbine",  "Das Magazin dieser SpecialCarbine umfasst 30 Patronen","inv-item-Special-Carbine", "Waffe", 2549323539, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.BullpupRifle, new ItemsInfo("Bullpup Rifle", "Das Magazin dieser BullpupRifle umfasst 30 Patronen","inv-item-Bullpup-Rifle", "Waffe", 3006407723, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CompactRifle, new ItemsInfo("Compact Rifle", "Das Magazin dieser CompactRifle umfasst 30 Patronen","inv-item-Compact-Rifle", "Waffe", 1931114084, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.AssaultRifleMk2, new ItemsInfo("Assault Rifle Mk2", "Das Magazin dieser AssaultRifleMk2 umfasst 30 Patronen","inv-item-Assault-Rifle-Mk-II", "Waffe", 1762764713, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CarbineRifleMk2, new ItemsInfo("Carbine Rifle Mk2", "Das Magazin dieser CarbineRifleMk2 umfasst 30 Patronen","inv-item-Carbine-Rifle-Mk-II", "Waffe", 1520780799, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SpecialCarbineMk2, new ItemsInfo("Special Carbine Mk2", "Das Magazin dieser SpecialCarbineMk2 umfasst 30 Patronen","inv-item-Special-Carbine-Mk-II", "Waffe", 2379721761, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.BullpupRifleMk2, new ItemsInfo("Bullpup Rifle Mk2", "Das Magazin dieser BullpupRifleMk2 umfasst 30 Patronen","inv-item-Bullpup-Rifle-Mk-II", "Waffe", 1415744902, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MilitaryRifle, new ItemsInfo("Military Rifle", "Das Magazin eines Sturmgewehr umfasst 30 Patronen.","inv-item-militaryrifle", "Waffe", 1415744902, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            /* Sniper */
            { ItemId.SniperRifle, new ItemsInfo("Sniper Rifle", "Das Magazin dieser SniperRifle umfasst 10 Patronen","inv-item-Sniper-Rifle", "Waffe", 346403307, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.HeavySniper, new ItemsInfo("Heavy Sniper", "Das Magazin dieser HeavySniper umfasst 6 Patronen","inv-item-Heavy-Sniper", "Waffe", 3548001216, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MarksmanRifle, new ItemsInfo("Marksman Rifle", "Das Magazin dieser MarksmanRifle umfasst 8 Patronen","inv-item-Marksman-Rifle", "Waffe", 2583718658, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.HeavySniperMk2, new ItemsInfo("Heavy Sniper Mk2", "Das Magazin dieser HeavySniperMk2 umfasst 6 Patronen.","inv-item-Heavy-Sniper-Mk-II", "Waffe", 619715967, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.MarksmanRifleMk2, new ItemsInfo("Marksman Rifle Mk2", "Das Magazin dieser MarksmanRifleMk2 umfasst 8 Patronen","inv-item-Marksman-Rifle-Mk-II", "Waffe", 2436666926, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            /* Shotguns */
            { ItemId.PumpShotgun, new ItemsInfo("Pump Shotgun", "Das Magazin dieser PumpShotgun umfasst 8 Patronen","inv-item-Pump-Shotgun", "Waffe", 689760839, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SawnOffShotgun, new ItemsInfo("SawnOff Shotgun", "Das Magazin dieser SawnOffShotgun umfasst 8 Patronen","inv-item-Sawed-Off-Shotgun", "Waffe", 3619125910, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.BullpupShotgun, new ItemsInfo("Bullpup Shotgun", "Das Magazin dieser BullpupShotgun umfasst 14 Patronen","inv-item-Bullpup-Shotgun", "Waffe", 2696754462, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.AssaultShotgun, new ItemsInfo("Assault Shotgun", "Das Magazin dieser AssaultShotgun umfasst 8 Patronen","inv-item-Assault-Shotgun", "Waffe", 1255410010, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Musket, new ItemsInfo("Musket", "Das Magazin dieser Musket umfasst 1 Patrone","inv-item-Musket", "Waffe", 1652015642, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.HeavyShotgun, new ItemsInfo("Heavy Shotgun", "Das Magazin dieser HeavyShotgun umfasst 6 Patronen","inv-item-Heavy-Shotgun", "Waffe", 3085098415, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.DoubleBarrelShotgun, new ItemsInfo("Double Barrel Shotgun", "Das Magazin dieser DoubleBarrelShotgun umfasst 2 Patronen","inv-item-Double-Barrel-Shotgun", "Waffe", 222483357, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.SweeperShotgun, new ItemsInfo("Sweeper Shotgun", "Das Magazin dieser SweeperShotgun umfasst 10 Patronen","inv-item-Sweeper-Shotgun", "Waffe", NAPI.Util.GetHashKey("w_sg_sweeper"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.PumpShotgunMk2, new ItemsInfo("Pump Shotgun Mk2", "Das Magazin dieser PumpShotgunMk2 umfasst 8 Patronen","inv-item-Pump-Shotgun-Mk-II", "Waffe", 3194406291, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
             
            /* NEW WEAPONS */
            { ItemId.RayPistol, new ItemsInfo("Up-n-Atomizer", "Eine Laserstrahlpistole aus der Zukunft O.o", "inv-item-Vintage-Pistol", "Waffe", NAPI.Util.GetHashKey("w_pi_raygun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CeramicPistol, new ItemsInfo("Ceramic Pistol", "Das Magazin dieser CeramicPistol umfasst 12 Patronen", "inv-item-Combat-Pistol", "Waffe", NAPI.Util.GetHashKey("w_pi_ceramic_pistol"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.NavyRevolver, new ItemsInfo("Navy Revolver", "Das Magazin dieser NavyRevolver umfasst 6 Patronen", "inv-item-Heavy-Revolver-Mk-II", "Waffe", NAPI.Util.GetHashKey("w_pi_wep2_gun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.RayCarbine, new ItemsInfo("Unholy Hellbringer", "Ein Futuristisches Plasmagewehr welches ein ungewöhnliches Aussehen hat", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_ar_srifle"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.GrenadeLauncher, new ItemsInfo("Grenade Launcher", "Das Magazin dieser GrenadeLauncher umfasst 10 Patronen", "", "Waffe", NAPI.Util.GetHashKey("w_lr_grenadelauncher"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.RPG, new ItemsInfo("RPG", "Das Magazin dieser RPG umfasst 1 Patrone", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_lr_rpg"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Minigun, new ItemsInfo("Minigun", "Das Magazin dieser Minigun umfasst 595 Patrone", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_mg_minigun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Firework, new ItemsInfo("Firework Launcher", "Ein Feuerwerk ist eine pyrotechnische Darbietung, zumeist am Nachthimmel, bei der Feuerwerkskörper planmäßig gezündet werden", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_mg_minigun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Railgun, new ItemsInfo("Railgun", "Das Magazin dieser Railgun umfasst 20 Patronen", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_ar_railgun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.HomingLauncher, new ItemsInfo("Homing Launcher", "Raketenwerfer mit Infrarotführung zum Ziel, enthält 1 Munition.", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_lr_homing"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.GrenadeLauncherSmoke, new ItemsInfo("Grenade Launcher Smoke", "Ein leichter Granatwerfer, der Rauchgranaten anstelle von normalen Granaten abfeuert.", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_lr_grenadelauncher"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.CompactGrenadeLauncher, new ItemsInfo("Compact Grenade Launcher", "Kompakter Granatwerfer fasst nur 1 Munition", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_lr_compactgl"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Widowmaker, new ItemsInfo("Widowmaker", "Ein futuristisches Plasma-Maschinengewehr, das bis zu 9999 Munition aufnehmen kann", "NEEDTEXT", "Waffe", NAPI.Util.GetHashKey("w_mg_sminigun"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
 
            /* MELEE WEAPONS */
            { ItemId.Knife, new ItemsInfo("Messer", "Ein scharfes Messer das jemanden verletzten kann","inv-item-Knife", "Nahkampfwaffe", 2312523967, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Nightstick, new ItemsInfo("Schlagstock", "Grundsätzlich ist er ein langes zylindrisches oder konisches Instrument, welches mit einer Hand geführt wird, um damit auf Menschen oder Dinge einzuschlagen","inv-item-Nightstick", "Nahkampfwaffe", 2659989060, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Hammer, new ItemsInfo("Hammer", "Der Hammer ist das wohl älteste Werkzeug der Welt. Er besteht in der Regel auf der einen Seite aus einem Stiel zum Greifen, mit dem Kraft für den Schlag aufgebaut werden kann.","inv-item-Hammer", "Nahkampfwaffe", 64104227, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Bat, new ItemsInfo("Baseballschläger", "Ein Baseballschläger muss im Querschnitt kreisrund sein, darf maximal 42 Zoll (knapp 107 cm) lang sein und an der stärksten Stelle einen Durchmesser von höchstens 2,75 Zoll (knapp 7 cm) aufweisen","inv-item-Baseball-Bat", "Nahkampfwaffe", 32653987, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Crowbar, new ItemsInfo("Brechstange", "Sie besteht aus einer festen, genügend großen Stange aus Metall, meist aus Stahl.","inv-item-crowbar", "Nahkampfwaffe", 1862268168, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.GolfClub, new ItemsInfo("Golfschläger", "Die drei Hauptkomponenten, aus denen ein Golfschläger aufgebaut ist, sind Schlägerkopf, Schaft und Griff","inv-item-Golf-Club", "Nahkampfwaffe", 3714771050, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Bottle, new ItemsInfo("Flasche", "Eine Flasche ist ein verschließbares Behältnis zum Transport und zur Lagerung von Flüssigkeiten und Gasen sowie schüttbaren Feststoffen wie Pulver","inv-item-Broken-Bottle", "Nahkampfwaffe", 1150762982, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Dagger, new ItemsInfo("Dolch", "Im Gegensatz zum Messer, das primär zum Schneiden ausgelegt ist, ist der Dolch als Stichwaffe konzipiert.","inv-item-Antique-Cavalry-Dagger", "Nahkampfwaffe", 601713565, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Hatchet, new ItemsInfo("Axt", "Die Axt, oberdeutsch auch Hacke genannt, ist ein Werkzeug und besteht im Allgemeinen aus einem Stück Stahl mit einer geschmiedeten stählernen Schneide","inv-item-Hatchet", "Nahkampfwaffe", 1653948529, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.KnuckleDuster, new ItemsInfo("Schlagring", "Ein Schlagring ist eine für den Nahkampf angepasste Handwaffe, die aus einem Griff besteht, durch die die Finger der Faust gesteckt werden.","inv-item-Brass-Knuckles", "Nahkampfwaffe", 3005998612, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Machete, new ItemsInfo("Machete", "Ein großes Messer mit einer bis zu drei Millimeter starken, langen Klinge, die für hackende und hauende Bewegungen beziehungsweise Tätigkeiten ausgelegt ist ","inv-item-Machete", "Nahkampfwaffe", 2239480765, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Flashlight, new ItemsInfo("Taschenlampe", "Eine Taschenlampe ist eine kleine, mobile Lichtquelle mit eigener Energieversorgung","inv-item-Flashlight", "Nahkampfwaffe", 2278481040, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.SwitchBlade, new ItemsInfo("Schweizer Messer", "Ein Merkmal der Schweizer Taschenmesser ist, dass neben einer Klinge noch weitere Werkzeuge in das Messer integriert sind","inv-item-Switchblade", "Nahkampfwaffe", 3331136096, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.PoolCue, new ItemsInfo("Queue", "Das Queue besteht entweder aus Holz oder aus mit Glas- oder Kohlenstofffasern verstärktem Kunststoff oder Aluminium","inv-item-Pool-Cue", "Nahkampfwaffe", 1184113278, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.Wrench, new ItemsInfo("Schraubenschlüssel", "Ein Schlüssel der treueste Helfer wenn etwas kaputt geht.","inv-item-Pipe-Wrench", "Nahkampfwaffe", 1959553115, 1, new Vector3(0.0,0.0,-0.985), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            { ItemId.BattleAxe, new ItemsInfo("Streitaxt", "Der Begriff Streitaxt oder Kriegsbeil ist eine Sammelbezeichnung für alle ein- oder zweihändig führbaren, im Kampf eingesetzten Äxte und Beile","inv-item-Battle-Axe", "Nahkampfwaffe", 3406411762, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.MeleeWeapons) },
            /* Ammo */
            { ItemId.PistolAmmo, new ItemsInfo("9mm", "Das Kaliber 9mm Luger ist als Militär- und Polizeipatrone weltweit verbreitet, und auch zivile Waffenträger schätzen die effektive und angenehm zu schießende Patrone","inv-item-ammo-pistol", "Munition", NAPI.Util.GetHashKey("v_ret_gc_ammo5"), 100, new Vector3(0.0,0.0,-0.7), new Vector3(), newItemType.Ammo) },
            { ItemId.RiflesAmmo, new ItemsInfo("7,62 × 39", "Die Mittelpatrone 7,62 × 39 mm (häufig auch unter der militärischen Bezeichnung Kurzpatrone M 43 geführt) gehörte als Munition zur Ausrüstung der Roten Armee, der Armeen des Warschauer Pakts und der Volksbefreiungsarmee Chinas","inv-item-ammo-average", "Munition", NAPI.Util.GetHashKey("prop_ld_ammo_pack_03"), 250, new Vector3(0.0,0.0,-0.7), new Vector3(), newItemType.Ammo) },
            { ItemId.ShotgunsAmmo, new ItemsInfo("12 Gauge",  "Die Angabe Kaliber 12 (englisch 12 Gauge) (gleich 18,53 mm × Hülsenlänge) bedeutet, dass zwölf gleich große Bleikugeln eine Masse von einem englischen Pfund (ca. 454 g) ergeben","inv-item-ammo-shotgun", "Munition", NAPI.Util.GetHashKey("prop_ld_ammo_pack_02"), 50, new Vector3(0.0,0.0,-0.7), new Vector3(), newItemType.Ammo) },
            { ItemId.SMGAmmo, new ItemsInfo("5,45 × 39", "Die Patrone 5,45 × 39 mm wird fast ausschließlich für den militärischen Bedarf früherer Mitgliedsstaaten des Warschauer Pakts hergestellt oder für Staaten, die mit diesen kooperierten","inv-item-ammo-small", "Munition", NAPI.Util.GetHashKey("v_ret_gc_ammo1"), 300, new Vector3(0.0,0.0,-0.7), new Vector3(), newItemType.Ammo) },
            { ItemId.SniperAmmo, new ItemsInfo(".50 BMG", "Die . 50 BMG gilt im militärischen Scharfschützenbereich als Patrone mit hoher Zerstörungskraft bei extremer Reichweite","inv-item-ammo-sniper", "Munition", NAPI.Util.GetHashKey("v_ret_gc_ammo2"), 48, new Vector3(0.0,0.0,-0.7), new Vector3(), newItemType.Ammo) },
            /* NEW */
            { ItemId.Snowball, new ItemsInfo("Schneeball", "Ein Schneeball ist ein kugelförmiges Gebilde aus Schnee, das mit den Händen zusammengedrückt oder über verschneites Gelände gerollt wird","inv-item-marijuana", "Andere", 1297482736, 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Weapons) },
            { ItemId.Ball, new ItemsInfo("Ball", "Das beste Spielzeug eines Haustieres","inv-item-ball", "Andere", 1297482736, 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Weapons) },
            
            //
            { ItemId.cVarmod, new ItemsInfo("Waffen Vinyl", "Mit Hilfe dieser Komponente können Sie eine Waffe dekorieren und sie attraktiver aussehen lassen","inv-item-Varmod", "Andere", NAPI.Util.GetHashKey("prop_paint_spray01a"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cClip, new ItemsInfo("Ammu-Nation", "Ein verbessertes Magazin ermöglicht es Ihnen, die maximale Munitionskapazität der Waffe zu erweitern.","inv-item-Clips", "Andere", NAPI.Util.GetHashKey("w_ar_assaultriflemk2_mag1"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cSuppressor, new ItemsInfo("Schalldämpfer", "Wenn der Schalldämpfer an einer Waffe montiert ist, dämpft er das Geräusch von Schüssen und ermöglicht es Ihnen lautlos zu schießen.","inv-item-Suppressors", "Andere", NAPI.Util.GetHashKey("w_at_ar_supp"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cScope, new ItemsInfo("Visier", "Das einmal montierte Fadenkreuz ermöglicht es dem Waffenträger, seine Feinde genauer zu zielen (verwenden Sie das Mausrad)","inv-item-Scopes", "Andere", NAPI.Util.GetHashKey("w_at_scope_medium"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cMuzzlebrake, new ItemsInfo("Mündungsfeuer", "Als Mündungsfeuer bezeichnet man die Flamme, die sich beim Abschuss von Feuerwaffen an der Mündung des Laufes bildet.","inv-item-Muzzle-Brakes", "Andere", NAPI.Util.GetHashKey("w_at_muzzle_1"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cBarrel, new ItemsInfo("Waffen Upgrade", "Ein verbesserter Lauf an einer Waffe ermöglicht es Ihnen, die Genauigkeit und den Schaden einer Waffe zu erhöhen.","inv-item-Barrels", "Andere", NAPI.Util.GetHashKey("w_at_sr_barrel_1"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cFlashlight, new ItemsInfo("Taschenlampe Waffe", "Eine an einer Waffe montierte Taschenlampe ist eine großartige Möglichkeit, Ihre Feinde im Dunkeln zu sehen. (E einschalten)","inv-item-Flashlights", "Andere", NAPI.Util.GetHashKey("w_at_ar_flsh"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cGrip, new ItemsInfo("Waffengriff", "Verbesserter Waffengriff sorgt für komfortableres Schießen","inv-item-Grips", "Andere", NAPI.Util.GetHashKey("w_at_afgrip_2"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
            { ItemId.cCamo, new ItemsInfo("Waffen Camouflage", "Mit Camouflage können Sie das Aussehen von Waffen verändern.","inv-item-Varmod", "Andere", NAPI.Util.GetHashKey("prop_paint_spray01a"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.Modification) },
        
            //
            { ItemId.HalloweenCoin, new ItemsInfo("Halloween 2020 Coin", "Halloween-Münze, für die Sie an den Tagen des Events besondere Preise erhalten können","inv-item-EventCoin", "Andere", NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 999999, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Firework1, new ItemsInfo("Feuerwerk", "Ein schönes Feuerwerk","inv-item-Firework1", "Unterhaltung", NAPI.Util.GetHashKey("ind_prop_firework_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Firework2, new ItemsInfo("Feuerwerk Stern", "Schönes Feuerwerk in Form eines Sterns","inv-item-Firework2", "Unterhaltung", NAPI.Util.GetHashKey("ind_prop_firework_02"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Firework3, new ItemsInfo("Feuerwerk Regen", "Schönes Feuerwerk in Form einer Explosion","inv-item-Firework3", "Unterhaltung", NAPI.Util.GetHashKey("ind_prop_firework_03"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Firework4, new ItemsInfo("Feuerwerk Brunnen", "Schönes Feuerwerk in Form eines Springbrunnens","inv-item-Firework4", "Unterhaltung", NAPI.Util.GetHashKey("ind_prop_firework_04"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.CarCoupon, new ItemsInfo("Fahrzeug Gutschein", "Enthält ein Fahrzeug das nach der Aktivierung in die Garage geliefert wird","inv-item-car", "Gutschein", 3125389411, 1, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.MerryChristmasCoin, new ItemsInfo("Christmas 2021 Coin", "Eine Weihnachtsmünze für die Sie an den Veranstaltungstagen Sonderpreise erhalten können","inv-item-EventCoin", "Andere", NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 999999, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Bear, new ItemsInfo("Kuschelbär", "Schenke diesen an eine nette Person","inv-item-teddy-bear", "Andere", NAPI.Util.GetHashKey("v_ilev_mr_rasberryclean"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            
            { ItemId.Note, new ItemsInfo("Brief", "Mit Hilfe einer Notiz können Sie eine Nachricht hinterlassen, ein Geheimnis oder andere wichtige Informationen übermitteln.","inv-item-Note", "Andere", NAPI.Util.GetHashKey("p_amanda_note_01_s"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.LoveNote, new ItemsInfo("Liebesbrief", "Eine Valentinskarte hilft dabei Ihre warmen Gefühle für eine Person zu beschreiben","inv-item-LoveNote", "Andere", NAPI.Util.GetHashKey("p_amanda_note_01_s"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Vape, new ItemsInfo("Vape", "Eine Vape, auch E-Zigarette oder elektronische Zigarette genannt, ist ein elektronisches Gerät, das verwendet wird, um Nikotin und Aromen, als E-Liquid, in Form von Dampf zu inhalieren","inv-item-Vape", "Andere", NAPI.Util.GetHashKey("ba_prop_battle_vape_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Rose, new ItemsInfo("Rose", "Ein wunderbares Geschenk für einen lieben Menschen!","inv-item-rose", "Andere", NAPI.Util.GetHashKey("prop_single_rose"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Barbell, new ItemsInfo("Hantel", "Eine Hantel ist ein Sportgerät, das meist aus einer Stange und zwei an deren Enden befestigten Gewichten in Form von Kugeln oder Scheiben besteht","inv-item-barbell", "Andere", NAPI.Util.GetHashKey("prop_barbell_02"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Binoculars, new ItemsInfo("Fernglas", "Ermöglicht es Ihnen Objekte in der Ferne zu sehen.","inv-item-binoculars", "Andere", NAPI.Util.GetHashKey("prop_binoc_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Bong, new ItemsInfo("Bong", "Eine Bong (auch: Ücke) ist eine Wasserpfeife, die ohne Schlauch geraucht wird","inv-item-bong", "Andere", NAPI.Util.GetHashKey("prop_bong_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Umbrella, new ItemsInfo("Regenschirm", "Ermöglicht es Ihnen, sich vor dem Regen zu verstecken und Stilvoll auszusehen","inv-item-umbrella", "Andere", NAPI.Util.GetHashKey("p_amb_brolly_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Camera, new ItemsInfo("Kamera", "Licht... Kamera... Aktion!","inv-item-camera", "Andere", NAPI.Util.GetHashKey("prop_v_cam_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Microphone, new ItemsInfo("Mikrofon", "Ein Mikrofon Schallwandler, der Luftschall als Schallwechseldruckschwingungen in entsprechende elektrische Spannungsänderungen als Mikrofonsignal umwandelt","inv-item-microphone", "Andere", NAPI.Util.GetHashKey("p_ing_microphonel_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Guitar, new ItemsInfo("Gitare", "Es bittet nur darum, abgeholt zu werden ... Spielen Sie etwas","inv-item-guitar", "Andere", NAPI.Util.GetHashKey("prop_acc_guitar_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Pickaxe1, new ItemsInfo("Spitzhacke", "Mit diesem Ding kannst du in der Mine arbeiten.", "inv-item-pickaxe1", "Andere", NAPI.Util.GetHashKey("prop_tool_pickaxe"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Pickaxe2, new ItemsInfo("verbesserte Spitzhacke", "Mit diesem Ding kannst du in der Mine arbeiten.", "inv-item-pickaxe2", "Andere", NAPI.Util.GetHashKey("prop_tool_pickaxe"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Pickaxe3, new ItemsInfo("professionale Spitzhacke", "Mit diesem Ding kannst du in der Mine arbeiten.", "inv-item-pickaxe3", "Andere", NAPI.Util.GetHashKey("prop_tool_pickaxe"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Coal, new ItemsInfo("Kohle", "Fossil aus der Mine", "inv-item-coal", "Andere", NAPI.Util.GetHashKey("prop_rock_5_smash2"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Iron, new ItemsInfo("Eisenerz", "Fossil aus der Mine", "inv-item-iron", "Andere", NAPI.Util.GetHashKey("prop_rock_5_smash2"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Gold, new ItemsInfo("Golderz", "Fossil aus der Mine", "inv-item-gold", "Andere", NAPI.Util.GetHashKey("prop_rock_5_smash2"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Sulfur, new ItemsInfo("Schwefelerz", "Fossil aus der Mine", "inv-item-sulfur", "Andere", NAPI.Util.GetHashKey("prop_rock_5_smash2"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Emerald, new ItemsInfo("Smaragd", "Fossil aus der Mine", "inv-item-emerald", "Andere", NAPI.Util.GetHashKey("prop_rock_5_smash2"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Ruby, new ItemsInfo("Rubin", "Fossil aus der Mine", "inv-item-ruby", "Andere", NAPI.Util.GetHashKey("prop_rock_5_smash2"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Radio, new ItemsInfo("Funkgerät", "Mit Hilfe eines Funkgeräts können Sie mit anderen Funkgerät-Besitzern kommunizieren oder sogar eine Polizei- oder andere Geheimwelle belauschen.", "hud__icon-walkie-talkie", "Andere", NAPI.Util.GetHashKey("prop_cs_hand_radio"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.WorkAxe, new ItemsInfo("Axt", "Holzfäller-Werkzeug.", "inv-item-workaxe", "Andere", NAPI.Util.GetHashKey("prop_ld_fireaxe"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.WoodOak, new ItemsInfo("Eiche", "Ich und mein Holz.", "inv-item-woodoak", "Andere", NAPI.Util.GetHashKey("prop_fncwood_16e"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.WoodMaple, new ItemsInfo("Ahorn", "Ich und mein Holz.", "inv-item-woodmaple", "Andere", NAPI.Util.GetHashKey("prop_fncwood_16e"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.WoodPine, new ItemsInfo("Kiefer", "Ich und mein Holz.", "inv-item-woodpine", "Andere", NAPI.Util.GetHashKey("prop_fncwood_16e"), 250, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Boombox, new ItemsInfo("Boombox", "Ermöglicht es Ihnen, Ihre Musik für Personen in der Umgebung abzuspielen. Rock die Party!", "inv-item-boombox", "Andere", NAPI.Util.GetHashKey("prop_ghettoblast_01"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(0, 0, 0), newItemType.None) },
            { ItemId.Hookah, new ItemsInfo("Hookah", "Schnapp' die Scheine, verteil' die KreideKenn' mich nicht mit Shisha aus, doch seh', du bist 'ne Pfeife", "inv-item-hookah", "Andere", NAPI.Util.GetHashKey("hookah_model"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Case0, new ItemsInfo(RouletteCasesData[0].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case0", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case1, new ItemsInfo(RouletteCasesData[1].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case1", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case2, new ItemsInfo(RouletteCasesData[2].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case2", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case3, new ItemsInfo(RouletteCasesData[3].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case3", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case4, new ItemsInfo(RouletteCasesData[4].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case4", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case5, new ItemsInfo(RouletteCasesData[5].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case5", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case6, new ItemsInfo(RouletteCasesData[6].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case6", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case7, new ItemsInfo(RouletteCasesData[7].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case7", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case8, new ItemsInfo(RouletteCasesData[8].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case8", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case9, new ItemsInfo(RouletteCasesData[9].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case9", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case10, new ItemsInfo(RouletteCasesData[10].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case10", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case11, new ItemsInfo(RouletteCasesData[11].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case11", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case12, new ItemsInfo(RouletteCasesData[12].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case12", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case13, new ItemsInfo(RouletteCasesData[13].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case13", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case14, new ItemsInfo(RouletteCasesData[14].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case14", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case15, new ItemsInfo(RouletteCasesData[15].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case15", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },
            { ItemId.Case16, new ItemsInfo(RouletteCasesData[16].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case16", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },  
            { ItemId.Case17, new ItemsInfo(RouletteCasesData[17].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case17", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },  
            { ItemId.Case18, new ItemsInfo(RouletteCasesData[18].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case18", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },  
            { ItemId.Case19, new ItemsInfo(RouletteCasesData[19].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case19", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) }, 
            { ItemId.Case20, new ItemsInfo(RouletteCasesData[20].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case20", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },  
            { ItemId.Case21, new ItemsInfo(RouletteCasesData[21].Name, "Ich möchte, dass die Leute verstehen, dass Glücksspiel nichts Schlechtes ist, wenn man es im Rahmen seiner eigentlichen Aufgabe betreibt, nämlich Spaß und Unterhaltung. zitat: Michael Jordan", "inv-item-case21", "Andere", NAPI.Util.GetHashKey("prop_idol_case_02"), 100, new Vector3(0.0,0.0,-1.0), new Vector3(90, 0, 0), newItemType.Cases) },  

            { ItemId.SummerCoin, new ItemsInfo("Jaguar Coin", "Eine Münze, für die Sie an den Veranstaltungstagen Sonderpreise erhalten können. IST KEINE DONATIONWÄHRUNG!","inv-item-EventCoin", "Andere", NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 999999, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.CandyCane, new ItemsInfo("Weihnachtslutscher", "Neujahrsbonbons, für die Sie an den Veranstaltungstagen Sonderpreise erhalten können.","inv-item-EventCoin", "Andere", NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 999999, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) }, 
            { ItemId.Qr, new ItemsInfo("QR Code", "QR-Code mit Informationen zur Krankheit und/oder Impfung. Auf Anfrage einreichen.","inv-item-QR", "Andere", NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) }, 
            { ItemId.QrFake, new ItemsInfo("QR Code", "QR-Code mit Informationen zur Krankheit und/oder Impfung. Auf Anfrage einreichen.","inv-item-QR", "Andere", NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.SimCard, new ItemsInfo("Sim-Karte", "SIM-Karte mit Telefonnummer. Es lässt sich in jedes moderne Smartphone einlegen und das Mobilfunknetz nutzen: SMS schreiben, telefonieren und vieles mehr.","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("prop_ld_contact_card"), 1, new Vector3(0.0,0.0,-0.92), new Vector3(90, 0, 0), newItemType.None) }, /// SIMCARD NEWPHONE
            { ItemId.VehicleNumber, new ItemsInfo("Kennzeichen", "Kfz-Kennzeichen. Sie können es an Ihrem Fahrzeug befästigen, verkaufen oder jemandem geben!","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("p_num_plate_02"), 1, new Vector3(0.0,0.0,-0.935), new Vector3(-90, 0, 90), newItemType.None) },
            { ItemId.Bint, new ItemsInfo("Verband", "Verband, stellt 40 % Gesundheit wieder her. Kann einmal alle 3 Minuten verwendet werden.","inv-item-SimCard", "Andere", 678958360, 10, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) }, //
            { ItemId.Cocaine, new ItemsInfo("Kokain", "Spieglein, Spieglein auf dem Tisch, ich bin müde, mach mich frisch.","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("bkr_prop_coke_powder_02"), 10, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Rub100, new ItemsInfo("1€", "Du kannst diesen Gegenstand beim Projektmanager gegen echtes Geld eintauschen! ","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("bkr_prop_money_wrapped_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Rub200, new ItemsInfo("2€", "Du kannst diesen Gegenstand beim Projektmanager gegen echtes Geld eintauschen! ","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("bkr_prop_money_wrapped_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Rub500, new ItemsInfo("5€", "Du kannst diesen Gegenstand beim Projektmanager gegen echtes Geld eintauschen! ","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("bkr_prop_money_wrapped_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Rub1000, new ItemsInfo("10€", "Du kannst diesen Gegenstand beim Projektmanager gegen echtes Geld eintauschen!","inv-item-SimCard", "Andere", NAPI.Util.GetHashKey("bkr_prop_money_wrapped_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            //
            { ItemId.RadioInterceptor, new ItemsInfo("Funkabfangjäger", "Ermöglicht es Ihnen, Daten über HeliCrash zu erhalten.","hud__icon-walkie-talkie", "Andere", NAPI.Util.GetHashKey("prop_cs_mini_tv"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Epinephrine, new ItemsInfo("Adrenalin","Für eine Behandlung erforderlich, kann 1 Mal in 5 Minuten verwendet werden.","inv-item-medical-kit", "Andere",  NAPI.Util.GetHashKey("p_syringe_01_s"), 10, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.AppleCoin, new ItemsInfo("Apple Coin","Münze, die an den Veranstaltungstagen erhältlich ist. ","inv-item-medical-kit", "Andere",  NAPI.Util.GetHashKey("ch_prop_arcade_fortune_coin_01a"), 999, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            //
            { ItemId.Fire, new ItemsInfo("Lagerfeuer", "Geeignet für Abendveranstaltungen, verbrennen Sie sich nicht!","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_fire"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Matras, new ItemsInfo("Luftmatratze", "Für einen Strandurlaub und nicht zum Ertrinken","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_lilo_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Tent, new ItemsInfo("Zelt", "Für Camping, Picknick und wilde Nächte","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_skid_tent_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Lezhak, new ItemsInfo("Sonnenbank", "Ein Solarium technische Einrichtung zur Bestrahlung des Körpers mit UV-Licht.","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_patio_lounger_3"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Towel, new ItemsInfo("Handtuch", "Für einen Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_towel_04"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flag, new ItemsInfo("Flagge", "Russische Flagge, vergessen Sie nicht, einen Fahnenmast zu kaufen","placingprop", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_us_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Barrell, new ItemsInfo("Fass", "Geeignet für verschiedene Bedürfnisse","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_wooden_barrel"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Surf, new ItemsInfo("Surfbrett", "Für einen Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_surf_board_03"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Vedro, new ItemsInfo("Eimer", "So groß wie die Muschi deines Ex, reicht Für einen Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_buck_spade_03"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagstok, new ItemsInfo("Flagge Sprunk ", "Fahnenmast mit großer angebrachter Sprunk-Flagge","placingprop", "Gegenstände", NAPI.Util.GetHashKey("stt_prop_flagpole_1b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Tenttwo, new ItemsInfo("Zelt", "Für Camping, Picknick und wilde Nächte","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_skid_tent_01b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Polotence, new ItemsInfo("Handtuch", "Für einen Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("p_cs_beachtowel_01_s"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Beachbag, new ItemsInfo("Strandtasche", "Für einen Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_bag_03"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
		    { ItemId.Zontik, new ItemsInfo("Regenschirm", "Schützt vor der Sonne und perfekt für den Strand geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_parasol_04"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
	        { ItemId.Zontiktwo, new ItemsInfo("Regenschirm", "Schützt vor der Sonne und perfekt für den Strand geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_parasol_02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Zontikthree, new ItemsInfo("Regenschirm", "Schützt vor der Sonne und perfekt für den Strand geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_parasol_04c"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },						        
            { ItemId.Closedzontik, new ItemsInfo("geschlossener Regenschirm", "Schützt nicht vor der Sonne, aber für einen Strandurlaub geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_parasol_04e"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Vball, new ItemsInfo("Volleyballball", "Für lustige Spiele und Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beach_volball01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Bball, new ItemsInfo("Wasserball", "Für lustige Spiele und Strandurlaub","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beachball_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Boomboxxx, new ItemsInfo("Boombox", "Gut zum Abhängen mit Freunden","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_boombox_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Table, new ItemsInfo("Tisch", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("bkr_prop_coke_table01a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Tabletwo, new ItemsInfo("Tisch", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_ld_farm_table02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Tablethree, new ItemsInfo("Tisch", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_proxy_chateau_table"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Tablefour, new ItemsInfo("Tisch", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_table_03b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Chair, new ItemsInfo("Stuhl", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("hei_prop_hei_skid_chair"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Chairtwo, new ItemsInfo("Stuhl", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_chair_01b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Chaierthree, new ItemsInfo("Stuhl", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_direct_chair_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Chaierfour, new ItemsInfo("Stuhl", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_table_03_chr"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Chairtable, new ItemsInfo("Tisch und Stuhl", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_picnictable_01_lod"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Korzina, new ItemsInfo("Korb", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_fruit_basket"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Light, new ItemsInfo("Beleuchtung", "Beleuchtung, die nachts gut zu gebrauchen ist","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_worklight_03b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Alco, new ItemsInfo("Schnapsflasche", "Teure Flasche Brandy: Geeignet zum Spaß und eine gute Nacht mit einem Mädchen oder einem Mann","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_bottle_brandy"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Alcotwo, new ItemsInfo("Cognacflasche", "Teure Flasche Cognac: Geeignet zum Spaß und eine gute Nacht mit einem Mädchen oder einem Mann","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_bottle_cognac"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Alcothree, new ItemsInfo("Tequilaflasche", "Teure Flasche Tequila: Geeignet zum Spaß und eine gute Nacht mit einem Mädchen oder einem Mann","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_tequila_bottle"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Alcofour, new ItemsInfo("Bierflasche", "Morgens ein Bier und der Tag gehört Dir!","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_beer_am"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Cocktail, new ItemsInfo("Cocktail", "Eine Mischung aus Zitrusfrüchten und Alkohol, perfekt für deine Freundin","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_cocktail"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Cocktailtwo, new ItemsInfo("Cocktail", "Eine Mischung aus Zitrusfrüchten und Alkohol, perfekt für deine Freundin","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_cocktail_glass"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Fruit, new ItemsInfo("Obstplatte", "Köstlicher und duftender Obstteller","placingprop", "Gegenstände", NAPI.Util.GetHashKey("ex_mp_h_acc_fruitbowl_02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Fruittwo, new ItemsInfo("Obstplatte", "Köstlicher und duftender Obstteller","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_bar_fruit"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Packet, new ItemsInfo("Paket", "Geeignet für ein Picknick","placingprop", "Gegenstände", NAPI.Util.GetHashKey("ng_proc_food_bag01a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Buter, new ItemsInfo("belegtes Brötchen", "Geeignet für ein Picknick","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_food_bs_burg3"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Patatoes, new ItemsInfo("Pommes", "Geeignet für ein Picknick","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_food_bs_chips"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Coffee, new ItemsInfo("Kaffee", "Geeignet für ein Picknick","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_food_bs_coffee"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Podnosfood, new ItemsInfo("Essenstablett", "Geeignet für ein Picknick","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_food_bs_tray_02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Bbqtwo, new ItemsInfo("Barbecue", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_bbq_4_l1"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
			{ ItemId.Bbq, new ItemsInfo("großes Barbecue", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_bbq_5"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flowerrr, new ItemsInfo("Blumenstrauß", "Ein wunderschöner Blumenstrauß mit bunten Blumen den Ihre Dame lieben wird","prop_snow_flower_02", "Gegenstände", NAPI.Util.GetHashKey("prop_snow_flower_02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Vaza, new ItemsInfo("Vase mit Blumen", "Eine Vase mit wunderschönen weißen Blumen die Ihre Dame lieben wird","vw_prop_flowers_vase_01a", "Gegenstände", NAPI.Util.GetHashKey("vw_prop_flowers_vase_01a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagwtokk, new ItemsInfo("Sonnenschirm", "Geeignet für ein Picknick oder eine Erholung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_flagpole_2a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },

            { ItemId.Flagau, new ItemsInfo("Flagge Australien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_australia", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_australia"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagbr, new ItemsInfo("Flagge Brasilien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_brazil", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_brazil"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagch, new ItemsInfo("Flagge China", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_china", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_china"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagcz, new ItemsInfo("Flagge Tschechien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_czechrep", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_czechrep"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flageng, new ItemsInfo("Flagge England", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_england", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_england"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },

            { ItemId.Flageu, new ItemsInfo("Flagge Europa", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_eu_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_eu_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },

            { ItemId.Flagfin, new ItemsInfo("Flagge Finnland", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_finland", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_finland"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagfr, new ItemsInfo("Flagge Frankreich", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_france", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_france"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagger, new ItemsInfo("Flagge Deutschland", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_german_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_german_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagire, new ItemsInfo("Flagge Irland", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_ireland", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_ireland"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagisr, new ItemsInfo("Flagge Israel", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_israel", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_israel"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagit, new ItemsInfo("Flagge Italien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_italy", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_italy"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagjam, new ItemsInfo("Flagge Jamaika", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_jamaica", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_jamaica"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagjap, new ItemsInfo("Flagge Japan", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_japan_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_japan_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagmex, new ItemsInfo("Flagge Mexiko", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_mexico_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_mexico_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagnet, new ItemsInfo("Flagge Niederlande", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_netherlands", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_netherlands"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagnig, new ItemsInfo("Flagge Nigeria", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_nigeria", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_nigeria"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagnorw, new ItemsInfo("Flagge Norwegen", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_norway", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_norway"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagpol, new ItemsInfo("Flagge Polen", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_poland", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_poland"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagrus, new ItemsInfo("Flagge Russland", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_russia_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_russia_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagbel, new ItemsInfo("Flagge Belgien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_belgium", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_belgium"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },

            { ItemId.Flagscot, new ItemsInfo("Flagge Schottland", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_scotland_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_scotland_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagscr, new ItemsInfo("Flagge Skript", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_script", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_script"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },

            { ItemId.Flagslov, new ItemsInfo("Flagge Slowakei", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_slovakia", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_slovakia"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagslovak, new ItemsInfo("Flagge Slowenien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_slovenia", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_slovenia"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagsou, new ItemsInfo("Flagge Korea", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_southkorea", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_southkorea"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagspain, new ItemsInfo("Flagge Spanien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_spain", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_spain"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagswede, new ItemsInfo("Flagge Schweden", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_sweden", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_sweden"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagswitz, new ItemsInfo("Flagge Schweiz", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_switzerland", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_switzerland"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagturk, new ItemsInfo("Flagge Türkei", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_turkey", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_turkey"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            //
            { ItemId.Flaguk, new ItemsInfo("Flagge Großbritannien", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_uk_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_uk_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagus, new ItemsInfo("Flagge Amerika", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_us_yt", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_us_yt"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Flagwales, new ItemsInfo("Flagge Wales", "Mittelgroße Flagge, erfordert einen Fahnenmast zur Befestigung","apa_prop_flag_wales", "Gegenstände", NAPI.Util.GetHashKey("apa_prop_flag_wales"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            //
  		    { ItemId.Konus, new ItemsInfo("Kegel", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_byard_net02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Konuss, new ItemsInfo("leuchtender Kegel", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_air_conelight"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Otboynik1, new ItemsInfo("Warnkegel", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_barrier_wat_03a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Otboynik2, new ItemsInfo("Warnkegel", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_barrier_wat_03b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Dontcross, new ItemsInfo("Schranke", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_barrier_work05"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Stop, new ItemsInfo("Stoppschild", "Geeignet für Verkehrsregeln","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_sign_road_01a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.NetProezda, new ItemsInfo("Durchfahrt gesperrt", "Geeignet für Verkehrsregeln","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_sign_road_03a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Zabor1, new ItemsInfo("großer Zaun", "Geeignet für ein Picknick","placingprop", "Gegenstände", NAPI.Util.GetHashKey("xm_prop_base_fence_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Kpp, new ItemsInfo("Kontrollpunkt", "Einen Kontrollpunkt erstellen","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_air_sechut_01"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Zabor2, new ItemsInfo("kleiner Zaun", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("xm_prop_base_fence_02"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Airlight, new ItemsInfo("Warnlicht", "Als absperrung geeignet","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_air_lights_02b"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Camera1, new ItemsInfo("Überwachungskamera", "Geeignet für die Überwachung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_cctv_cam_05a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            { ItemId.Camera2, new ItemsInfo("Überwachungskamera", "Geeignet für die Überwachung","placingprop", "Gegenstände", NAPI.Util.GetHashKey("prop_snow_cam_03a"), 1, new Vector3(0.0,0.0,-0.9), new Vector3(), newItemType.None) },
            
            { ItemId.TacticalRifle, new ItemsInfo("Tactical Rifle", "Das Magazin eines Sturmgewehr umfasst 30 Patronen.","inv-item-militaryrifle", "Waffe", 273925117, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },
            
            { ItemId.PrecisionRifle, new ItemsInfo("Precision Rifle", "Das Magazin eines Scharfschützengewehr umfasst 6 Patronen.","inv-item-militaryrifle", "Waffe", 346403307, 1, new Vector3(0.0,0.0,-0.99),new Vector3(90, 0, 0), newItemType.Weapons) },

            { ItemId.CombatShotgun, new ItemsInfo("Combat Shotgun", "Das Magazin einer Schrotflinte umfasst 10 Patronen.","inv-item-militaryrifle", "Waffe", 689760839, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },

            { ItemId.HeavyRifle, new ItemsInfo("Heavy Rifle", "Das Magazin eines Sturmgewehr umfasst 30 Patronen.","inv-item-militaryrifle", "Waffe", 2379721761, 1, new Vector3(0.0,0.0,-0.99),new Vector3(90, 0, 0), newItemType.Weapons) },
            
            { ItemId.NeonStick, new ItemsInfo("Neon-Sticks", "Rote Neon-Sticks die Sie in Ihren Händen halten können.","inv-item-Assault-Rifle", "Andere", 3455618605, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },
            
            { ItemId.GlowStick, new ItemsInfo("Leucht-Sticks", "Schöne Leuchtstäbe, die Sie in Ihren Händen halten können.","inv-item-Assault-Rifle", "Andere", NAPI.Util.GetHashKey("ba_prop_battle_glowstick_01"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.Giftcoin, new ItemsInfo("Geschenk", "Freiwillige Eigentumsübertragung einer Sache oder eines Rechts an den Beschenkten ohne Gegenleistung","inv-item-Assault-Rifle", "Andere", NAPI.Util.GetHashKey(""), 999, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },

            { ItemId.CombatRifle, new ItemsInfo("Combat Rifle", "Ein Gewehr, das alles zerstört, was ihm in den Weg kommt","inv-item-Carbine-Rifle", "Waffe", 2379721761, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },

            { ItemId.Glock, new ItemsInfo("Banana Glock", "Banana Glock Top","inv-item-Carbine-Rifle", "Waffe", 651271362, 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.Weapons) },

            { ItemId.DrugPot, new ItemsInfo("Marihuana-Topf", "Куст с нелегальными плодами...", "inv-item-DrugPot", "Остальное", NAPI.Util.GetHashKey("bkr_prop_weed_med_01b"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.Pot, new ItemsInfo("Topf", "В него можно посдать что-то интересно...", "inv-item-pickaxe3", "Остальное", NAPI.Util.GetHashKey("v_ret_fh_pot02"), 5, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.DrugSeed, new ItemsInfo("Marihuana-Samen", "Эти семена можно посадить в горшок", "inv-item-DrugSeed", "Остальное", NAPI.Util.GetHashKey("p_weed_bottle_s"), 15, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.WaterCan, new ItemsInfo("Gießkanne", "Поливайте растения и они будут расти быстрее!", "inv-item-pickaxe3", "Остальное", NAPI.Util.GetHashKey("prop_wateringcan"), 1, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },
            { ItemId.DrugPlant, new ItemsInfo("Marihuana-Planze", "Их можно обменять на косяк у диллера!", "inv-item-DrugPlant", "Остальное", NAPI.Util.GetHashKey("p_weed_bottle_s"), 15, new Vector3(0.0,0.0,-0.99), new Vector3(90, 0, 0), newItemType.None) },
        };
        ...
        public const int MaxSlotsInventory = 12; //INVENTAR PLATZ
        ...
        public static int AddNewItem(ExtPlayer player, string locationName, string Location, ItemId ItemId, int count = 1, string ItemData = "", bool stack = true, int MaxSlots = MaxSlotsInventory, bool isInfo = true, int price = 0, bool addInWarehouse = false)
        {
            try
            {
                ...
                if (success == -1 && addInWarehouse)
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSpaceInventoryThenSclad), 10000);
                }
        ...
        public static void AddNewItemWarehouse(ExtPlayer player, ItemId ItemId, int count = 1, string ItemData = "")
        {
            try
            {
                ...
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Warehouse, LangFunc.GetText(LangType.De, DataName.Posilka, Chars.Repository.ItemsInfo[ItemId].Name), DateTime.Now);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (allCount > 0)
                    {
                        ...
                        {
                            if (send) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyHaveItemStack, ItemsInfo[ItemId].Name, maxStack), 6000);
                            return -1;
                        }
                ...
                if (send && rData == -1)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSpaceInventory), 6000);// "Nicht genug Platz im Inventar"
                }
                else if (send && rData == -2)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyHaveWeapon, ItemsInfo[ItemId].Name), 6000); //"Невозможно взять {0}, потому что в инвентаре уже есть {0}"
                }
                else if (send && rData == -3)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyHaveItem, ItemsInfo[ItemId].Name), 6000); //"У Вас уже есть {0}
                }
                else if (send && rData != 0)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyHaveItemStack, ItemsInfo[ItemId].Name, maxStack), 6000); // Нет места для {0}, максимум можно иметь при себе - {1} шт.
                }
                /*else if(send && rData != 0)
                {
        ...
        public static string getCountToStockItems(string locationName)
        {
            try
            {
                ...
                return $"Waffen: {otherCount} Stk. | Munition: {ammoCount} Stk.";
            }
            catch (Exception e)
            {
                Log.Write($"getCountToStockItems Exception: {e.ToString()}");
                return $"Waffen: 0 Stk. | Munition: 0 Stk.";
            }
        }
            ...
            try
            {
                ...
                if (ArrayName == "accessories")
                {
                    ...
                    if (Item.ItemId == ItemId.BodyArmor) 
                    {
                        if (player.IsInVehicle)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantSnyatBronikInVeh), 6000);
                            return;
                        }
                ...
                else if (ArrayName != "inventory" && ArrayName != "fastSlots")
                {
                    ...
                    SetItemData(player, ArrayName, Index, new InventoryItemData(), true);
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGot, Name), 6000);
                    return;
                }
                ...
                {                        
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Du kannst keine Schutzweste anziehen wenn du dich im Fahrzeug befindest", 5000);
                        return;
                    }
                    if (Item.ItemId != ItemId.Bag && Item.ItemId != ItemId.BodyArmor && Item.ItemId != ItemId.Mask && gender != Item.GetGender())
                    {
                        string error_gender = (Item.GetGender()) ? LangFunc.GetText(LangType.De, DataName.MansC) : LangFunc.GetText(LangType.De, DataName.WomansC);
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorGender, error_gender), 6000);
                        return;
                    }
                ...
                else if (ItemInfo.functionType == newItemType.Weapons || ItemInfo.functionType == newItemType.MeleeWeapons)
                {
                    ...
                    SetItemData(player, ArrayName, Index, new InventoryItemData(), true);
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FastSlotAdd), 6000);
                    return;
                }
                else if (Item.ItemId == ItemId.Beer)
                {
                    ...
                    Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.Bahnuv) + (characterData.Gender ? "" : "а") + LangFunc.GetText(LangType.De, DataName.Pivka));
                ...
                else if (ItemInfo.functionType == newItemType.Alco)
                {
                    ...
                    if (rdata.Ban)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SoDrunk), 6000);
                        return;
                    }
                ...
                else if (ItemInfo.functionType == newItemType.Modification && Item.Data.Split("_").Length > 0)
                {
                    ...
                    if (ItemsData.ContainsKey($"weapon_{Item.SqlId}") && ItemsData[$"weapon_{Item.SqlId}"].ContainsKey("weapon"))
                    {
                        foreach (InventoryItemData itemData in ItemsData[$"weapon_{Item.SqlId}"]["weapon"].Values)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyModifiedWeapon), 6000);
                                return;
                            };
                        }
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.KeyChainNoSpace), 6000);
                        return;
                    }
                    SetItemData(player, ArrayName, Index, new InventoryItemData(), true);
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ModifWeapon), 6000);
                    return;
                }
                ...
                switch (Item.ItemId)
                {
                    ...
                    case ItemId.CarKey:
                        ...
                        SetItemData(player, ArrayName, Index, new InventoryItemData(), true);
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.KeyChainSucc), 6000);
                        BattlePass.Repository.UpdateReward(player, 73);
                        return;
                    ...
                    case ItemId.Burger:
                        if (DateTime.Now > sessionData.TimingsData.NextEat)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DontWantToEat), 6000);
                                return;
                            }*/
                            ...
                            Commands.RPChat("sme", player, $"isst" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
                    ...
                    case ItemId.Drugs:
                        if (DateTime.Now > sessionData.TimingsData.NextDrugs)
                        {
                            ...
                            {
                                case 0:
                                    Commands.RPChat("sme", player, $"kifft" + (characterData.Gender ? "" : "а") + " blunt");
                                    break;
                                case 1:
                                    Commands.RPChat("sme", player, $"kifft" + (characterData.Gender ? "" : "а") + " blunt");
                                    break;
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DrugsTooMany), 6000);
                            return;
                        }
                        break;
                     case ItemId.Cocaine:
                    ...
                    case ItemId.DrugPot:
                        if (player.IsInVehicle)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Du musst dich auf dem Boden befinden", 3000);
                            return;
                        }
                        if (!Int32.TryParse(Item.Data, out int progress))
                        {
                            Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Leider ist der Busch verdorrt...", 3000);
                            return;
                        }
                        if (player.HasData("block.action-drugs")) return;
                        if (player.HasData("field.plant"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Sie sind bereits auf einer der Plantagen, wählen Sie einen anderen Ort!", 3000);
                            return;
                        }

                        World.Drugs.DrugsHandler.CreatePlant(player, progress);
                        break;
                    case ItemId.Pot: return;
                    case ItemId.DrugPlant: return;
                    case ItemId.WaterCan:
                        ...
                        if (!player.HasData("field.plant"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Du musst dich neben der Pflanze befinden", 3000);
                            return;
                        }

                        World.Drugs.DrugsHandler.WateringPlant(player);
                        return;
                    case ItemId.DrugSeed:
                        if (player.HasData("field.plant"))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Sie sind bereits auf einer der Plantagen, wählen Sie einen anderen Ort!", 3000);
                            return;
                        ...
                        int pots = getCountToLacationItem($"char_{characterData.UUID}", "inventory", ItemId.Pot);
                        if (pots < 1)
                        {
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, "Du hast keinen Topf um deine Samen zu Pflanzen", 3000);
                            return;
                        }

                        Remove(player, $"char_{characterData.UUID}", "inventory", ItemId.Pot);
                        World.Drugs.DrugsHandler.CreatePlant(player, 0);
                        break;
                    ...
                    case ItemId.eCola:
                        if (DateTime.Now > sessionData.TimingsData.NextEat)
                        {
                            ...
                            sessionData.TimingsData.NextEat = DateTime.Now.AddSeconds(5);
                            Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.Drink) + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
                    ...
                    case ItemId.Oil:
                    case ItemId.Diesel:
                    case ItemId.Kerosene:
                    case ItemId.GasCan:
                        if (!player.IsInVehicle)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustInCar), 6000);
                            ItemsClose(player, true);
                            return;
                        }
                        ...
                        if (vehicleLocalData != null)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.FullFuel), 6000);
                                ItemsClose(player, true);
                                return;
                            }
                            fuel += 15;
                    ...
                    case ItemId.HealthKit:
                        if (DateTime.Now > sessionData.TimingsData.NextMedKit)
                        {
                            ...
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouFullHP), 6000);
                                return;
                            }
                            player.Health = 100;
                            sessionData.TimingsData.NextMedKit = DateTime.Now.AddMinutes(5);
                            Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.used) + (characterData.Gender ? "" : "а") + LangFunc.GetText(LangType.De, DataName.healthkity));
                            Main.OnAntiAnim(player);
                        ...
                        else
                        {
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AptekCooldown, g.Minute, g.Second), 6000);
                            return;
                        }
                    ...
                    case ItemId.Bint:
                         if (DateTime.Now > sessionData.TimingsData.NextMedKit)
                         {
                            ...
                            Commands.RPChat("sme", player, LangFunc.GetText(LangType.De, DataName.used) + (characterData.Gender ? "" : "а") + LangFunc.GetText(LangType.De, DataName.bint));
                            Main.OnAntiAnim(player);
                            Sounds.PlayPlayer3d(player, "inventory/medkit");
                            Trigger.ClientEvent(player, "blockMove", true);
                        ...
                        else
                        {
                            ...
                            if (ticks <= 0) return;
                            DateTime g = new DateTime(ticks);
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BintCooldown, g.Minute, g.Second), 6000);
                            return;
                        }
                        break;
                    case ItemId.HotDog:
                    ...
                    case ItemId.ArmyLockpick:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustBeInArmyTruck), 6000);
                            return;
                        }
                        var vehicle = (ExtVehicle) player.Vehicle;
                        if (VehicleStreaming.GetEngineState(vehicle))
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarAlreadyOn), 6000);
                            return;
                        }
                        int lucky = new Random().Next(0, 5);
                        if (lucky == 5) Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ErrorCarOn), 6000);
                        else
                        {
                            Sounds.PlayPlayer3d(player, "inventory/keys");
                            VehicleStreaming.SetEngineState(vehicle, true);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CarOn), 6000);
                        }
                        break;
                    case ItemId.Pizza:
                        if (DateTime.Now > sessionData.TimingsData.NextEat)
                    ...
                    case ItemId.BagWithMoney:
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucWearing, ItemInfo.Name), 6000);
                        return;
                    case ItemId.CarCoupon:
                        int vehiclesCount = VehicleManager.GetVehiclesCarCountToPlayer(player.Name);
                        if (vehiclesCount >= GarageManager.MaxGarageCars)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MaxcarsCoupon), 6000);
                            return;
                        }
                        var house = HouseManager.GetHouse(player, true);
                        if (house != null)
                        ...
                        VehicleManager.Create(player, Item.Data, new Color(225, 225, 225), new Color(225, 225, 225), Text: LangFunc.GetText(LangType.De, DataName.CouponActivate, Item.Data), Logs: $"CarCoupon({Item.Data}");
                        break;
                    case ItemId.Note:
                    ...
                    case ItemId.Vape:
                        ...
                        if (value <= 0)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VapeBroken), 6000);
                    ...
                    case ItemId.SimCard:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Du kannst eine Sim-Karte nur alle 5 Minuten wechseln", 3000);
                            return;
                        }
                    ...
                    default:
                        if (!success)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantDoThisNowv2), 6000);
                            return;
                        }
                        break;
                }
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouUsed, Name), 6000);
                GameLog.Items($"usedItem({Item.SqlId})", $"char_{characterData.UUID}", Convert.ToInt32(Item.ItemId), 1, Item.Data);
        ...
        public static void UseSmoke(ExtPlayer player, ItemId ItemId = ItemId.Vape)
        {
            try
            {
                ...
                Main.OnAntiAnim(player);
                Commands.RPChat("sme", player, $"benutzt" + (characterData.Gender ? "" : "а") + $" {name}");
        ...
        public static void UseBong(ExtPlayer player, float scale = 0.5f)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NeedNarcoToUse), 6000);
                    return;
                }

                if (DateTime.Now < sessionData.TimingsData.NextDrugs)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BongTooMany), 6000);
                    return;
                }
                ...
                {
                    case 0:
                        Commands.RPChat("sme", player, $"raucht" + (characterData.Gender ? "" : "а") + " Bong");
                        break;
                    case 1:
                        Commands.RPChat("sme", player, $"raucht" + (characterData.Gender ? "" : "а") + " Bong");
                        break;
            ...
            try
            {
                ...
                switch (ItemId)
                {
                    ...
                    case ItemId.Rose:
                        ...
                        {
                            Commands.RPChat("sme", player, $"holt" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
        ...
        public static void NoteCreate(ExtPlayer player, int type, int ItemId, string nameValue, string textValue)
        {
            try
            {
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucSaveLetter), 6000);
                        ...
                        if (sessionData.LastCoverState == true)
                        {
                            ...
                            if (characterData.IsAlive && !player.IsInCover)
                            {
                                ...
                                if (!characterData.Achievements[21])
                                {
                                    ...
                                    Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Ukrytiefivehp), 5000);
                                }
                                return;
                            }
                        }
        ...
        public static bool ItemsDrop(ExtPlayer player, InventoryItemData Item, bool me = false, float posZ = -1f)
        {
            try
            {
                ...
                if (me)
                {
                    ...
                    xrnd = rnd.NextDouble();
                    yrnd = rnd.NextDouble();
                    Commands.RPChat("sme", player, $"schmeißt" + (characterData.Gender ? "" : "а") + $" {itemInfo.Name}");
        ...
        public static void ItemsDropToEditor(ExtPlayer player, string arrayName, int index, float posX, float posY, float posZ, float rotX, float rotY, float rotZ)
        {
            try
            {
                ...
                sessionData.TimingsData.NextDropItem = DateTime.Now.AddMilliseconds(150);
                ItemsInfo ItemInfo = ItemsInfo[Item.ItemId];
                Commands.RPChat("sme", player, $"stellt" + (characterData.Gender ? "" : "а") + $" {ItemInfo.Name}");
                ...
                if (FireworkTypeData.ContainsKey (Item.ItemId))
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.fireworkstand), 7000);
        ...
        public static void StartTrade(ExtPlayer player, ExtPlayer target)
        {
            try
            {
                ...
                {
                    Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantTrade, player.Value), 6000);
                    return;
                }
                var targetSessionData = target.GetSessionData();
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantTrade, player.Value), 6000);
                    return;
                }
        ...
        public static void ItemsTrade(ExtPlayer player, int status)
        {
            try
            {
                ...
                if (status == 1 && targetSessionData.ItemsTrade.Status == 1)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NobodyVibral, target.Name), 6000);
                        return;
                    }
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetMestaTrade, target.Name), 6000);
                        return;
                    }
                    else if (tCount > (InventoryMaxSlots["inventory"] - myInvCount))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouNetMestaTrade, target.Name), 6000);
                        return;
                    }
                }
                if (status == 2)
        ...
        public static void ConfirmTrade(ExtPlayer player)
        {
            try
            {
                ...
                if (!target.IsCharacterData())
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Handel abgebrochen", 3000);
                    ItemsClose(player, true);
                    return;
                }
                var targetSessionData = target.GetSessionData();
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TradeCancelled), 6000);
                    ItemsClose(player, true);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoMoney), 6000);
                    Notify.Send(target, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DoesntHaveMoney, player.Name), 6000);
                    ItemsClose(player, true);
                    return;
                }
                else if (UpdateData.CanIChange(target, targetSessionData.ItemsTrade.Money) != 255)
                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DoesntHaveMoney, target.Name), 6000);
                    ItemsClose(target, true);
                    return;
                }
                /*else if (Main.ServerNumber != 0 && (characterData.AdminLVL >= 1 && characterData.AdminLVL <= 6))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AdminTransferRestricted), 6000);
                    return;
                }
                ...
                if (TradeData.Money > 0)
                {
                    ...
                    Commands.RPChat("sme", player, "handelt" + (characterData.Gender ? "" : "а") + $" {Wallet.Format(TradeData.Money)}$ " + "{name}", target);
                ...
                Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.DealSuccess), 6000);
                ...
                if (TradeData.Money > 0)
                {
                    ...
                    Commands.RPChat("sme", target, "handelt" + (targetCharacterData.Gender ? "" : "а") + $" {Wallet.Format(TradeData.Money)}$ " + "{name}", player);
        ...
        public static void PlayerStats(ExtPlayer player, ExtPlayer target = null)
        {
            try
            {
                ...
                charData.Add(targetCharacterData.WeddingName.Length > 5 ? targetCharacterData.WeddingName : "Ledig");//14
        ...
        public static void ItemBuy(ExtPlayer player, string ArrayName, int Index, int Value)
        {
            ...
            if (locationName != null)
            {
                ...
                //Notify.Send(target, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouItemBuyed, ItemsInfo[Item.ItemId].Name, price), 10000);
                
                Players.Phone.Messages.Repository.AddSystemMessage(target, (int)DefaultNumber.Tent, LangFunc.GetText(LangType.De, DataName.YouItemBuyed, ItemsInfo[Item.ItemId].Name, price), DateTime.Now);  
        ...
        public static void ItemStack(ExtPlayer player, string ArrayName, int Index, int Id, int Value, bool isBuy = false)
        {
            try
            {
                ...
                if (Item.ItemId == ItemId.Coal || Item.ItemId == ItemId.Iron || Item.ItemId == ItemId.Gold || Item.ItemId == ItemId.Sulfur || Item.ItemId == ItemId.Emerald || Item.ItemId == ItemId.Ruby)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantMoveItem), 6000);
                        return;
                    }
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SomethingWrong), 6000);
                    return;
                }
                if (Id == 0)
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SuccSplit, itemInfo.Name), 6000);
                }
                else if (Id == 1)
                {
                    /*if (DateTime.Now < sessionData.TimingsData.NextDropItem)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Drop1secOnly), 6000);
                        return;
                    }
                    else */if (player.IsInVehicle)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoDropFromCar), 6000);
                        return;
                    }
                    if (!ItemsDrop(player, new InventoryItemData(0, Item.ItemId, Value, Item.Data))) return;
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SuccDrop, itemInfo.Name), 6000);
                }
                else
                {
                    locationName = null;
                    ...
                    if (Location == "tent")
                    {
                        ...
                        Trigger.ClientEvent(player, "openInput", LangFunc.GetText(LangType.De, DataName.ItemSell), LangFunc.GetText(LangType.De, DataName.ItemSellInput), 8, "sell_tent");
                        return;
                    }
                    ...
                    if (Value == Item.Count)
                    {
                        ...
                        SetItemData(player, ArrayName, Index, new InventoryItemData(), true);
                        if (isBuy) EventSys.SendCoolMsg(player,"Markt", "Gegenstand kauf", LangFunc.GetText(LangType.De, DataName.YouBuy, itemInfo.Name, itemPrice), "", 5000);
                            //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouBuy, itemInfo.Name), 6000);
                        else if (ArrayName != "other" && ArrayName != "backpack" && ArrayName != "trade") Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouSuccGive, itemInfo.Name), 6000);
                        else Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouGetItem, itemInfo.Name), 6000);
                        return;
                    }
        ...
        public static void SappeGame(ExtPlayer player, int amount)
        {
            try
            {
                ...
                UpdateData.RedBucks(player, -amount, msg: "Min Game «Sapper»");
        ...
        public static void SappeEnd(ExtPlayer player, int type)
        {
            ...
            try
            {
                ...
                if (type != -2)
                {
                    if (type <= 0 || type > SappeCoef.Count) UpdateData.RedBucks(player, sessionData.SappeData, msg: LangFunc.GetText(LangType.De, DataName.SapperGame));
                    else 
                    {
                        int winrb = Convert.ToInt32(sessionData.SappeData * SappeCoef[type - 1]);
                        UpdateData.RedBucks(player, winrb, msg: LangFunc.GetText(LangType.De, DataName.SapperGameWin));
                        Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, LangFunc.GetText(LangType.De, DataName.SappWin, winrb), DateTime.Now);
                    }
                }
        ...
        public static void Sappe_PlayerDisconnected(ExtPlayer player)
        {
            try
            {
                ...
                {
                    UpdateData.RedBucks(player, sessionData.SappeData, msg: LangFunc.GetText(LangType.De, DataName.SapperGameGetBack));
                    sessionData.SappeData = -1;
                }
            }
            catch (Exception e)
