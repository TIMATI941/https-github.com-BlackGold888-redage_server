    ...
    class Donate : Script
    {
        ...
        public static void UpdatePrice(ExtPlayer player, string category, int index, int price)
        {
            try
            {
                ...
                UpdateData.RedBucks(player, price, LangFunc.GetText(LangType.De, DataName.DonShopBought));
            }
            catch (Exception e)
            {
                Log.Write($"GetPrice Exception: {e.ToString()}");
...

                {
                    ...
                    case 0:// Подписка
...

                        {
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SubAlreadyBuy), 6000);
                        ...
                        UpdateData.RedBucks(player, -price, LangFunc.GetText(LangType.De, DataName.SubBought));

                        RewardSubscribe(player);

                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouBoughtSub), 6000);
                    ...
                    case 1:// Type.SilverVIP:
...

                        {
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyBoughtVIP), 6000);
                        ...
                        UpdateData.RedBucks(player, -DonatesPremiumData[1].Price, msg: LangFunc.GetText(LangType.De, DataName.BoughtSilverVIP));
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuySilverVIP), 6000);
                    ...
                    case 2:// Type.GoldVIP:
                        ...
                        UpdateData.RedBucks(player, -DonatesPremiumData[2].Price, msg: LangFunc.GetText(LangType.De, DataName.BoughtGoldVIP));
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuyGoldVIP), 6000);
                    ...
                    case 3:// Type.PlatinumVIP:
                        ...
                        UpdateData.RedBucks(player, -DonatesPremiumData[3].Price, msg: LangFunc.GetText(LangType.De, DataName.BoughtPlatinumVIP));
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuyPlatinumVIP), 6000);
                    ...
                    case 4:// Type.DiamondVIP:
                        ...
                        UpdateData.RedBucks(player, -DonatesPremiumData[4].Price, LangFunc.GetText(LangType.De, DataName.BoughtDiamondVIP));
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuyDiamondVIP), 6000);
        ...
        public void RewardSubscribe(ExtPlayer player)
        {
...

            {
...

                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSubscription), 6000);
...

                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Only24hPrize), 6000);
                ...
                UpdateData.RedBucks(player, donateCash, msg: LangFunc.GetText(LangType.De, DataName.SubBonus));
...

                {
                    ...
                    case 0: //Type.BagOnFoot:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NaHodDonPack, Main.DonatePack.PriceRB[0]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.NaHodDonPack, Main.DonatePack.PriceRB[0]));
                    ...
                    case 1: //Type.BagStart:

                        {
...

                            {
                                ...
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoSpaceForAccessory), 6000);
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.StarterDonPack, Main.DonatePack.PriceRB[1]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.StarterDonPack, Main.DonatePack.PriceRB[1]));
                    ...
                    case 2: //Type.BagAdvanced:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PromotedDonPack, Main.DonatePack.PriceRB[2]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.PromotedDonPack, Main.DonatePack.PriceRB[2]));
                    ...
                    case 3: //Type.BagCharged:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LoadedDonPack, Main.DonatePack.PriceRB[3]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.LoadedDonPack, Main.DonatePack.PriceRB[3]));
                    ...
                    case 4: //Type.BagGoodStart:

                        {
...

                            {
                                ...
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MaxCarsDonPack), 6000);
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GoodStartDonPack, Main.DonatePack.PriceRB[4]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.GoodStartDonPack, Main.DonatePack.PriceRB[4]));
                    ...
                    case 5: //Type.BagBigPlans:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BigPlansDonPack, Main.DonatePack.PriceRB[5]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.BigPlansDonPack, Main.DonatePack.PriceRB[5]));
                    ...
                    case 6: //Type.BagFatCheck:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BigCheckDonPack, Main.DonatePack.PriceRB[6]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.BigCheckDonPack, Main.DonatePack.PriceRB[6]));
                    ...
                    case 7: //Type.BagExcellentStart:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GreatDonPack, Main.DonatePack.PriceRB[7]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.GreatDonPack, Main.DonatePack.PriceRB[7]));
                    ...
                    case 8: //Type.BagLegend:

                        {
                           ...
                           characterData.Licenses[4] = true; // helicopter
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.LegendPackDon, Main.DonatePack.PriceRB[8]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.LegendPackDon, Main.DonatePack.PriceRB[8]));
                    ...
                    case 9: //Type.BagPerfectStart:

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuyDonateGreatStart, Main.DonatePack.PriceRB[9]), 6000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, LangFunc.GetText(LangType.De, DataName.BuyDonateGreatStart, Main.DonatePack.PriceRB[9]));
                    ...
                    case 10: //Type.BagDaddy: +

                        {
                            ...
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Sie haben das Paket 'Daddy' erfolgreich gekauft!", 3000);

                            GameLog.AccountLog(accountData.Login, accountData.HWID, accountData.IP, accountData.SocialClub, $"Paket 'Daddy' für (-{Main.DonatePack.GiveMoney[10]} Rockford-Coins) erfolgreich gekauft");
...

                {
                    ...
                    case 1:
...

                        {
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoCreatorDemorgan), 5000);

                            return;

                        }

                        UpdateData.RedBucks(player, -1000, msg:LangFunc.GetText(LangType.De, DataName.SendCreator));
                    ...
                    case 0:
...

                        {
...

                            {
                                ...
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoName), 6000);
...

                            {
                                ...
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoFamily), 6000);
...

                        {
                            ...
                            Admin.AdminsLog(1, LangFunc.GetText(LangType.De, DataName.ChangeNameAdmins, player.Name, player.Value, name), 1);

                            UpdateData.RedBucks(player, -800, msg: LangFunc.GetText(LangType.De, DataName.ChangeName));
                    ...
                    case 2:
...

                        {
                            ...
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Nowarn), 6000);
                        ...
                        UpdateData.RedBucks(player, -1000, msg: LangFunc.GetText(LangType.De, DataName.SnyatieWarn));

                        characterData.Warns -= 1;

                        //Repository.PlayerStats(player);

                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucUnwarn), 6000);
        ...
        public void Change(ExtPlayer player, int amount)
        {
...

            {
...

                {
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Amount1OrMore), 6000);
                ...
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, LangFunc.GetText(LangType.De, DataName.SucConvertRbToMoney, amount, totalamount), DateTime.Now);
                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SucConvertRbToMoney, amount, totalamount), 6000);

                UpdateData.RedBucks(player, -amount, msg: LangFunc.GetText(LangType.De, DataName.ConvertRbTo, totalamount));
        ...
        public void BuyChar(ExtPlayer player, int slotId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Already3Slot), 6000);
                    return;
                }
                ...
                UpdateData.RedBucks(player, -1000, msg: LangFunc.GetText(LangType.De, DataName.Buy3Slot));
...

                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlatinumVIP30d), 6000);
...

                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlattoVip7d), 5000);
        ...
        public void BuyClothes(ExtPlayer player, int id)
        {
...

            {
                ...
                UpdateData.RedBucks(player, -cData.PriceRB, msg: LangFunc.GetText(LangType.De, DataName.LKLogBuyClothes, id));

                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PremiumClothesBuy), 6000);
        ...
        {
            new List<object>{500000, "$", "Gewöhnlich"},//0
            new List<object>{5000, "RB", "Selten"},//1
            new List<object>{7000, "RB", "Einzigartig"},//2
            new List<object>{10000, "RB", "Einzigartig"},//3
            new List<object>{15000, "RB", "Luxus"},//4
            new List<object>{35000, "RB", "Luxus"}//5
            
        };
        public static int GetVehicleNumberPrice(string number)
        {
            object[] test = {30000, "RB", "Luxus"};
        ...
        public void BuyVehNumber(ExtPlayer player, string number)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Kennzeichen existiert bereits", 3000);
                return;
            }
            ...
            if (numberData[1].ToString() == "RC" && accountData.RedBucks < money) //RB
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetRB), 6000);
                return;
            }
            ...
            {
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, LangFunc.GetText(LangType.De, DataName.DonNumBuy, number, money), DateTime.Now);
                UpdateData.RedBucks(player, -money, LangFunc.GetText(LangType.De, DataName.DonNumBuy, number, money));
            }
            //client.donate.close
        ...
        {
            new List<object>{55000, "RB", "Luxus"},//0
            new List<object>{45000, "RB", "Luxus"},//1
            new List<object>{35000, "RB", "Luxus"},//2
            new List<object>{25000, "RB", "Selten"},//3
            new List<object>{20000, "RB", "Selten"},//4
            new List<object>{15000, "RB", "Einzigartig"},//5
            new List<object>{10000, "RB", "Einzigartig"},//6
            new List<object>{7500, "RB", "Einzigartig"},//7
            new List<object>{5000, "RB", "Gewöhnlich"},//8
        ...
        public void BuyVehNumber(ExtPlayer player, int sim)
        {
            ...
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Falsches Format", 3000);
                return;
            }
            ...
            Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, LangFunc.GetText(LangType.De, DataName.DonSimBuy, sim, money), DateTime.Now);
            UpdateData.RedBucks(player, -money, LangFunc.GetText(LangType.De, DataName.DonSimBuy, sim, money));
            //client.donate.close
            Trigger.ClientEvent(player, "client.donate.close");
        }
