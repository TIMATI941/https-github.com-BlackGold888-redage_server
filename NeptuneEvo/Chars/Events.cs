    ...
    class Events : Script
    {
        ...
        public void TryTrade(ExtPlayer player, ExtPlayer target, string type)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouHaveActiveOrders), 6000);
                    return;
                }
                ...
                if (type == "vehicle")
                {
                    ...
                    if (vehiclesCount == 0)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PersonHaveNoCar), 6000);
                        return;
                    }
                    ...
                    //Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWantTradeVeh), 6000);
                    //Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PersonWantTradeVeh, player.Value), 6000);
                    EventSys.SendCoolMsg(player,"Angebot", "Handel", $"{LangFunc.GetText(LangType.De, DataName.YouWantTradeVeh)}", "", 10000);
                    EventSys.SendCoolMsg(target,"Angebot", "Handel", $"{LangFunc.GetText(LangType.De, DataName.PersonWantTradeVeh, player.Value)}", "", 10000);
                }
                else if (type == "house")
                {
                    ...
                    targetSessionData.RequestData.From = player;
                    targetSessionData.RequestData.Time = DateTime.Now.AddSeconds(10);
                    //Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWantTradeHouse), 6000);
                    //Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PersonWantTradeHouse), 6000);
                    EventSys.SendCoolMsg(player,"Angebot", "Handel", $"{LangFunc.GetText(LangType.De, DataName.YouWantTradeHouse)}", "", 10000);
                    EventSys.SendCoolMsg(target,"Angebot", "Handel", $"{LangFunc.GetText(LangType.De, DataName.PersonWantTradeHouse)}", "", 10000);
                }
                else if (type == "business")
                {
                    ...
                    targetSessionData.RequestData.From = player;
                    targetSessionData.RequestData.Time = DateTime.Now.AddSeconds(10);
                    //Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouWantTradeBiz), 6000);
                    //Notify.Send(target, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PersonWantTradeBiz), 6000);
                    EventSys.SendCoolMsg(player,"Angebot", "Handel", $"{LangFunc.GetText(LangType.De, DataName.YouWantTradeBiz)}", "", 10000);
                    EventSys.SendCoolMsg(target,"Angebot", "Handel", $"{LangFunc.GetText(LangType.De, DataName.PersonWantTradeBiz)}", "", 10000);
                }
            }
            catch (Exception e)
            {
        ...
        public void InventoryDrop(ExtPlayer player, string ArrayName, int Index, float posZ)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CooldownItemDrop), 6000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouCantDrop), 6000);
                    return;
                }
        ...
        public void InventoryBuy(ExtPlayer player, string ArrayName, int Index, int Value)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "openDialog", "buy_tent", LangFunc.GetText(LangType.De, DataName.DialogBuyFromTent, Repository.ItemsInfo[Item.ItemId].Name, MoneySystem.Wallet.Format(Item.Price )));
