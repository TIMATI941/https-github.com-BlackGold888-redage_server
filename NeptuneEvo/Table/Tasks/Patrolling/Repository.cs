    ...
    public class Repository
    {
        ...
        public void InPatrolling(ExtPlayer player, int index)
        {
            try
            {
                ...
                if (isEnd)
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Sie haben Ihre Patrouille abgeschlossen.", 7000);
                }
                else
                {
                    index += 1;
        ...
        public static bool CreatePatrolling(ExtPlayer player, bool isAir)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Aufgabe angenommen. Markierung wurde gesetzt", 7000);
                return true;
