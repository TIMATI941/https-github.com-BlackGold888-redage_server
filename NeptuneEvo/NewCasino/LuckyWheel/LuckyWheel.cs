...
namespace NeptuneEvo.NewCasino
{
    class LuckyWheel
    {
        ...
        private static Dictionary<string, string> Names = new Dictionary<string, string>
        {
            ...
            ["veh_zorrusso"] = "Fahrzeug zorrusso",
            ["veh_xa21"] = "Fahrzeug xa21",
            ["veh_cheburek"] = "Fahrzeug cheburek",
            ["veh_btype"] = "Автомобиль btype",
            ["veh_stafford"] = "Fahrzeug stafford",

            ["clothes_neon_shoes"] = "Neon Schuhe",
            ["clothes_mask_boll"] = "Stiermaske",
            ["clothes_cosmo_legs"] = "Kosmische Hose"
        };
