...
namespace NeptuneEvo.Businesses
{
    public class Repository
    {
        ...
        public static void GetHistory(ExtPlayer player)
        {
            ...
            {
                1, 0, "2021-12-22 18:23:57", 1018322, "Brecheisen", 45
            });
            historyList.Add(new List<object>
            {
                2, 0, "2021-12-22 18:23:57", 1018322, "Bier", 45
            });
            historyList.Add(new List<object>
            {
            ...
            historyList.Add(new List<object>
            {
                4, 0, "2021-12-21 18:23:57", 1018322, "Rund", 45
            });
            historyList.Add(new List<object>
            {
                5, 0, "2021-12-22 18:23:57", 1018321, "Ratte", 45
            });
