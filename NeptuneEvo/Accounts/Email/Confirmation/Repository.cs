    ...
    public class Repository
    {
        ...
        public static void VerificationConfirm(string hash, string ga)
        {
            ...
            if (emailVerification != null)
            {
                ...
                //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Почта подтверждена успешно. Приз отправлен на склад. (M->GPS - > Lager)", 5000);
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, $"Ihr Konto wurde erfolgreich bestätigt. Ihre Belohnung wurde ins Lager geschickt. (M->GPS - > Lager)", DateTime.Now);
