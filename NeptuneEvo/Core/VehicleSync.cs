...
namespace NeptuneEvo.Core
{
    public class VehicleStreaming : Script
    {
        ...
        public void OnResourceStart()
        {
            ...
            NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(501.410, -1336.284, 29.0), 5F, 0.4F, 0, new Color(255, 255, 255));
        }
        ...
        public static void OnRepair(ExtPlayer player)
        {
            ...
            Trigger.ClientEvent(player, "openDialog", "RepairMyVeh", LangFunc.GetText(LangType.De, DataName.RepairSelf));
            return;
        }*/
    }
}
