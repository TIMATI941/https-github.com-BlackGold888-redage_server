...
namespace NeptuneEvo.Core
{
    class BusinessManager : Script
    {
        ...
        public static void UpdateBusProd(Business data)
        {
            try
            {
                ...
                foreach (Product prod in data.Products)
                {
                    ...
                    if (data.Type == 0 && prod.Name == "Lottoschein")
                    {
                        if (prod.Price != 500)
                        {
                    ...
                    case 0:
                        foreach (KeyValuePair<string, BusProductData> busProductData in BusProductsData)
                        {
                            ...
                            if (product == null)
                            {
                                ...
                                if (busProductData.Key == "Lottoschein") data.Products.Add(new Product(500, 0, 0, busProductData.Key, false));
        ...
        public static void Init()
        {
            try
            {
                ...
                PedSystem.Repository.CreateQuest("a_m_y_hipster_01", new Vector3(-1126.9141, -1440.1637, 4.108331 + 1.12), -63.85f, title: "~y~NPC~w~ Vladimir", colShapeEnums: ColShapeEnums.PremiumShop);
                ...
                switch (type)
                {
                    case 0:
                        foreach (KeyValuePair<string, BusProductData> busProductData in BusProductsData)
                        {
                            if (busProductData.Value.Type != BusProductToType.Market) continue;
                            Product product;
                            if (busProductData.Key == "Lottoschein") product = new Product(500, 0, 0, busProductData.Key, false);
                            else product = new Product(busProductData.Value.Price, 0, 1, busProductData.Key, false);
                            _ProductsList.Add(product);
                        }
                        break;
                    case 1:
                        _ProductsList.Add(new Product(BusProductsData["Benzin"].Price, 0, 0, "Benzin", false));
                        break;
                    case 2:
                        foreach (string name in CarsNames[0])
                        {
                    ...
                    case 6:
                        ...
                        _ProductsList.Add(new Product(BusProductsData["Munition"].Price, 0, 5, "Munition", false));
                        _ProductsList.Add(new Product(BusProductsData["Modifikation"].Price, 0, 5, "Modifikation", false));
                        break;
                    case 7:
                        _ProductsList.Add(new Product(50, 200, 10, "Kleidung", false));
                        break;
                    case 8:
                        foreach (KeyValuePair<string, BusProductData> busProductData in BusProductsData)
                        {
                        ...
                        break;
                    case 9:
                        _ProductsList.Add(new Product(80, 100, 0, "Verbrauchsmaterial", false));
                        _ProductsList.Add(new Product(100, 0, 0, "Tätowierungen", false));
                        break;
                    case 10:
                        _ProductsList.Add(new Product(80, 100, 0, "Verbrauchsmaterial", false));
                        _ProductsList.Add(new Product(100, 0, 0, "Perücken", false));
                        break;
                    case 11:
                        _ProductsList.Add(new Product(100, 50, 0, "Masken", false));
                        break;
                    case 12:
                        _ProductsList.Add(new Product(100, 1000, 0, "Ersatzteile", false));
                        break;
                    case 13:
                        _ProductsList.Add(new Product(200, 200, 0, "Waschmittel zum Waschen", false));
                        break;
                    case 14:
                        _ProductsList.Add(new Product(45000, 20, 0, "Tiernahrung", false));
                        break;
                }
        ...
        public static void OnBusinessAction(ExtPlayer player, int ID)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizNotWork, BusinessTypeNames[biz.Type]), 6000);
                    return;
                }
                switch (biz.Type)
                {
                    ...
                    case 7:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MustEndWorkDay), 6000);
                            return;
                        }
                        sessionData.TempBizID = biz.ID;
                    ...
                    case 13:
                        ...
                        Trigger.ClientEvent(player, "openDialog", "CARWASH_PAY", LangFunc.GetText(LangType.De, DataName.CarWashWant, biz.Products[0].Price));
                        return;
                    case 14:
                        if (sessionData.Follower != null)
                        {
        ...
        public static void RemoteEvent_petshopBuy(ExtPlayer player, string petName)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.HomeNotForPets), 6000);
                    return;
                }
                ...
                if (!takeProd(biz.ID, 1, "Tiernahrung", price))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoPets), 6000);
                    return;
                }
                Wallet.Change(player, -price);
                biz.BuyItemBusiness(characterData.UUID, "Tiernahrung", price);
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NewPet, petName), 6000);
            }
            catch (Exception e)
            {
                ...
                if (player.IsInVehicle)
                {
                    if (player.VehicleSeat == (int)VehicleSeat.Driver)
                    {
                        ...
                        if (VehicleStreaming.GetVehicleDirt(vehicle) >= 0.01f)
                        {
                            ...
                            if (!takeProd(biz.ID, 1, "Waschmittel zum Waschen", price)) 
                            {
                                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetTovaraNaSkladeBiza), 6000);
                                return;
                            }
                            GameLog.Money($"player({characterData.UUID})", $"biz({biz.ID})", price, "carwash");
                            MoneySystem.Wallet.Change(player, -price);
                            biz.BuyItemBusiness(characterData.UUID, "Waschmittel zum Waschen", price);
                            VehicleStreaming.SetVehicleDirt(vehicle, 0.0f);
                            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WashedCar), 5000);
                        ...
                        else Notify.Send(player, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NotDirtyCar), 5000);
                    }
                    else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.OnlyDriverWashCar), 5000);
                }
            }
            catch (Exception e)
            {
        ...
        public static void StartTuning(ExtPlayer player)
        {
            try
            {
                ...
                if (vehicleLocalData.Access == VehicleAccess.Personal)
                {
                    if (vehicle.Class == 13)
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VeloCantBeTuned), 6000);
                        return;
                    }
                    if (VehicleModel.AirAutoRoom.isAirCar(vehicle.Model))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Luftverkehr lässt sich nicht tunen", 3000);
                        return;
                    }
        ...
        public static void RemoteEvent_buyTuning(ExtPlayer player, string category, int index, int otherIndex, int r, int g, int b)
        {
            try
            {
                ...
                if (price == 0)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoDetailsError), 6000);
                        return;
                    }
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoDetails), 6000);
                    return;
                }
                
                if (SetCustomization(player, category, index, otherIndex, r, g, b, price, $"biz({biz.ID})"))
                    biz.BuyItemBusiness(characterData.UUID, "Ersatzteile", price);
        ...
        private static bool SetCustomization(ExtPlayer player, string category, int index, int otherIndex, int r, int g, int b, int price, string textLogs = "ExoticAutoRoom")
        {
            ...
            Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuyTunNotify, Wallet.Format(price)), 6000);
        ...
        public static void ClothesBuy(ExtPlayer player, string name, int id, int texture, bool isDonate = false)
        {
            try
            {
                ...
                if (price <= 0)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantBuyThis), 6000);
                    return;
                }
                ...
                if (!isDonate)
                {
                    if (dictionary == ClothesComponent.Masks && !takeProd(biz.ID, (price >= 15000 ? 6 : 1), "Masken", price))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetTovaraNaSkladeBiza), 6000);
                        return;
                    }
                    else if (!takeProd(biz.ID, amount, "Kleidung", price))
                    { 
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetTovaraNaSkladeBiza), 6000);
                        return;
                    }
                ...
                if (!isDonate)
                {
                    ...
                    Wallet.Change(player, -price);
                    biz.BuyItemBusiness(characterData.UUID, "Kleidung", price);
                }
                else
                {
                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.RedAge, LangFunc.GetText(LangType.De, DataName.PremClothB, price), DateTime.Now);
                    UpdateData.RedBucks(player, -price, msg: LangFunc.GetText(LangType.De, DataName.PremClothB, price));
                }
                
                EventSys.SendCoolMsg(player,"Kauf", "Kleidung kauf", $"{LangFunc.GetText(LangType.De, DataName.BuyNewClothes)}", "", 6000);
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BuyNewClothesView, price), 2000);
        ...
        public static void BarberBuy(ExtPlayer player, string name, int id, int color, int colorHighlight, float opacity, bool isDonate = false)
        {
            try
            {
                ...
                if (!isDonate)
                {
                    if (!takeProd(biz.ID, 1, "Verbrauchsmaterial", price))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetTovaraNaSkladeBiza), 6000);
                        return;
                    }
                    ...
                    Wallet.Change(player, -price);
                    biz.BuyItemBusiness(characterData.UUID, "Verbrauchsmaterial", price);
                }
                else
                {
                    UpdateData.RedBucks(player, -price, msg: LangFunc.GetText(LangType.De, DataName.PremiumClothesBuy));
                }
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BarberBuy, price), 5000);
        ...
        public static void TattooBuy(ExtPlayer player, string name, int id, bool isDonate = false)
        {
            try
            {
                ...
                foreach (var t in customTattoos.Values)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ThisTattooIs), 6000);
                        return;
                    }
                }
                ...
                if (countTattoo >= 60)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MaxTattoo), 6000);
                    return;
                }
                ...
                if (!isDonate)
                {
                    ...
                    if (amount <= 0) amount = 1;
                    if (!takeProd(biz.ID, amount, "Verbrauchsmaterial", price))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NetTovaraNaSkladeBiza), 6000);
                        return;
                    }
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.TattooBuy, tattooData.Name, price), 8000);
        ...
        public static void RemoteEvent_buyClothes(Player player, string type, int variation, int texture, bool isDonate = false)
        {
            try
            {
                ...
                if (!isDonate) 
                {
                    if(type == "Mask" && !takeProd(biz.ID, (price >= 15000 ? 6 : 1), "Masken", price))
                    {
        ...
        public static void RemoteEvent_buyBarber(Player player, string id, int style, int color)
        {
            try
            {
                ...
                Product prod = biz.Products.FirstOrDefault(p => p.Name == "Perücken");
                ...
                if (!takeProd(biz.ID, 1, "Verbrauchsmaterial", totalprice))
                {
        ...
        [RemoteEvent("petrol")]
        public static void fillCar(ExtPlayer player, int lvl, int paytype)
        {
            try
            {
                var sessionData = player.GetSessionData();
                ...
                if (vehicleLocalData != null)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantZapravit), 6000);
                        return;
                    }
                    if (VehicleStreaming.GetEngineState(vehicle))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Zaglushite), 6000);
                        return;
                    }
                    ...
                    if (isGov)
                    {
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GosZapravit), 6000);
                            return;
                        }
                        if (vehicleLocalData.Access != VehicleAccess.Fraction || vehicleLocalData.Fraction != fractionData.Id)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.GosGosZapravit), 6000);
                            return;
                        }
                    ...
                    {
                        if (paytype == 0 && UpdateData.CanIChange(player, price, true) != 255)
                        {
                            return;
                        }
                        else if (paytype == 1 && MoneySystem.Bank.GetBalance(characterData.Bank) < price)
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Sie haben nicht genug Geld auf dem Bankkonto", 3000);
                            return;
                        }
                    }
                    if (!takeProd(biz.ID, lvl, "Benzin", price))
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ZapravkaIs, biz.Products[0].Lefts), 7000);
                        return;
                    }
                    biz.BuyItemBusiness(characterData.UUID, "Benzin", price);
                    if (isGov)
                    {
                        ...
                        //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ZapravkaGos), 6000);
                        Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Bank, LangFunc.GetText(LangType.De, DataName.ZapravkaGos), DateTime.Now); 
                    }
                    else
                    {
                        ...
                        {
                            MoneySystem.Bank.Change(characterData.Bank, -price);
                        }
                            //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.ZapravkaSuccess, price), 6000);
                            Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Bank, LangFunc.GetText(LangType.De, DataName.ZapravkaSuccess, price), DateTime.Now); 
                    ...
                    Commands.RPChat("sme", player, $"tankt" + (characterData.Gender ? "" : "а") + LangFunc.GetText(LangType.De, DataName.veh));
                }
            }
            catch (Exception e)
            {
        ...
        public static void buyBusinessCommand(ExtPlayer player)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NeedBeNearBiz), 6000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantGetMoreThanBiz, Group.GroupMaxBusinesses[accountData.VipLvl]), 6000);
                    return;
                }
                if (biz.IsAuction)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizAuc), 6000);
                    return;
                }

                if (Players.Phone.Auction.Repository.IsBet(characterData.UUID, AuctionType.Biz))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.YouBizAuc), 6000);
                    return;
                }
                if (biz.Owner.Equals(player.Name))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizYours), 6000);
                    return;
                }
                if (biz.IsOwner())
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizOtherPlayer), 6000);
                    return;
                }
                ...
                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizBuy, BusinessManager.BusinessTypeNames[biz.Type]), 6000);
                Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Bank, LangFunc.GetText(LangType.De, DataName.BizBuy, BusinessManager.BusinessTypeNames[biz.Type], biz.SellPrice), DateTime.Now);
        ...
        public static async void createBusinessCommand(ExtPlayer player, int govPrice, int type, double taxes)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NalogLimit), 6000);
                    return;
                }
                ...
                cmd.Parameters.AddWithValue("@val1", "Staat");
                ...
                NAPI.Task.Run(() => {
                    try
                    {
                        Business biz = new Business(lastBizID, "Staat", govPrice, type, products_list, pos, new Vector3(), bankID, -1, new List<Order>(), taxes);
                        biz.UpdateLabel();
                        ...
                        //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizCreated), 6000);
                    }
                    catch (Exception e)
                    {
        ...
        public static void createBusinessUnloadpoint(ExtPlayer player, int bizid)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PointUnloadBuy, bizid), 6000);
            }
            catch (Exception e)
            {
        ...
        public static void changeBizTax(ExtPlayer player, int id, double taxes)
        {
            try
            {
                ...
                if (biz != null)
                {
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NalogChasIzmenen, id, taxes * 100), 6000);
                    if (owner != null)
                    {
                        Notify.Send(owner, NotifyType.Alert, NotifyPosition.Center, LangFunc.GetText(LangType.De, DataName.NalogIzmenen, biz.Tax * 100, taxes * 100), 10000);
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.VladeletNotify, owner.Name, owner.Value), 5000);
                    }
                    biz.Tax = taxes;
                }
            }
        ...
        public static void deleteBusinessCommand(ExtPlayer player, int id)
        {
            try
            {
                ...
                if (biz == null)
                {
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizIdNotFound), 6000);
                    return;
                }
                ...
                MySQL.Query(cmd);
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizDeleted), 6000);
                if (biz.Type == 6)
                {
                    using MySqlCommand cmd1 = new MySqlCommand
                    {
        ...
        public static void sellBusinessCommand(ExtPlayer player, ExtPlayer target, int price)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizMaxPlayer), 6000);
                    return;
                }
                Business biz = BizList[characterData.BizIDs[0]];
                if (price < biz.SellPrice)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizCantSellPrice, biz.SellPrice), 6000);
                    return;
                }
                if (!biz.Owner.Equals(player.Name))
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizNotYour), 6000);
                    return;
                }
                ...
                Trigger.ClientEvent(target, "openDialog", "BUSINESS_BUY", LangFunc.GetText(LangType.De, DataName.YouWantSellBiz, player.Name, BusinessTypeNames[biz.Type], MoneySystem.Wallet.Format(price)));
                EventSys.SendCoolMsg(player,"Angebot", "Kauf", $"{LangFunc.GetText(LangType.De, DataName.BizWantSellToYou, target.Value, MoneySystem.Wallet.Format(price))}", "", 10000);
                //Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizWantSellToYou, target.Value, MoneySystem.Wallet.Format(price)), 6000);
            }
            catch (Exception e)
            {
        ...
        public static void acceptBuyBusiness(ExtPlayer player)
        {
            try
            {
                ...
                if (!targetCharacterData.BizIDs.Contains(biz.ID))
                {
                    sessionData.SellItemData = new SellItemData();
                    targetSessionData.SellItemData = new SellItemData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.BizNoBelongsTo), 6000);
                    return;
                }
                ...
                if (characterData.BizIDs.Count >= Group.GroupMaxBusinesses[accountData.VipLvl])
                {
                    sessionData.SellItemData = new SellItemData();
                    targetSessionData.SellItemData = new SellItemData();
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MaxBizAmount), 6000);
                    return;
                }
                ...
                Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, $"Du kaufst bei {target.Name.Replace('_', ' ')} {BusinessTypeNames[biz.Type]} für {MoneySystem.Wallet.Format(price)}$", 4500);
                Notify.Send(target, NotifyType.Info, NotifyPosition.BottomCenter, $"{player.Name.Replace('_', ' ')} hat bei dir {BusinessTypeNames[biz.Type]} für {MoneySystem.Wallet.Format(price)}$ gekauft", 4500);
        ...
        public static void OpenBizShopMenu(ExtPlayer player)
        {
            try
            {
                ...
                foreach (var p in biz.Products)
                {
                    ...
                    else if (p.Name == "Sim-Karte") jsonData.Add(new Fractions.Manager.FracMatsData(index, "Sim-Karte", "sm-icon-sim", $"{p.Price}$"));
                    else if (p.Name == "Lottoschein") jsonData.Add(new Fractions.Manager.FracMatsData(index, "Lottoschein", "sm-icon-lotary", $"{p.Price}$"));
                    index++;
                }
        ...
        public static void Event_ShopCallback(ExtPlayer player, int index, int paytype)
        {
            try
            {
                var sessionData = player.GetSessionData();
                ...
                if (paytype == 0 && UpdateData.CanIChange(player, prod.Price, true) != 255)
                {
                    return;
                }
                else if (paytype == 1 && MoneySystem.Bank.GetBalance(characterData.Bank) < prod.Price)
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Sie haben nicht genug Geld auf dem Bankkonto", 3000);
                    return;
                }
                ...
                if (prod.Name == "Sim-Karte")
                {
                    ...
                    Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Du hast eine Sim-Karte mit der Nummer: {number} gekauft. Diese findest du im Inventar", 6000);
                    //Chars.Repository.PlayerStats(player);
                    biz.BuyItemBusiness(characterData.UUID, "Sim-Karte", prod.Price);
                    if (paytype == 0)
                    {
                    ...
                    {
                        MoneySystem.Bank.Change(characterData.Bank, -prod.Price);
                    }
                    GameLog.Money($"player({characterData.UUID})", $"biz({biz.ID})", prod.Price, $"buyShopSim({number})");
                
                }
                else if (prod.Name == "Lottoschein")
                {
                    ...
                    if (!Lottery.LotteryBought.ContainsKey(mynumb))
                    {
                        ...
                        switch (mynumb)
                        {
                            ...
                            case 3001:
                            case 5001:
                                NAPI.Chat.SendChatMessageToAll($"~g~[LOTTERIE] Es wurden {mynumb - 1} Lotterie Scheine verkauft. Jackpot: {Wallet.Format(Lottery.Price)}$!");
                                NAPI.Chat.SendChatMessageToAll($"~g~[LOTTERIE] In allen 24/7 können Sie sich einen Lotterieschein kaufen.");
                                break;
                            default:
                                break;
                        }

                        biz.BuyItemBusiness(characterData.UUID, "Lottoschein", 500);
                        if (paytype == 0)
                        {
                        ...
                        {
                            MoneySystem.Bank.Change(characterData.Bank, 500);
                        }
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Du hast einen Lottoschein gekauft #{mynumb}. Mehr Info: /lottery", 7000);
                ...
                else
                {
                    ...
                    if (busProductData.ItemId != ItemId.Debug)
                    {
                        ...
                        EventSys.SendCoolMsg(player,"Kauf", "Gegenstand kauf", $"{LangFunc.GetText(LangType.De, DataName.YouBuy, itemInfo.Name, prod.Price)}", "", 6000); 
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"{LangFunc.GetText(LangType.De, DataName.YouBuy, itemInfo.Name, prod.Price)}", 1000);
        ...
        public static void OpenGunShopMenu(ExtPlayer player)
        {
            try
            {
                ...
                Trigger.ClientEvent(player, "client.gunshop.open", JsonConvert.SerializeObject(_WeaponsData), JsonConvert.SerializeObject(_AmmoData), biz.Products.FirstOrDefault(p => p.Name == "Патроны").Price);
        ...
        public static void Event_WShopComponent(ExtPlayer player, int cat, int index, string componentId)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Sie haben keinen Waffenschein. Den bekommst du bei der Polizei..", 10000);
                    return;
                }
                Business biz = BizList[bizid];
                Product prod = biz.Products.FirstOrDefault(p => p.Name == "Modifikation");
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Du kaufst {Chars.Repository.ItemsInfo[wType].Name} für {totalPrice}$", 3000);
        ...
        public static void Event_WShopAmmo(ExtPlayer player, int category, int ammo)
        {
            try
            {
                ...
                Business biz = BizList[bizid];
                Product prod = biz.Products.FirstOrDefault(p => p.Name == "Munition");
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Du kaufst {Chars.Repository.ItemsInfo[AmmoTypes[category]].Name} x{ammo} für {totalPrice}$", 3000);
            }
            catch (Exception e)
            {
        ...
        public static void Event_WShop(ExtPlayer player, int cat, int index)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, $"Du kaufst {prod.Name} für {prod.Price}$", 3000);
    ...
    public class Business
    {
        ...
        public void UpdateLabel()
        {
            Trigger.SetMainTask(() =>
            {
                try
                {
                    ...
                    if (IsAuction) text += $"~w~Auktion erstellt";
                    else if (IsOwner()) text += $"~p~{Owner}\n";
                    else text += $"~w~Preis: ~g~{Wallet.Format(SellPrice)}$\n";
                    if (Type == 1) text += $"~w~Preis pro Liter: ~g~{Products[0].Price}$\n";
                    text += $"~c~ID{ID}";
                    label.Text = text;
                    if (Mafia != -1) mafiaLabel.Text = $"~w~Mafia: ~r~{Fractions.Manager.GetName(Mafia)}";
                    else mafiaLabel.Text = "~w~Mafia: ~w~leer";
                }
                catch (Exception e)
                {
        ...
        public bool IsOwner() => Owner != "Staat";
    }
