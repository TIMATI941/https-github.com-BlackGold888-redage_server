...
namespace NeptuneEvo.Core
{
    ...
    class Customization : Script
    {
        ...
        private static Vector3[] SpawnsPos =
        {
            ...
            new Vector3(-1044.9844, -2756.6763, 21.343168), //SPIELER SPAWN //FLUGHAVEN SPAWN
            //new Vector3(-479.1031, -307.97488, 34.989967), //SPIELER SPAWN STANDART
                ...
                try
                {
                    ...
                    NAPI.Task.Run(() =>
                    {
                        ...
                        if (!isChanging)
                        {
                            ...
                            Trigger.SendToAdmins(1, LangFunc.GetText(LangType.De, DataName.NewChar, player.Name, player.Value));
