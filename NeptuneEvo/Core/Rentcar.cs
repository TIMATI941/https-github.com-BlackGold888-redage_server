...
namespace NeptuneEvo.Core
{
    ...
    class Rentcar : Script
    {
        ...
        public void Event_OnPlayerEnterVehicle(ExtPlayer player, ExtVehicle vehicle, sbyte seatid)
        {
            try
            {
                ...
                {                 
                    ...
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AlreadyRented), 6000);
        ...
        public static ExtPlayer Event_vehicleDeath(ExtVehicle vehicle,  string prefix = "zerstört") 
        {
            try
            {
                var vehicleLocalData = vehicle.GetVehicleLocalData();
                if (vehicleLocalData != null && vehicleLocalData.Access == VehicleAccess.Rent)
                {
                    ...
                    if (sessionData.RentData != null)
                    {
                        ...
                        if (prefix != String.Empty) 
                            Notify.Send(player, NotifyType.Warning, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.RentCarWas, prefix), 6000);
        ...
        public static RentCarData[] RentCarsData =
        {
            ...
            // 
            new RentCarData(8, "tribike", 0, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(9, "scorcher", 0, new List<RentCarId>() { RentCarId.Civilian }),// 
            new RentCarData(10, "scorcher2", 0, new List<RentCarId>() { RentCarId.Civilian }),
            new RentCarData(11, "faggio", 25, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(12, "faggio2", 25, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(13, "faggio3", 25, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(14, "blazer", 45, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(15, "blazer2", 45, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(16, "blazer3", 45, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(17, "blazer4", 45, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(18, "blazer5", 45, new List<RentCarId>() { RentCarId.Civilian }), 
            new RentCarData(19, "verus", 50, new List<RentCarId>() { RentCarId.Civilian }),
            // 
        ...
        private static RentCarSpawn[] RentCarsSpawn = new RentCarSpawn[]
       {
            ...
            new RentCarSpawn(95, new Vector3(-1330.758, 44.09792, 53.48625), new Vector3(1.926815, -0.7770224, 272.733)),
            new RentCarSpawn(95, new Vector3(-1331.057, 45.90104, 53.48906), new Vector3(1.926815, -0.7770224, 272.733)),
            new RentCarSpawn(95, new Vector3(-1331.293, 49.59402, 53.4978), new Vector3(0.06539849, -1.081534, 269.8514)),
            new RentCarSpawn(95, new Vector3(-1331.297, 51.49276, 53.5071), new Vector3(-1.502, -1.38771, 274.4296)),
            new RentCarSpawn(95, new Vector3(-1331.475, 53.58579, 53.53268), new Vector3(0.578413, 0.2098309, 272.2005)),
            ...
            new RentCarSpawn(62, new Vector3(895.04443, -5.465729, 78.739716), new Vector3(0, 0, 147.49081)), //CASINO
            new RentCarSpawn(62, new Vector3(898.76624, -7.6017523, 78.739655), new Vector3(0, 0, 151.11702)),
            new RentCarSpawn(62, new Vector3(901.9368, -9.711848, 78.74912), new Vector3(0, 0, 144.76367)),
            ...
            //
            new RentCarSpawn(59, new Vector3(-989.5941, -2707.1123, 13.803273), new Vector3(0.0357279, -12.160821, -24.654032)),
            new RentCarSpawn(59, new Vector3(-986.4037, -2708.6287, 13.803029), new Vector3(0.14, -11.398513, -25.554615)),
            new RentCarSpawn(59, new Vector3(-983.6149, -2709.7168, 13.799486), new Vector3(0.10487608, -14.354504, -15.822334)),
            new RentCarSpawn(59, new Vector3(-980.43005, -2710.4592, 13.810885), new Vector3(0.537983, -14.068779, -10.148447)),
            new RentCarSpawn(59, new Vector3(-976.92316, -2711.049, 13.825271), new Vector3(0.6189843, -10.400752, -6.4614267)),
            new RentCarSpawn(59, new Vector3(-973.8794, -2711.47, 13.820084), new Vector3(0.63915646, -14.416481, -0.86573225)),
            new RentCarSpawn(59, new Vector3(-970.2401, -2711.549, 13.81263), new Vector3(0.63562065, -14.137, 5.8211784)),
            new RentCarSpawn(59, new Vector3(-966.7226, -2711.2993, 13.799825), new Vector3(0.1157643, -14.37432, 8.1122055)),
            new RentCarSpawn(59, new Vector3(-963.7886, -2710.7937, 13.799287), new Vector3(0.09274506, -14.510374, 5.1378255)),
            new RentCarSpawn(59, new Vector3(-960.70593, -2710.2183, 13.804493), new Vector3(0.255844, -11.39235, 8.298418)),
            new RentCarSpawn(59, new Vector3(-961.2617, -2699.24, 13.798901), new Vector3(0.12954527, -14.679754, 149.43217)),
            new RentCarSpawn(59, new Vector3(-964.00256, -2697.6533, 13.801191), new Vector3(0.08425814, -13.438373, 149.97089)),
            new RentCarSpawn(59, new Vector3(-966.8756, -2695.9675, 13.799926), new Vector3(0.06971222, -14.188609, 154.73001)),
            new RentCarSpawn(59, new Vector3(-969.5869, -2694.385, 13.800965), new Vector3(0.08978128, -13.508417, 152.3171)),
            new RentCarSpawn(59, new Vector3(-972.86584, -2692.5022, 13.807825), new Vector3(0.30177063, -7.8334026, 151.27179)),
            new RentCarSpawn(59, new Vector3(-975.4588, -2690.8625, 13.798597), new Vector3(0.05768277, -15.000032, 151.13438)),
            new RentCarSpawn(59, new Vector3(-979.0505, -2688.948, 13.817537), new Vector3(1.1595346, -8.211557, 148.18622)), //FLUGHAFEN RENT
            //
            ...
            //
            new RentCarSpawn(61, new Vector3(218.6284, -905.7513, 18.304111), new Vector3(1.6250721, -7.54815, 54.114815)),
            new RentCarSpawn(61, new Vector3(220.42935, -903.194, 18.294895), new Vector3(1.4774987, -14.419454, 53.199093)),
            new RentCarSpawn(61, new Vector3(222.28569, -900.4804, 18.296185), new Vector3(1.4682509, -13.691469, 57.583115)),

            new RentCarSpawn(63, new Vector3(1209.9075, 2648.5854, 37.832268), new Vector3(0, 0, -47.149242)),
            new RentCarSpawn(63, new Vector3(1210.854, 2647.5874, 37.82391), new Vector3(0, 0, -49.21403)),

            new RentCarSpawn(64, new Vector3(1963.6884, 3765.4417, 32.17697), new Vector3(0, 0, 34.88672)),
            new RentCarSpawn(64, new Vector3(1959.9685, 3763.1204, 32.17355), new Vector3(0, 0, 27.646582)),

            new RentCarSpawn(65, new Vector3(782.01447, -2985.0105, 5.785645), new Vector3(0, 0, 65.08415)),
            new RentCarSpawn(65, new Vector3(783.04004, -2981.6838, 5.781751), new Vector3(0, 0, 68.55899)),
            new RentCarSpawn(66, new Vector3(2567.5208, 328.38678, 108.43576), new Vector3(0, 0, -179.54012)),
            new RentCarSpawn(67, new Vector3(1688.8152, 4916.032, 42.05761), new Vector3(0, 0, 58.199356)),
            new RentCarSpawn(68, new Vector3(-116.16183, 6445.5396, 31.450527), new Vector3(0, 0, -45.82562)),
            new RentCarSpawn(69, new Vector3(-588.42444, 188.09767, 71.20962), new Vector3(0, 0, 93.38517)),
            new RentCarSpawn(70, new Vector3(-3052.278, 597.1049, 7.411725), new Vector3(0, 0, -76.02556)),
            new RentCarSpawn(71, new Vector3(284.57474, -615.6956, 43.395798), new Vector3(0, 0, -20.909573)),
            new RentCarSpawn(71, new Vector3(282.74643, -615.07446, 43.346584), new Vector3(0, 0, -19.590946)),
            new RentCarSpawn(71, new Vector3(280.47864, -614.2529, 43.279434), new Vector3(0, 0, -23.311335)),
        ...
        {
            //new RentZoneData(1, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.EliteRent), new Vector3(-153.19, -158.982, 43.62119), 112.6956f, RentCarId.Elite),
            new RentZoneData(2, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-280.0288, -889.7692, 31.0806), 252.4524f, RentCarId.Civilian),
           //new RentZoneData(3, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.RaceRent), new Vector3(-37.98943, -2095.628, 16.70483), 112.7483f, RentCarId.Rally),
            //new RentZoneData(4, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1869.13, -359.697, 49.30879), 322.3027f, RentCarId.Civilian),
            //new RentZoneData(5, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.EventRent), new Vector3(-905.1248, -2337.17, 6.709028), 0.0f, RentCarId.Holiday),
            new RentZoneData(6, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(453.2874, -1149.766, 29.29178), 180.0f, RentCarId.Civilian),
            new RentZoneData(7, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(461.9777, 217.6612, 103.1002), 0.0f, RentCarId.Civilian),
            //new RentZoneData(8, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1313.945, 282.8484, 64.09132), 0.0f, RentCarId.Civilian),
            //new RentZoneData(9, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-513.6987, 43.07299, 52.57989), 0.0f, RentCarId.Civilian),
           //new RentZoneData(10, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.BikeRent), new Vector3(-1109.3678, -1694.4069, 4.5645723), 0.0f, RentCarId.Cycling),
            //new RentZoneData(11, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.OffRoadRent), new Vector3(-2040.9161, -130.33661, 27.593317), 175.0f, RentCarId.OffRoad),
            //new RentZoneData(12, "s_m_m_pilot_01", LangFunc.GetText(LangType.De, DataName.HeliRent), new Vector3(-736.5372, -1458.0835, 5.00052), 0.0f, RentCarId.Helicopter),
            //new RentZoneData(13, "s_m_m_pilot_01", LangFunc.GetText(LangType.De, DataName.PlaneRent), new Vector3(-993.7938, -2947.3257, 13.957196), 0.0f, RentCarId.Aeroplane),
            new RentZoneData(14, "s_m_y_uscg_01", LangFunc.GetText(LangType.De, DataName.BoatRent), new Vector3(-1606.993, -1127.9418, 2.1554325), 0.0f, RentCarId.WaterBased),
            //new RentZoneData(15, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1699.369, 3774.0999, 34.731514), -126.795135f, RentCarId.Civilian),
            //new RentZoneData(16, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1037.1823, -765.38556, 57.977104), -120.06861f, RentCarId.Civilian),
            //new RentZoneData(17, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(934.37427, 148.65912, 80.83027), -88.601776f, RentCarId.Civilian),
            new RentZoneData(18, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1541.2733, -437.8889, 35.596672), -79.82406f, RentCarId.Civilian),
            new RentZoneData(19, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-820.0671, -1100.6382, 11.156218), -59.84502f, RentCarId.Civilian),
            //new RentZoneData(20, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(657.36163, 687.5908, 129.04634), 160.71507f, RentCarId.Civilian),
            //new RentZoneData(21, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(219.64946, 1192.6567, 225.55067), -78.82406f, RentCarId.Civilian),
            //new RentZoneData(22, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-2294.3545, 429.43195, 174.60149), 81.051025f, RentCarId.Civilian),
            new RentZoneData(23, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(394.68338, -633.62024, 28.70693), -88.82406f, RentCarId.Civilian),
            //new RentZoneData(24, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(583.3127, 2739.7866, 42.095203), -171.795135f, RentCarId.Civilian),
            //new RentZoneData(25, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(2752.168, 3467.383, 55.74715), -117.795135f, RentCarId.Civilian),
            //new RentZoneData(26, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-72.81145, 6346.49, 31.586294), 0.0f, RentCarId.Civilian),
            //new RentZoneData(27, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-3140.1387, 1130.3076, 20.851465), -120.795135f, RentCarId.Civilian),
            //new RentZoneData(28, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-389.61102, -196.51826, 36.54216), -159.795135f, RentCarId.Civilian),
            //new RentZoneData(29, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1695.415, 4785.0933, 41.996357), 52.643776f, RentCarId.Civilian),

            new RentZoneData(30, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.TaxiRent), new Vector3(437.08667, -627.85693, 28.707752), 70.70735f, RentCarId.JobTaxi),
            new RentZoneData(95, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.LandmowerRent), new Vector3(-1331.1528, 41.80951, 53.57145), 0.0f, RentCarId.JobLawnmower), //-1330.482, 42.12986, 53.48915
            new RentZoneData(32, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.BusRent), new Vector3(435.23758, -653.01117, 28.730534), 78.42807f, RentCarId.JobBus),
            new RentZoneData(33, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.FuraRent), new Vector3(438.97568, -606.2591, 28.713915), 109.040101f, RentCarId.JobTrucker),
  	        new RentZoneData(34, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.FurgonRent), new Vector3(438.951, -613.8331, 28.71138), 78.51024f, RentCarId.JobCollector),          
            new RentZoneData(35, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.MechanikRent), new Vector3(440.13922, -599.6496, 28.714296), 78.0f, RentCarId.JobMechanic),

         // new RentZoneData(36, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1024.0071, 2651.1096, 39.55115), 3.2891867f, RentCarId.Civilian),
         // new RentZoneData(37, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1711.9036, 3320.435, 41.146633), 105.430374f, RentCarId.Civilian),
         // new RentZoneData(38, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1725.8662, 3029.0952, 62.1895), 70.05024f, RentCarId.Civilian),
         // new RentZoneData(39, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(145.26793, 6646.386, 31.503784), -168.58095f, RentCarId.Civilian),
         // new RentZoneData(40, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1436.4434, 6331.325, 23.934277), 95.294754f, RentCarId.Civilian),
         // new RentZoneData(41, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(268.53894, 2573.1646, 45.064144), 42.072704f, RentCarId.Civilian),
         // new RentZoneData(42, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-2172.9595, 4281.6562, 49.09), -121.75311f, RentCarId.Civilian),
         // new RentZoneData(43, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(2553.2017, 4639.9536, 34.07682), -10.622228f, RentCarId.Civilian),
         // new RentZoneData(44, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(2531.4392, 4113.914, 38.756462), -113.949425f, RentCarId.Civilian),
         // new RentZoneData(45, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(2034.2146, 3180.105, 45.25282), 154.2865f, RentCarId.Civilian),
         // new RentZoneData(46, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1125.9249, 2694.8164, 18.800394), 93.99415f, RentCarId.Civilian),
         // new RentZoneData(47, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-2647.9492, 2532.6375, 3.0417547), 33.042896f, RentCarId.Civilian),
         // new RentZoneData(48, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1837.5392, 4714.268, 4.317833), -139.0106f, RentCarId.Civilian),
         // new RentZoneData(49, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1651.5188, 4828.98, 42.023285), -169.2284f, RentCarId.Civilian),
         // new RentZoneData(50, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(3304.9111, 5424.6646, 15.494226), -124.61217f, RentCarId.Civilian),
            new RentZoneData(51, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(2830.9817, -710.8333, 1.97693), 81.07968f, RentCarId.Civilian),
          //new RentZoneData(52, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1419.0496, 3654.1768, 34.52287), 116.757744f, RentCarId.Civilian),
          //new RentZoneData(53, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(834.9719, -3204.43, 5.9008045), -174.2475f, RentCarId.Civilian),
            new RentZoneData(54, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-330.19974, -2464.6208, 6.0006385), 142.68982f, RentCarId.Civilian),
            new RentZoneData(56, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1237.501, -1395.8168, 4.141041), 122.99152f, RentCarId.Civilian),
            new RentZoneData(57, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1389.4164, -2073.133, 51.99858), 53.371437f, RentCarId.Civilian),
            new RentZoneData(58, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.FurgonRent2), new Vector3(437.9226, -621.9111, 28.7092), 83.0f, RentCarId.JobPostman),
            new RentZoneData(59, "s_m_y_uscg_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-1016.18646, -2693.834, 13.977448), 148f, RentCarId.Civilian), //FLUGHAVEN RENTCAR
            new RentZoneData(60, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-227.15689, -2666.8054, 6.0002985),  7.2f, RentCarId.Civilian),
            new RentZoneData(61, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(211.596, -905.3025, 18.319727), -126.62898f, RentCarId.Civilian), //WÜRFELPARK
            new RentZoneData(62, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(889.9224, -0.3963617, 78.76496), -162.01485f, RentCarId.Civilian), //Casino
            new RentZoneData(63, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1202.7826, 2656.076, 37.851875), -48.466076f, RentCarId.Civilian), //ZONE 4025
            new RentZoneData(64, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1969.1804, 3772.6572, 32.193657), 67.93028f, RentCarId.Civilian), //ZONE 3008
            new RentZoneData(65, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(796.22107, -2977.3489, 6.020937), 82.838646f, RentCarId.Civilian), //ZONE 10130
            new RentZoneData(66, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(2560.678, 355.59033, 108.62063), -86.32713f, RentCarId.Civilian), //ZONE 7355
            new RentZoneData(67, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(1693.49, 4919.478, 42.078106), 55.669003f, RentCarId.Civilian), //ZONE 2006
            new RentZoneData(68, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-110.77041, 6458.108, 31.466572), 139.34373f, RentCarId.Civilian), //ZONE 1055
            new RentZoneData(69, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-583.53143, 189.87044, 71.31276), 79.69884f, RentCarId.Civilian), //ZONE 7067
            new RentZoneData(70, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(-3056.616, 595.5014, 7.556151), -63.19109f, RentCarId.Civilian), //ZONE 5047
            new RentZoneData(71, "a_m_y_genstreet_01", LangFunc.GetText(LangType.De, DataName.CarRent), new Vector3(289.23117, -617.8548, 43.51709), 0.34992424f, RentCarId.Civilian), //ZONE EMS
        ...
        {
            { RentCarId.Civilian, new RentBlipData(226, LangFunc.GetText(LangType.De, DataName.CarRent), 4) }, //RENT BLIP ANFANG
            { RentCarId.Cycling, new RentBlipData(512, LangFunc.GetText(LangType.De, DataName.BikeRent), 9) },
            { RentCarId.OffRoad, new RentBlipData(757, LangFunc.GetText(LangType.De, DataName.OffRoadRent), 9) },
            { RentCarId.WaterBased, new RentBlipData(471, LangFunc.GetText(LangType.De, DataName.BoatRent), 9) },
            { RentCarId.Helicopter, new RentBlipData(602, LangFunc.GetText(LangType.De, DataName.HeliRent), 9) },
            { RentCarId.Aeroplane, new RentBlipData(579, LangFunc.GetText(LangType.De, DataName.PlaneRent), 9) },
            //{ RentCarId.Holiday, new RentBlipData(747, LangFunc.GetText(LangType.De, DataName.EventRent), 9) },
            //{ RentCarId.Elite, new RentBlipData(633, LangFunc.GetText(LangType.De, DataName.EliteRent), 9) },
            //{ RentCarId.Rally, new RentBlipData(726, LangFunc.GetText(LangType.De, DataName.RaceRent), 9) },
            { RentCarId.JobTaxi, new RentBlipData(2, LangFunc.GetText(LangType.De, DataName.Taxi), 46) },
            { RentCarId.JobLawnmower, new RentBlipData(109, LangFunc.GetText(LangType.De, DataName.Landmower), 4) },
            { RentCarId.JobBus, new RentBlipData(2, LangFunc.GetText(LangType.De, DataName.Bus), 26) },
            { RentCarId.JobTrucker, new RentBlipData(2, LangFunc.GetText(LangType.De, DataName.Gruzovik), 4) },
            { RentCarId.JobCollector, new RentBlipData(2, LangFunc.GetText(LangType.De, DataName.Inkass), 63) },
            { RentCarId.JobMechanic, new RentBlipData(2, LangFunc.GetText(LangType.De, DataName.Mechanik), 4) },
            { RentCarId.JobPostman, new RentBlipData(2, LangFunc.GetText(LangType.De, DataName.Postman), 4) },
        };
        ...
        public static void RentCarToInterface(ExtPlayer player, int carId, int colorId, int hour, int fakezone)
        {
            Console.WriteLine(" CarId " + carId+" color "+ colorId+ " hour "+hour);
            try
            {
                ...
                if (player.IsInVehicle)
                {
                    ...
                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent, LangFunc.GetText(LangType.De, DataName.CantRentAuto), DateTime.Now); 
                    return;
                }
                if(sessionData.RentData != null)
                {
                    //Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, "Вы уже арендуете т/с.", 3000);
                    Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent, LangFunc.GetText(LangType.De, DataName.AlreadyRent), DateTime.Now); 
                    return;
                }
                ...
                switch (rentCarsData.Job)
                {
                    case JobsId.Taxi:
                        ...
                        {
                            Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.Ru, DataName.BeforeNeedToWork), 6000);
                            return;
                        }
                ...
                if (fakezone == 999)
                {
                    zoneId = CustomColShape.GetDataToEnum(player, ColShapeEnums.RentCar);
                    if (zoneId == (int)ColShapeData.Error)
                    {
                        Console.WriteLine("KP WAS ");
                        return;
                    }
                }
                else
                {
                    zoneId = fakezone;
                    Console.WriteLine("Fakezone erstellt");
                }
                ...
                string correctMessage = LangFunc.GetText(LangType.De, DataName.hours);
                if (hour == 1) correctMessage = LangFunc.GetText(LangType.De, DataName.hour);
                else if (hour == 2 || hour == 3 || hour == 4) correctMessage = LangFunc.GetText(LangType.De, DataName.houra);

                //Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.SuccRentVehJob, hour, correctMessage), 8000);
                //Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent, LangFunc.GetText(LangType.De, DataName.SuccRentVehJob, rentCarsData.Model), DateTime.Now);
        ...
        private static void OnReturnVehicleTask(ExtPlayer player, bool msg = false)
        {
            try
            {
                ...
                if (sessionData.RentData != null)
                {
                    ...
                    if (msg) 
                        Players.Phone.Messages.Repository.AddSystemMessage(player, (int)DefaultNumber.Rent, LangFunc.GetText(LangType.De, DataName.CancelledRent), DateTime.Now);
            ...
            try
            {
                ...
                switch (listItem)
                {
                    case "gpstrack":
                        ...
                        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.MarkSelected), 6000);
                        return;
                    case "datetime":
                        int price = GetRentCarCash (accountData.VipLvl, characterData.LVL, rent.Price);
                        Trigger.ClientEvent(player, "openDialog", "RENTCARI_DATETIME", LangFunc.GetText(LangType.De, DataName.RentExpandConfirm, rent.Date, MoneySystem.Wallet.Format(price)));
                        return;
                    case "stoprent":
                        Trigger.ClientEvent(player, "openDialog", "RENTCARI_STOPRENT", LangFunc.GetText(LangType.De, DataName.RentCancelConfirm, rent.Date));
                        return;
                }
            }
            catch (Exception e)
