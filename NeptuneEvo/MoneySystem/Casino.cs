...
namespace NeptuneEvo.MoneySystem
{
    class Casino : Script
    {
        ...
        private static Vector3 blipPosition = new Vector3(934.26825, 45.990326, 81.095795);

        public static Vector3[] casinoChecks = new Vector3[7]
                {
            new Vector3(934.26825, 45.990326, 81.095795), //MARKER STRAßENEINGANG INS CASINO
            new Vector3(1090.358, 206.7677, -50.11972), // MARKER CASINO AUSGANG (IM CASINO)
        ...
        public static void OnResourceStart()
        {
            try
            {
                ...
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(casinoChecks[0].X, casinoChecks[0].Y, casinoChecks[0].Z), 5F, 0.3F, 0, new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(27, casinoChecks[0] + new Vector3(0, 0, 0), new Vector3(), new Vector3(), 0.8f, new Color(255, 255, 255, 60));

                CustomColShape.CreateCylinderColShape(casinoChecks[1], 1, 2, 0, ColShapeEnums.Casino, 3);
                NAPI.TextLabel.CreateTextLabel(Main.StringToU16("~w~Drücke\n~r~'Interaktion'"), new Vector3(casinoChecks[1].X, casinoChecks[1].Y, casinoChecks[1].Z + 1), 5F, 0.3F, 0, new Color(255, 255, 255));
                NAPI.Marker.CreateMarker(27, casinoChecks[1] + new Vector3(0, 0, 0.7), new Vector3(), new Vector3(), 0.8f, new Color(255, 255, 255, 60));
               ...
               /* CustomColShape.CreateCylinderColShape(casinoChecks[3], 1, 2, 0, ColShapeEnums.Casino, 4);
                ...
                Main.CreateBlip(new Main.BlipData(617, "Kasino", blipPosition, 3, true));
            }
            catch (Exception e)
            {
