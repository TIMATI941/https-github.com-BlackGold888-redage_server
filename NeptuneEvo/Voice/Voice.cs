    ...
    public class Voice : Script
    {
        ...
        public static void PlayerQuit(ExtPlayer player, string reson)
        {
            try
            {
                ...
                if (playerPhoneMeta.Target != null)
                {
                    ...
                    Notify.Send(target, NotifyType.Alert, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.PlayerHangPhone, playerName), 6000);
        ...
        public void voiceDebugReload(ExtPlayer player)
        {
            try
            {
                ...
                Trigger.SendChatMessage(player, LangFunc.GetText(LangType.De, DataName.Vreload));
        ...
        public static void TakeWalkieTalkie_server(ExtPlayer player)
        {
            try
            {
                ...
                else Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.NoWalkieTalkie), 6000);
            }
            catch (Exception e)
            {
        ...
        public static void PressedDangerButton(ExtPlayer player)
        {
            try
            {
                ...
                if (memberFractionData.Id == 7 || memberFractionData.Id == 9 || memberFractionData.Id == 18)
                {
                    ...
                    {
                        Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.Panic15sec), 6000);
                        return;
                    }
                    ...
                    foreach (ExtPlayer foreachPlayer in Character.Repository.GetPlayers())
                    {
                        ...
                        if (foreachMemberFractionData.Id == (int)Fractions.Models.Fractions.POLICE || foreachMemberFractionData.Id == (int)Fractions.Models.Fractions.FIB || foreachMemberFractionData.Id == (int)Fractions.Models.Fractions.SHERIFF)
                        {
                            ...
                            Trigger.SendChatMessage(foreachPlayer, "!{#F08080}[F] " + LangFunc.GetText(LangType.De, DataName.PanicActivator, player.Name, player.Value));
                        }
            ...
            try
            {
                ...
                if (memberFractionData.Id == 7 || memberFractionData.Id == 9 || memberFractionData.Id == 18)
                {
                    ...
                    foreach (ExtPlayer foreachPlayer in Character.Repository.GetPlayers())
                    {
                        ...
                        if (foreachMemberFractionData.Id == (int)Fractions.Models.Fractions.POLICE || foreachMemberFractionData.Id == (int)Fractions.Models.Fractions.FIB || foreachMemberFractionData.Id == (int)Fractions.Models.Fractions.SHERIFF)
                            Trigger.SendChatMessage(foreachPlayer, "!{#F08080}[F] " + LangFunc.GetText(LangType.De, DataName.Code0accept, player.Name, player.Value, sender_id));
        ...
        public static void UpdateWalkieTalkieFrequency(ExtPlayer player, int value)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.WalkieWave, value), 6000);
            }
            catch (Exception e)
            {
        ...
        public static void SetVoiceZone(ExtPlayer player, int value = 0, bool addMicroToHand = false)
        {
            ...
            else
            {
                ...
                if (addMicroToHand)
                {
                    Commands.RPChat("sme", player, $"holt" + (characterData.Gender ? "" : "а") + $" Mikrofon");
