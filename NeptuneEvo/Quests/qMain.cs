    ...
    class qMain : Script
    {
        ...
        public static void QuestPerform(ExtPlayer player, bool isClose)
        {
            try
            {
                ...
                else if (questData.ActorName == "npc_electrician") Electric.Perform(player);
                else if (questData.ActorName == "npc_lawnmower") LawnmowerDialog.Perform(player);
        ...
        public static void QuestAction(ExtPlayer player, bool isClose)
        {
            try
            {
                ...
                else if (questData.ActorName == "npc_lawnmower") LawnmowerDialog.Action(player);
            }
            catch (Exception e)
            {
        ...
        public static void SkipQuest(ExtPlayer player, int id)
        {
            try
            {
                ...
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Sie überspringen die Quest {questData.ActorName} Spieler {target.Name}", 3000);
            }
            catch (Exception e)
            {
