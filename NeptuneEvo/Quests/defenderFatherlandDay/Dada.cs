            ...
            switch ((data_quests)Line)
            {
                case data_quests.Start:
                    ...
                    if (Chars.Repository.isItem(player, "inventory", ItemId.Hammer) == null && Chars.Repository.isItem(player, "inventory", ItemId.Wrench) == null)
                    {
                        ...
                        Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Es wurde der nächste 24/7 auf der Karte markiert", 3000);
                    }
                    break;
                case data_quests.Tools:
                    ...
                    Notify.Send(player, NotifyType.Info, NotifyPosition.BottomCenter, "Repariere das Boot", 3000);
                    break;
                default:
                    // Not supposed to end up here. 
                    break;
