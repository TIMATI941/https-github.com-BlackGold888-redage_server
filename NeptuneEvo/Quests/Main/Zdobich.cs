...
{    
    ...
    public class Zdobich : Script
    {
        ...
        {
            PedSystem.Repository.CreateQuest("a_m_m_tourist_01", new Vector3(-1037.0555, -2736.8945, 20.169273), 145f, questName: QuestName, title: "~y~NPC~w~ Tourist Robert\nQuest", colShapeEnums: ColShapeEnums.QuestZdobich); //NPC ROBERT FLUGHAFEN
