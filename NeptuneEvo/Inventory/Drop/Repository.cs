    ...
    public class Repository
    {
        ...
        public static void ItemRaise(ExtPlayer player, GTANetworkAPI.Object obj)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.AdminCantPickupItems), 6000);
                    return;
                }
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.CantPickupInCar), 6000);
                    return;
                }
        ...
        public static void OnHookah(ExtPlayer player, GTANetworkAPI.Object obj)
        {
            try
            {
                ...
                {
                    Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, LangFunc.GetText(LangType.De, DataName.HookahCantUse), 6000);
                    DeleteObject(obj);
                    return;
                }
